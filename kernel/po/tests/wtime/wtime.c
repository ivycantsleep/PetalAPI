...
char *argv[];
{
    ...
    h = CreateWaitableTimer(NULL, TRUE, "TestTimer");
    ...
    printf("Current time is:  %d:%d:%d, ", TimeFields.wHour, TimeFields.wMinute, TimeFields.wSecond);
    ...
    printf("timer set for %d:%d:%d (%d min)  %s time\n", TimeFields.wHour, TimeFields.wMinute, TimeFields.wSecond,
           DueTimeInMin, Absolute ? "absolute" : "relative");
