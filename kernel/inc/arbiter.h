...
typedef NTSTATUS (*PARBITER_UNPACK_REQUIREMENT)(IN PIO_RESOURCE_DESCRIPTOR Descriptor, OUT PULONGLONG Minimum,
                                                OUT PULONGLONG Maximum, OUT PULONG Length, OUT PULONG Alignment);

typedef NTSTATUS (*PARBITER_PACK_RESOURCE)(IN PIO_RESOURCE_DESCRIPTOR Requirement, IN ULONGLONG Start,
                                           OUT PCM_PARTIAL_RESOURCE_DESCRIPTOR Descriptor);

typedef NTSTATUS (*PARBITER_UNPACK_RESOURCE)(IN PCM_PARTIAL_RESOURCE_DESCRIPTOR Descriptor, OUT PULONGLONG Start,
                                             OUT PULONG Length);
...
typedef NTSTATUS (*PARBITER_ADD_RESERVED)(IN PARBITER_INSTANCE Arbiter, IN PIO_RESOURCE_DESCRIPTOR Requirement OPTIONAL,
...
typedef NTSTATUS (*PARBITER_QUERY_CONFLICT)(IN PARBITER_INSTANCE Arbiter, IN PDEVICE_OBJECT PhysicalDeviceObject,
...
typedef NTSTATUS (*PARBITER_TRANSLATE_ALLOCATION_ORDER)(OUT PIO_RESOURCE_DESCRIPTOR TranslatedDescriptor,
...
NTSTATUS
ArbInitializeArbiterInstance(OUT PARBITER_INSTANCE Arbiter, IN PDEVICE_OBJECT BusDevice,
...
NTSTATUS
ArbRollbackAllocation(PARBITER_INSTANCE Arbiter);
...
BOOLEAN
ArbGetNextAllocationRange(PARBITER_INSTANCE Arbiter, PARBITER_ALLOCATION_STATE State);
