...
VOID VdmDispatchException(PKTRAP_FRAME TrapFrame, NTSTATUS ExcepCode, PVOID ExcepAddress, ULONG NumParms, ULONG Parm1,
...
#define VdmGetTrapFrame(pKThread)                                             \
    ((PKTRAP_FRAME)((PUCHAR)(pKThread)->InitialStack - sizeof(FX_SAVE_AREA) - \
                    ((ULONG)(sizeof(KTRAP_FRAME) + KTRAP_FRAME_ROUND) & ~(KTRAP_FRAME_ROUND))))
