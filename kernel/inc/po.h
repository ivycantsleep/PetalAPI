...
#define PoPowerTrace(TracePoint, DevObj, Arg1, Arg2)                                                         \
    {                                                                                                        \
        ...
        PoPowerTracePrint(TracePoint, (ULONG_PTR)pptcCaller, (ULONG_PTR)pptcCallerCaller, (ULONG_PTR)DevObj, \
...
NTKERNELAPI
VOID PoSetHiberRange(IN PVOID MemoryMap, IN ULONG Flags, IN PVOID Address, IN ULONG_PTR Length, IN ULONG Tag);
...
ULONG
PoSimpleCheck(IN ULONG PatialSum, IN PVOID StartVa, IN ULONG_PTR Length);
...
NTKERNELAPI
VOID PoSetSystemState(IN EXECUTION_STATE Flags);
...
typedef VOID (*PREQUEST_POWER_COMPLETE)(IN PDEVICE_OBJECT DeviceObject, IN UCHAR MinorFunction,
...
PoRequestPowerIrp(IN PDEVICE_OBJECT DeviceObject, IN UCHAR MinorFunction, IN POWER_STATE PowerState,
                  IN PREQUEST_POWER_COMPLETE CompletionFunction, IN PVOID Context, OUT PIRP *Irp OPTIONAL);
