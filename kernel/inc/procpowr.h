...
// Useful masks
//
#define PSTATE_THROTTLE_MASK (PSTATE_ADAPTIVE_THROTTLE | PSTATE_DEGRADED_THROTTLE | PSTATE_CONSTANT_THROTTLE)
#define PSTATE_CLEAR_MASK (PSTATE_SUPPORTS_THROTTLE | PSTATE_THROTTLE_MASK)
#define PSTATE_DISABLE_THROTTLE (PSTATE_DISABLE_THROTTLE_NTAPI | PSTATE_DISABLE_THROTTLE_INRUSH)
