...
--*/
{
    ...
    //
    status = IoCreateDevice(VfDriverObject, sizeof(VERIFIER_EXTENSION),
                            NULL, // No Name
...
NTSTATUS
ViDriverEntry(IN PDRIVER_OBJECT DriverObject, IN PUNICODE_STRING RegistryPath)
/*++
...
NTSTATUS
ViDriverAddDevice(IN PDRIVER_OBJECT DriverObject, IN PDEVICE_OBJECT PhysicalDeviceObject)
/*++
...
NTSTATUS
ViDriverDispatchPnp(IN PDEVICE_OBJECT DeviceObject, IN PIRP Irp)
/*++
...
NTSTATUS
ViDriverStartCompletionRoutine(IN PDEVICE_OBJECT DeviceObject, IN PIRP Irp, IN PVOID Context)
{
    PVERIFIER_EXTENSION verifierExtension;
...
NTSTATUS
ViDriverDeviceUsageNotificationCompletionRoutine(IN PDEVICE_OBJECT DeviceObject, IN PIRP Irp, IN PVOID Context)
{
    PVERIFIER_EXTENSION verifierExtension;
...
NTSTATUS
ViDriverDispatchPower(IN PDEVICE_OBJECT DeviceObject, IN PIRP Irp)
/*++
...
NTSTATUS
ViDriverDispatchGeneric(IN PDEVICE_OBJECT DeviceObject, IN PIRP Irp)
/*++
