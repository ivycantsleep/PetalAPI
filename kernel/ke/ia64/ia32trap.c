...
VOID KiIA32CommonArgs(IN PKTRAP_FRAME Frame, IN ULONG ExceptionCode, IN PVOID ExceptionAddress, IN ULONG_PTR Argument0,
                      IN ULONG_PTR Argument1, IN ULONG_PTR Argument2)
/*++
...
BOOLEAN
KiIA32ExceptionDivide(IN PKTRAP_FRAME Frame)
/*++
...
--*/
{
    ...
    KiIA32CommonArgs(Frame, Ki386CheckDivideByZeroTrap(Frame), (PVOID)(ULONG_PTR)EIP(Frame), 0, 0, 0);
    return TRUE;
}

BOOLEAN
KiIA32ExceptionDebug(IN PKTRAP_FRAME Frame)
/*++
Routine Description:
...
--*/
{
    ...
    KiIA32CommonArgs(Frame, STATUS_WX86_SINGLE_STEP, (PVOID)(ULONG_PTR)EIP(Frame), 0, 0, 0);
    return TRUE;
}

BOOLEAN
KiIA32ExceptionBreak(IN PKTRAP_FRAME Frame)
/*++
...
--*/
{
    ...
    KiIA32CommonArgs(Frame, STATUS_WX86_BREAKPOINT, (PVOID)(ULONG_PTR)EIP(Frame), BREAKPOINT_BREAK, ECX(Frame),
                     EDX(Frame));
    return TRUE;
}

BOOLEAN
KiIA32ExceptionOverflow(IN PKTRAP_FRAME Frame)
/*++
Routine Description:
...
--*/
{
    ...
    KiIA32CommonArgs(Frame, STATUS_INTEGER_OVERFLOW, (PVOID)(ULONG_PTR)(EIP(Frame) - 1), 0, 0, 0);
    return TRUE;
}


BOOLEAN
KiIA32ExceptionBound(IN PKTRAP_FRAME Frame)
/*++
...
--*/
{
    ...
    //
    KiIA32CommonArgs(Frame, STATUS_ARRAY_BOUNDS_EXCEEDED, (PVOID)(ULONG_PTR)EIP(Frame), 0, 0, 0);
    return TRUE;
}


ULONG
IA32EmulateSmsw(IN PKTRAP_FRAME Frame)
/*++
...
ULONG
IA32CheckOpcode(IN PKTRAP_FRAME Frame)
/*++
...
--*/
{
    ...
    case MI_TWO_BYTE:
        if ((OpCodeByte1 == MI_SMSW) && ((OpCodeByte2 & MI_MODRM_MASK) == MI_SMSW_REGOP))
        {
            //
        ...
        else if ((OpCodeByte1 == MI_LTR_LLDT) || (OpCodeByte2 == MI_LGDT_LIDT_LMSW))
        {

            OpCodeByte2 &= MI_MODRM_MASK; // get bit 3-5 of ModRM byte

            if (OpCodeByte2 == MI_LLDT_MASK || OpCodeByte2 == MI_LTR_MASK || OpCodeByte2 == MI_LGDT_MASK ||
                OpCodeByte2 == MI_LIDT_MASK || OpCodeByte2 == MI_LMSW_MASK)
            {
                return (STATUS_PRIVILEGED_INSTRUCTION);
            }
            else
...
BOOLEAN
KiIA32InterceptInstruction(IN PKTRAP_FRAME Frame)
/*++
...
--*/
{
    ...
    case STATUS_PRIVILEGED_INSTRUCTION:
        KiIA32CommonArgs(Frame, STATUS_PRIVILEGED_INSTRUCTION, (PVOID)(ULONG_PTR)EIP(Frame), 0, 0, 0);
        break;

    case STATUS_ACCESS_VIOLATION:
        KiIA32CommonArgs(Frame, STATUS_ACCESS_VIOLATION, (PVOID)(ULONG_PTR)EIP(Frame), 0, -1, 0);
        break;

    case STATUS_ILLEGAL_INSTRUCTION:
        KiIA32CommonArgs(Frame, STATUS_ILLEGAL_INSTRUCTION, (PVOID)(ULONG_PTR)EIP(Frame), 0, -1, 0);
        break;
    ...
    default:
        KiIA32CommonArgs(Frame, status, (PVOID)(ULONG_PTR)EIP(Frame), 0, -1, 0);
        break;
    }
...
BOOLEAN
KiIA32ExceptionNoDevice(IN PKTRAP_FRAME Frame)
/*++
...
--*/
{
    ...
    //
    FpState[0] = (ULONG)(~(FcrRegister & (FSW_INVALID_OPERATION | FSW_DENORMAL | FSW_ZERO_DIVIDE | FSW_OVERFLOW |
    ...
    FpState[1] =
        (ULONG)(~((FcrRegister >> KATMAI_SHIFT_CONTROL) & (FSW_INVALID_OPERATION | FSW_DENORMAL | FSW_ZERO_DIVIDE |
                                                           FSW_OVERFLOW | FSW_UNDERFLOW | FSW_PRECISION)) &
    ...
    for (i = 0; i < 2; i++)
    {
        if (FpState[i] & FSW_INVALID_OPERATION)
        {
            ...
            {
                KiIA32CommonArgs(Frame, STATUS_FLOAT_STACK_CHECK, (PVOID)(ULONG_PTR)FirOffset, 0, FdrOffset, 0);
                return TRUE;
            }
            else
            {
                KiIA32CommonArgs(Frame, STATUS_FLOAT_INVALID_OPERATION, (PVOID)(ULONG_PTR)FirOffset, 0, 0, 0);
                return TRUE;
            }
        }
        else
    ...
    if (ErrorCode)
    {
        KiIA32CommonArgs(Frame, ErrorCode, (PVOID)(ULONG_PTR)FirOffset, 0, 0, 0);
        return TRUE;
    }
...
BOOLEAN
KiIA32ExceptionSegmentNotPresent(IN PKTRAP_FRAME Frame)
/*++
...
--*/
{
    ...
    KiIA32CommonArgs(Frame, STATUS_ACCESS_VIOLATION, (PVOID)(ULONG_PTR)EIP(Frame), 0, ISRCode(Frame) | RPL_MASK, 0);
    return TRUE;
}

BOOLEAN
KiIA32ExceptionStack(IN PKTRAP_FRAME Frame)
/*++
...
--*/
{
    ...
    //
    KiIA32CommonArgs(Frame, STATUS_ACCESS_VIOLATION, (PVOID)(ULONG_PTR)EIP(Frame),
                     Code ? (Code | RPL_MASK) : ESP(Frame), Code ? EXCEPT_UNKNOWN_ACCESS : EXCEPT_LIMIT_ACCESS, 0);
    return TRUE;
}

BOOLEAN
KiIA32ExceptionInvalidOp(IN PKTRAP_FRAME Frame)
/*++
...
--*/
{
    ...
    KiIA32CommonArgs(Frame, STATUS_ILLEGAL_INSTRUCTION, (PVOID)(ULONG_PTR)EIP(Frame), 0, 0, 0);
    return TRUE;
}

BOOLEAN
KiIA32ExceptionGPFault(IN PKTRAP_FRAME Frame)
/*++
...
--*/
{
    ...
    KiIA32CommonArgs(Frame, Status, (PVOID)(ULONG_PTR)EIP(Frame), 0, 0, 0);
    return TRUE;
}


BOOLEAN
KiIA32ExceptionKNI(IN PKTRAP_FRAME Frame)
/*++
...
BOOLEAN
KiIA32ExceptionFPFault(IN PKTRAP_FRAME Frame)
/*++
...
BOOLEAN
KiIA32ExceptionAlignmentFault(IN PKTRAP_FRAME Frame)
/*++
...
BOOLEAN
KiIA32InterruptVector(IN PKTRAP_FRAME Frame)
/*++
...
BOOLEAN
KiIA32InterceptGate(IN PKTRAP_FRAME Frame)
/*++
...
BOOLEAN
KiIA32InterceptSystemFlag(IN PKTRAP_FRAME Frame)
{
    NTSTATUS NtStatus;
#if defined(IADBG)
    IF_IA32TRAP_DEBUG(FLAG)
    DbgPrint("IA32 FLAG: Eip %x Old EFlag: %x OpcodeId %x\n", EIP(Frame), (ULONG)(Frame->StIIM & 0xff),
             (ULONG)(ISRCode(Frame) >> 14));
#endif // IADBG
    ...
    KiIA32CommonArgs(Frame, NtStatus, (PVOID)(ULONG_PTR)EIP(Frame), 0, 0, 0);
...
BOOLEAN
KiIA32InterceptLock(IN PKTRAP_FRAME Frame)
/*++
...
BOOLEAN
KiIA32ExceptionPanic(IN PKTRAP_FRAME Frame)
{
    //
    // Panic the system
    //
...
CONST BOOLEAN (*KiIA32ExceptionDispatchTable[])(PKTRAP_FRAME) = {
    KiIA32ExceptionDivide,   KiIA32ExceptionDebug,          KiIA32ExceptionPanic,     KiIA32ExceptionBreak,
    KiIA32ExceptionOverflow, KiIA32ExceptionBound,          KiIA32ExceptionInvalidOp, KiIA32ExceptionNoDevice,
    KiIA32ExceptionPanic,    KiIA32ExceptionPanic,          KiIA32ExceptionPanic,     KiIA32ExceptionSegmentNotPresent,
    KiIA32ExceptionStack,    KiIA32ExceptionGPFault,        KiIA32ExceptionPanic,     KiIA32ExceptionPanic,
    KiIA32ExceptionFPFault,  KiIA32ExceptionAlignmentFault, KiIA32ExceptionPanic,     KiIA32ExceptionKNI
};

CONST BOOLEAN (*KiIA32InterceptionDispatchTable[])(PKTRAP_FRAME) = { KiIA32InterceptInstruction, KiIA32InterceptGate,
                                                                     KiIA32InterceptSystemFlag, KiIA32ExceptionPanic,
                                                                     KiIA32InterceptLock };

BOOLEAN
KiIA32InterceptionVectorHandler(IN PKTRAP_FRAME Frame)
/*++
...
BOOLEAN
KiIA32ExceptionVectorHandler(IN PKTRAP_FRAME Frame)
/*++
...
BOOLEAN
KiIA32InterruptionVectorHandler(IN PKTRAP_FRAME Frame)
/*++
...
--*/
{
    ...
    KiIA32CommonArgs(Frame, STATUS_ACCESS_VIOLATION, (PVOID)(ULONG_PTR)EIP(Frame), 0, 0, 0);
    return TRUE;
}
