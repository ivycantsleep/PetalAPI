...
// GET/PUT F1
// ***************************************************************
void GETSTATE_F1(EM_pred_reg_specifier Pr0, EM_fp_reg_specifier Fr1, EM_fp_reg_specifier Fr3, EM_fp_reg_specifier Fr4,
...
// GET/PUT F4
// ***************************************************************
void GETSTATE_F4(EM_pred_reg_specifier Pr0, EM_pred_reg_specifier Pr1, EM_pred_reg_specifier Pr2,
                 EM_fp_reg_specifier Fr2, EM_fp_reg_specifier Fr3)
{
}
...
// GET/PUT F6
// ***************************************************************
void GETSTATE_F6(EM_pred_reg_specifier Pr0, EM_fp_reg_specifier Fr1, EM_pred_reg_specifier Pr2, EM_fp_reg_specifier Fr2,
...
EM_boolean_t fp82_fp_software_assistance_required(EM_state_type *ps, EM_opcode_type calling_instruction, ...)
{
    return (0);
}
...
INLINE void reserved_register_field_fault(EM_uint_t val)
{
#ifdef IN_KERNEL
