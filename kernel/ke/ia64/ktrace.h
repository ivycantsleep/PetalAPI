...
#if DBG
ULONG
__stdcall KeDumpKTrace(ULONG ProcessorNumber, ULONG StartEntry, ULONG NumberOfEntries, ULONGLONG ModuleFilter,
                       ULONGLONG MessageFilter, BOOLEAN Sort);
#else
#define KeDumpKTrace
#endif
...
//
#if DBG
VOID __stdcall KeEnableKTrace(ULONG IDMask);
#else
#define KeEnableKTrace
#endif

#if DBG
VOID NTAPI // __stdcall
DumpRecord(IN ULONG ProcessorNumber, IN ULONG Index);
#else
#define DumpRecord
#endif
