...
static INLINE void _fcmp(EM_state_type *ps, EM_opcode_frel_type frel, EM_opcode_ctype_type ctype, EM_opcode_sf_type sf,
...
#define fp_ieee_rnd_to_int_sp(arg1, arg2, arg3) fp82_fp_ieee_rnd_to_int_sp(ps, arg1, arg2, arg3)
...
#define frcpa_exception_fault_check(arg1, arg2, arg3, arg4) fp82_frcpa_exception_fault_check(ps, arg1, arg2, arg3, arg4)
...
#define frsqrta_exception_fault_check(arg1, arg2, arg3) fp82_frsqrta_exception_fault_check(ps, arg1, arg2, arg3)

#define fprsqrta_exception_fault_check(arg1, arg2, arg3, arg4) \
    fp82_fprsqrta_exception_fault_check(ps, arg1, arg2, arg3, arg4)

#define illegal_operation_fault(NON_RS) fp82_illegal_operation_fault(ps, NON_RS)

#define fp_check_target_register(reg_specifier) fp82_fp_check_target_register(ps, reg_specifier)

#define fp_exception_fault(tmp) fp82_fp_exception_fault(ps, tmp)

#define fp_exception_trap(tmp) fp82_fp_exception_trap(ps, tmp)

#define disabled_fp_register_fault(isr_code, itype) fp82_disabled_fp_register_fault(ps, isr_code, itype)
