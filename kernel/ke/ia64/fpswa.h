...
#define EFI_INTEL_FPSWA { 0xc41b6531, 0x97b9, 0x11d3, 0x9a, 0x29, 0x0, 0x90, 0x27, 0x3f, 0xc1, 0x4d }
...
typedef PAL_RETURN (*EFI_FPSWA)(IN unsigned int TrapType, IN OUT BUNDLE *pBundle, IN OUT UINT64 *pipsr,
                                IN OUT UINT64 *pfsr, IN OUT UINT64 *pisr, IN OUT UINT64 *ppreds, IN OUT UINT64 *pifs,
