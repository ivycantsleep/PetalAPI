...
*/
{
    ...
    Status = RtlAdjustPrivilege(SE_RESTORE_PRIVILEGE, TRUE, FALSE, &OldPrivState);
    ...
    {
        Err = RegOpenKeyEx(HKEY_LOCAL_MACHINE, TEMP_KEY_NAME, REG_OPTION_RESERVED, KEY_READ, &hkey);
        ...
        if (Err == ERROR_SUCCESS)
        {
            ...
            if (!OldPrivState)
            {
                ...
                RtlAdjustPrivilege(SE_RESTORE_PRIVILEGE, FALSE, FALSE, &OldPrivState);
            }


            RtlAdjustPrivilege(SE_BACKUP_PRIVILEGE, TRUE, FALSE, &OldPrivState);
        ...
        RtlAdjustPrivilege(SE_RESTORE_PRIVILEGE, TRUE, FALSE, &OldPrivState);
