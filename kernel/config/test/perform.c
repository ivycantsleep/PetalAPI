...
BOOLEAN
AdjustPrivilege(PSTR SecurityNameString)
{
    HANDLE TokenHandle;
...
*/
    ...
    Status = RegCreateKeyExW(TestKeyHandle, KEY1_NAME, NULL, NULL, REG_OPTION_NON_VOLATILE, MAXIMUM_ALLOWED, NULL,
                             &Key1Handle, &Disposition);
    ...
    Status = RegEnumValueW(Key1Handle, 0, BufferForValueEntryName, &NameSize, NULL, &DataType, BufferForValueEntryData,
                           &DataSize);
    ...
    Status = RegEnumKeyExW(TestKeyHandle, 0, BufferForKeyName, &NameSize, NULL, BufferForKeyClass, &ClassSize,
                           &ftLastWriteTime);
    ...
    ClassSize = sizeof(BufferForKeyClass);
    Status = RegQueryInfoKeyW(Key1Handle, BufferForKeyClass, &ClassSize, NULL, &cSubKeys, &cbMaxSubkey, &cbMaxClass,
                              &cValues, &vbMaxValueName, &cbMaxValueData, &cbSecurityDescriptor, &ftLastWriteTime);
    ...
    Status = RegGetKeySecurity(Key1Handle, DACL_SECURITY_INFORMATION, (PSECURITY_DESCRIPTOR)BufferForSecurityDescriptor,
    ...
    Status =
        RegSetKeySecurity(Key1Handle, DACL_SECURITY_INFORMATION, (PSECURITY_DESCRIPTOR)BufferForSecurityDescriptor);
...
*/
    ...
    Status = RegNotifyChangeKeyValue(HKEY_CURRENT_USER, TRUE,
