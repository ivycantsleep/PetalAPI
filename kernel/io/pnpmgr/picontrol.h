...
typedef NTSTATUS (*PLUGPLAY_CONTROL_HANDLER)(IN PLUGPLAY_CONTROL_CLASS PnPControlClass, IN OUT PVOID PnPControlData,
...
PiControlRetrieveDockData(IN PLUGPLAY_CONTROL_CLASS PnPControlClass,
                          IN OUT PPLUGPLAY_CONTROL_RETRIEVE_DOCK_DATA DockData, IN ULONG DockDataLength,
                          IN KPROCESSOR_MODE CallerMode);
