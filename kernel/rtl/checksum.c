...
USHORT
ChkSum(ULONG PartialSum, PUSHORT Source, ULONG Length);
...
BOOLEAN
LdrVerifyMappedImageMatchesChecksum(IN PVOID BaseAddress, IN ULONG FileLength)
...
ULONG32
RtlComputeCrc32(ULONG32 PartialCrc, PUCHAR Buffer, ULONG Length)
