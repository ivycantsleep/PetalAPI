...

{
    ...
    PEPROCESS Process;
    PTEB Teb;
    NTSTATUS KillStatus = STATUS_THREAD_IS_TERMINATING;
    ULONG OldFlags;
    BOOLEAN KillThread;
    ...
    if (!KillThread)
    {
        ...
        //
        // We just queued a user APC to this thread in the create path.
        // User APCs won't fire until we do an alertable wait so we need
