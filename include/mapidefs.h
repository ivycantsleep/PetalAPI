...
#define CbSPropProblemArray(_lparray) \
    (offsetof(SPropProblemArray, aProblem) + (UINT)((_lparray)->cProblem * sizeof(SPropProblem)))
...
#define SizedSRowSet(_crow, _name) \
    ...
    typedef SCODE(STDMETHODCALLTYPE ALLOCATEBUFFER)(ULONG cbSize, LPVOID FAR *lppBuffer);

    typedef SCODE(STDMETHODCALLTYPE ALLOCATEMORE)(ULONG cbSize, LPVOID lpObject, LPVOID FAR *lppBuffer);
...
#define DECLARE_MAPI_INTERFACE_PTR(iface, piface) typedef struct iface##Vtbl iface##Vtbl, FAR *iface, FAR *FAR *piface;
#else
...
#else
#define DECLARE_MAPI_INTERFACE_PTR(iface, piface) typedef interface iface iface, FAR *piface
#endif
#endif
...
#define MAPI_IMAPIADVISESINK_METHODS(IPURE) \
    ...
    (THIS_ ULONG cNotif, LPNOTIFICATION lpNotifications) IPURE;

#undef INTERFACE
#define INTERFACE IMAPIAdviseSink
    DECLARE_MAPI_INTERFACE_(IMAPIAdviseSink,
                            IUnknown){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IMAPIADVISESINK_METHODS(PURE) };

    /* Callback function type for MAPIAllocAdviseSink */

    typedef long(STDAPICALLTYPE NOTIFCALLBACK)(LPVOID lpvContext, ULONG cNotification, LPNOTIFICATION lpNotifications);
...
#define MAPI_IMAPIPROGRESS_METHODS(IPURE)                      \
    MAPIMETHOD(Progress)                                       \
    (THIS_ ULONG ulValue, ULONG ulCount, ULONG ulTotal) IPURE; \
    MAPIMETHOD(GetFlags)                                       \
    ...
    (THIS_ LPULONG lpulMin, LPULONG lpulMax, LPULONG lpulFlags) IPURE;

#undef INTERFACE
#define INTERFACE IMAPIProgress
    DECLARE_MAPI_INTERFACE_(IMAPIProgress,
                            IUnknown){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IMAPIPROGRESS_METHODS(PURE) };
...
#define MAPI_IMAPIPROP_METHODS(IPURE)                                                                             \
    ...
    MAPIMETHOD(GetProps)                                                                                          \
    (THIS_ LPSPropTagArray lpPropTagArray, ULONG ulFlags, ULONG FAR * lpcValues, LPSPropValue FAR * lppPropArray) \
        IPURE;                                                                                                    \
    MAPIMETHOD(GetPropList)                                                                                       \
    (THIS_ ULONG ulFlags, LPSPropTagArray FAR * lppPropTagArray) IPURE;                                           \
    MAPIMETHOD(OpenProperty)                                                                                      \
    (THIS_ ULONG ulPropTag, LPCIID lpiid, ULONG ulInterfaceOptions, ULONG ulFlags, LPUNKNOWN FAR * lppUnk) IPURE; \
    MAPIMETHOD(SetProps)                                                                                          \
    (THIS_ ULONG cValues, LPSPropValue lpPropArray, LPSPropProblemArray FAR * lppProblems) IPURE;                 \
    MAPIMETHOD(DeleteProps)                                                                                       \
    (THIS_ LPSPropTagArray lpPropTagArray, LPSPropProblemArray FAR * lppProblems) IPURE;                          \
    MAPIMETHOD(CopyTo)                                                                                            \
    (THIS_ ULONG ciidExclude, LPCIID rgiidExclude, LPSPropTagArray lpExcludeProps, ULONG ulUIParam,               \
    ...
    (THIS_ LPSPropTagArray lpIncludeProps, ULONG ulUIParam, LPMAPIPROGRESS lpProgress, LPCIID lpInterface,        \
     LPVOID lpDestObj, ULONG ulFlags, LPSPropProblemArray FAR * lppProblems) IPURE;                               \
    MAPIMETHOD(GetNamesFromIDs)                                                                                   \
    (THIS_ LPSPropTagArray FAR * lppPropTags, LPGUID lpPropSetGuid, ULONG ulFlags, ULONG FAR * lpcPropNames,      \
     LPMAPINAMEID FAR * FAR * lpppPropNames) IPURE;                                                               \
    MAPIMETHOD(GetIDsFromNames)                                                                                   \
    (THIS_ ULONG cPropNames, LPMAPINAMEID FAR * lppPropNames, ULONG ulFlags, LPSPropTagArray FAR * lppPropTags) IPURE;

#undef INTERFACE
#define INTERFACE IMAPIProp
    DECLARE_MAPI_INTERFACE_(IMAPIProp,
                            IUnknown){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IMAPIPROP_METHODS(PURE) };
...
#define MAPI_IMAPITABLE_METHODS(IPURE)                                                                          \
    ...
    (THIS_ HRESULT hResult, ULONG ulFlags, LPMAPIERROR FAR * lppMAPIError) IPURE;                               \
    MAPIMETHOD(Advise)                                                                                          \
    (THIS_ ULONG ulEventMask, LPMAPIADVISESINK lpAdviseSink, ULONG FAR * lpulConnection) IPURE;                 \
    MAPIMETHOD(Unadvise)                                                                                        \
    (THIS_ ULONG ulConnection) IPURE;                                                                           \
    MAPIMETHOD(GetStatus)                                                                                       \
    (THIS_ ULONG FAR * lpulTableStatus, ULONG FAR * lpulTableType) IPURE;                                       \
    MAPIMETHOD(SetColumns)                                                                                      \
    (THIS_ LPSPropTagArray lpPropTagArray, ULONG ulFlags) IPURE;                                                \
    MAPIMETHOD(QueryColumns)                                                                                    \
    (THIS_ ULONG ulFlags, LPSPropTagArray FAR * lpPropTagArray) IPURE;                                          \
    MAPIMETHOD(GetRowCount)                                                                                     \
    (THIS_ ULONG ulFlags, ULONG FAR * lpulCount) IPURE;                                                         \
    MAPIMETHOD(SeekRow)                                                                                         \
    (THIS_ BOOKMARK bkOrigin, LONG lRowCount, LONG FAR * lplRowsSought) IPURE;                                  \
    MAPIMETHOD(SeekRowApprox)                                                                                   \
    (THIS_ ULONG ulNumerator, ULONG ulDenominator) IPURE;                                                       \
    MAPIMETHOD(QueryPosition)                                                                                   \
    (THIS_ ULONG FAR * lpulRow, ULONG FAR * lpulNumerator, ULONG FAR * lpulDenominator) IPURE;                  \
    MAPIMETHOD(FindRow)                                                                                         \
    (THIS_ LPSRestriction lpRestriction, BOOKMARK bkOrigin, ULONG ulFlags) IPURE;                               \
    MAPIMETHOD(Restrict)                                                                                        \
    (THIS_ LPSRestriction lpRestriction, ULONG ulFlags) IPURE;                                                  \
    ...
    (THIS_ LPSSortOrderSet lpSortCriteria, ULONG ulFlags) IPURE;                                                \
    MAPIMETHOD(QuerySortOrder)                                                                                  \
    (THIS_ LPSSortOrderSet FAR * lppSortCriteria) IPURE;                                                        \
    MAPIMETHOD(QueryRows)                                                                                       \
    (THIS_ LONG lRowCount, ULONG ulFlags, LPSRowSet FAR * lppRows) IPURE;                                       \
    MAPIMETHOD(Abort)(THIS) IPURE;                                                                              \
    MAPIMETHOD(ExpandRow)                                                                                       \
    (THIS_ ULONG cbInstanceKey, LPBYTE pbInstanceKey, ULONG ulRowCount, ULONG ulFlags, LPSRowSet FAR * lppRows, \
     ULONG FAR * lpulMoreRows) IPURE;                                                                           \
    MAPIMETHOD(CollapseRow)                                                                                     \
    (THIS_ ULONG cbInstanceKey, LPBYTE pbInstanceKey, ULONG ulFlags, ULONG FAR * lpulRowCount) IPURE;           \
    MAPIMETHOD(WaitForCompletion)                                                                               \
    (THIS_ ULONG ulFlags, ULONG ulTimeout, ULONG FAR * lpulTableStatus) IPURE;                                  \
    MAPIMETHOD(GetCollapseState)                                                                                \
    (THIS_ ULONG ulFlags, ULONG cbInstanceKey, LPBYTE lpbInstanceKey, ULONG FAR * lpcbCollapseState,            \
     LPBYTE FAR * lppbCollapseState) IPURE;                                                                     \
    MAPIMETHOD(SetCollapseState)                                                                                \
    (THIS_ ULONG ulFlags, ULONG cbCollapseState, LPBYTE pbCollapseState, BOOKMARK FAR * lpbkLocation) IPURE;

#undef INTERFACE
#define INTERFACE IMAPITable
    DECLARE_MAPI_INTERFACE_(IMAPITable,
                            IUnknown){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IMAPITABLE_METHODS(PURE) };
...
#define PS_PROFILE_PROPERTIES_INIT \
    { 0x98, 0x15, 0xAC, 0x08, 0xAA, 0xB0, 0x10, 0x1A, 0x8C, 0x93, 0x08, 0x00, 0x2B, 0x2A, 0x56, 0xC2 }
...
#define INTERFACE IProfSect
    DECLARE_MAPI_INTERFACE_(IProfSect, IMAPIProp){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE)
                                                       MAPI_IMAPIPROP_METHODS(PURE) MAPI_IPROFSECT_METHODS(PURE) };
...
#define MAPI_IMAPISTATUS_METHODS(IPURE)                              \
    ...
    (THIS_ ULONG ulUIParam, ULONG ulFlags) IPURE;                    \
    MAPIMETHOD(SettingsDialog)                                       \
    (THIS_ ULONG ulUIParam, ULONG ulFlags) IPURE;                    \
    MAPIMETHOD(ChangePassword)                                       \
    (THIS_ LPTSTR lpOldPass, LPTSTR lpNewPass, ULONG ulFlags) IPURE; \
    MAPIMETHOD(FlushQueues)                                          \
    (THIS_ ULONG ulUIParam, ULONG cbTargetTransport, LPENTRYID lpTargetTransport, ULONG ulFlags) IPURE;

#undef INTERFACE
#define INTERFACE IMAPIStatus
    DECLARE_MAPI_INTERFACE_(IMAPIStatus, IMAPIProp){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE)
                                                         MAPI_IMAPIPROP_METHODS(PURE) MAPI_IMAPISTATUS_METHODS(PURE) };
...
#define MAPI_IMAPICONTAINER_METHODS(IPURE)                                                                   \
    ...
    (THIS_ ULONG cbEntryID, LPENTRYID lpEntryID, LPCIID lpInterface, ULONG ulFlags, ULONG FAR * lpulObjType, \
     LPUNKNOWN FAR * lppUnk) IPURE;                                                                          \
    MAPIMETHOD(SetSearchCriteria)                                                                            \
    (THIS_ LPSRestriction lpRestriction, LPENTRYLIST lpContainerList, ULONG ulSearchFlags) IPURE;            \
    MAPIMETHOD(GetSearchCriteria)                                                                            \
    (THIS_ ULONG ulFlags, LPSRestriction FAR * lppRestriction, LPENTRYLIST FAR * lppContainerList,           \
     ULONG FAR * lpulSearchState) IPURE;

#undef INTERFACE
#define INTERFACE IMAPIContainer
    DECLARE_MAPI_INTERFACE_(IMAPIContainer, IMAPIProp){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE)
...
#define MAPI_IABCONTAINER_METHODS(IPURE)                                                                        \
    ...
    (THIS_ ULONG cbEntryID, LPENTRYID lpEntryID, ULONG ulCreateFlags, LPMAPIPROP FAR * lppMAPIPropEntry) IPURE; \
    MAPIMETHOD(CopyEntries)                                                                                     \
    (THIS_ LPENTRYLIST lpEntries, ULONG ulUIParam, LPMAPIPROGRESS lpProgress, ULONG ulFlags) IPURE;             \
    MAPIMETHOD(DeleteEntries)                                                                                   \
    (THIS_ LPENTRYLIST lpEntries, ULONG ulFlags) IPURE;                                                         \
    MAPIMETHOD(ResolveNames)                                                                                    \
    (THIS_ LPSPropTagArray lpPropTagArray, ULONG ulFlags, LPADRLIST lpAdrList, LPFlagList lpFlagList) IPURE;

#undef INTERFACE
#define INTERFACE IABContainer
    DECLARE_MAPI_INTERFACE_(IABContainer,
                            IMAPIContainer){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IMAPIPROP_METHODS(PURE)
                                                 MAPI_IMAPICONTAINER_METHODS(PURE) MAPI_IABCONTAINER_METHODS(PURE) };
...
#define INTERFACE IMailUser
    DECLARE_MAPI_INTERFACE_(IMailUser, IMAPIProp){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE)
                                                       MAPI_IMAPIPROP_METHODS(PURE) MAPI_IMAILUSER_METHODS(PURE) };
...
#define INTERFACE IDistList
    DECLARE_MAPI_INTERFACE_(IDistList,
                            IMAPIContainer){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IMAPIPROP_METHODS(PURE)
                                                 MAPI_IMAPICONTAINER_METHODS(PURE) MAPI_IDISTLIST_METHODS(PURE) };
...
#define MAPI_IMAPIFOLDER_METHODS(IPURE)                                                                                \
    ...
    (THIS_ LPCIID lpInterface, ULONG ulFlags, LPMESSAGE FAR * lppMessage) IPURE;                                       \
    MAPIMETHOD(CopyMessages)                                                                                           \
    (THIS_ LPENTRYLIST lpMsgList, LPCIID lpInterface, LPVOID lpDestFolder, ULONG ulUIParam, LPMAPIPROGRESS lpProgress, \
     ULONG ulFlags) IPURE;                                                                                             \
    MAPIMETHOD(DeleteMessages)                                                                                         \
    (THIS_ LPENTRYLIST lpMsgList, ULONG ulUIParam, LPMAPIPROGRESS lpProgress, ULONG ulFlags) IPURE;                    \
    MAPIMETHOD(CreateFolder)                                                                                           \
    (THIS_ ULONG ulFolderType, LPTSTR lpszFolderName, LPTSTR lpszFolderComment, LPCIID lpInterface, ULONG ulFlags,     \
     LPMAPIFOLDER FAR * lppFolder) IPURE;                                                                              \
    MAPIMETHOD(CopyFolder)                                                                                             \
    (THIS_ ULONG cbEntryID, LPENTRYID lpEntryID, LPCIID lpInterface, LPVOID lpDestFolder, LPTSTR lpszNewFolderName,    \
     ULONG ulUIParam, LPMAPIPROGRESS lpProgress, ULONG ulFlags) IPURE;                                                 \
    MAPIMETHOD(DeleteFolder)                                                                                           \
    (THIS_ ULONG cbEntryID, LPENTRYID lpEntryID, ULONG ulUIParam, LPMAPIPROGRESS lpProgress, ULONG ulFlags) IPURE;     \
    MAPIMETHOD(SetReadFlags)                                                                                           \
    (THIS_ LPENTRYLIST lpMsgList, ULONG ulUIParam, LPMAPIPROGRESS lpProgress, ULONG ulFlags) IPURE;                    \
    MAPIMETHOD(GetMessageStatus)                                                                                       \
    (THIS_ ULONG cbEntryID, LPENTRYID lpEntryID, ULONG ulFlags, ULONG FAR * lpulMessageStatus) IPURE;                  \
    MAPIMETHOD(SetMessageStatus)                                                                                       \
    (THIS_ ULONG cbEntryID, LPENTRYID lpEntryID, ULONG ulNewStatus, ULONG ulNewStatusMask, ULONG FAR * lpulOldStatus)  \
        IPURE;                                                                                                         \
    MAPIMETHOD(SaveContentsSort)                                                                                       \
    (THIS_ LPSSortOrderSet lpSortCriteria, ULONG ulFlags) IPURE;                                                       \
    MAPIMETHOD(EmptyFolder)                                                                                            \
    (THIS_ ULONG ulUIParam, LPMAPIPROGRESS lpProgress, ULONG ulFlags) IPURE;

#undef INTERFACE
#define INTERFACE IMAPIFolder
    DECLARE_MAPI_INTERFACE_(IMAPIFolder,
                            IMAPIContainer){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IMAPIPROP_METHODS(PURE)
                                                 MAPI_IMAPICONTAINER_METHODS(PURE) MAPI_IMAPIFOLDER_METHODS(PURE) };
...
#define MAPI_IMSGSTORE_METHODS(IPURE)                                                                        \
    MAPIMETHOD(Advise)                                                                                       \
    (THIS_ ULONG cbEntryID, LPENTRYID lpEntryID, ULONG ulEventMask, LPMAPIADVISESINK lpAdviseSink,           \
     ULONG FAR * lpulConnection) IPURE;                                                                      \
    MAPIMETHOD(Unadvise)                                                                                     \
    (THIS_ ULONG ulConnection) IPURE;                                                                        \
    MAPIMETHOD(CompareEntryIDs)                                                                              \
    (THIS_ ULONG cbEntryID1, LPENTRYID lpEntryID1, ULONG cbEntryID2, LPENTRYID lpEntryID2, ULONG ulFlags,    \
     ULONG FAR * lpulResult) IPURE;                                                                          \
    MAPIMETHOD(OpenEntry)                                                                                    \
    (THIS_ ULONG cbEntryID, LPENTRYID lpEntryID, LPCIID lpInterface, ULONG ulFlags, ULONG FAR * lpulObjType, \
     LPUNKNOWN FAR * lppUnk) IPURE;                                                                          \
    MAPIMETHOD(SetReceiveFolder)                                                                             \
    (THIS_ LPTSTR lpszMessageClass, ULONG ulFlags, ULONG cbEntryID, LPENTRYID lpEntryID) IPURE;              \
    MAPIMETHOD(GetReceiveFolder)                                                                             \
    (THIS_ LPTSTR lpszMessageClass, ULONG ulFlags, ULONG FAR * lpcbEntryID, LPENTRYID FAR * lppEntryID,      \
    ...
    (THIS_ ULONG cbEntryID, LPENTRYID lpEntryID, ULONG ulFlags) IPURE;                                       \
    MAPIMETHOD(GetOutgoingQueue)                                                                             \
    (THIS_ ULONG ulFlags, LPMAPITABLE FAR * lppTable) IPURE;                                                 \
    MAPIMETHOD(SetLockState)                                                                                 \
    (THIS_ LPMESSAGE lpMessage, ULONG ulLockState) IPURE;                                                    \
...
#define INTERFACE IMsgStore
    DECLARE_MAPI_INTERFACE_(IMsgStore, IMAPIProp){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE)
                                                       MAPI_IMAPIPROP_METHODS(PURE) MAPI_IMSGSTORE_METHODS(PURE) };
...
#define MAPI_IMESSAGE_METHODS(IPURE)                                                                          \
    ...
    (THIS_ ULONG ulAttachmentNum, LPCIID lpInterface, ULONG ulFlags, LPATTACH FAR * lppAttach) IPURE;         \
    MAPIMETHOD(CreateAttach)                                                                                  \
    (THIS_ LPCIID lpInterface, ULONG ulFlags, ULONG FAR * lpulAttachmentNum, LPATTACH FAR * lppAttach) IPURE; \
    MAPIMETHOD(DeleteAttach)                                                                                  \
    (THIS_ ULONG ulAttachmentNum, ULONG ulUIParam, LPMAPIPROGRESS lpProgress, ULONG ulFlags) IPURE;           \
    MAPIMETHOD(GetRecipientTable)                                                                             \
    (THIS_ ULONG ulFlags, LPMAPITABLE FAR * lppTable) IPURE;                                                  \
    MAPIMETHOD(ModifyRecipients)                                                                              \
    (THIS_ ULONG ulFlags, LPADRLIST lpMods) IPURE;                                                            \
...
#define INTERFACE IMessage
    DECLARE_MAPI_INTERFACE_(IMessage, IMAPIProp){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE)
                                                      MAPI_IMAPIPROP_METHODS(PURE) MAPI_IMESSAGE_METHODS(PURE) };
...
#define INTERFACE IAttach
    DECLARE_MAPI_INTERFACE_(IAttach, IMAPIProp){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE)
                                                     MAPI_IMAPIPROP_METHODS(PURE) MAPI_IATTACH_METHODS(PURE) };
 ...
 */
    ...
    typedef SCODE(STDMETHODCALLTYPE FAR *LPFNBUTTON)(ULONG ulUIParam, LPVOID lpvContext, ULONG cbEntryID,
                                                     LPENTRYID lpSelection, ULONG ulFlags);
...
#define MAPI_IMAPICONTROL_METHODS(IPURE)                                          \
    ...
    (THIS_ HRESULT hResult, ULONG ulFlags, LPMAPIERROR FAR * lppMAPIError) IPURE; \
    MAPIMETHOD(Activate)                                                          \
    (THIS_ ULONG ulFlags, ULONG ulUIParam) IPURE;                                 \
    MAPIMETHOD(GetState)                                                          \
    (THIS_ ULONG ulFlags, ULONG FAR * lpulState) IPURE;

#undef INTERFACE
#define INTERFACE IMAPIControl
    DECLARE_MAPI_INTERFACE_(IMAPIControl,
                            IUnknown){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IMAPICONTROL_METHODS(PURE) };
...
#define MAPI_IPROVIDERADMIN_METHODS(IPURE)                                                           \
    ...
    (THIS_ LPTSTR lpszProvider, ULONG cValues, LPSPropValue lpProps, ULONG ulUIParam, ULONG ulFlags, \
     MAPIUID FAR * lpUID) IPURE;                                                                     \
    MAPIMETHOD(DeleteProvider)                                                                       \
    (THIS_ LPMAPIUID lpUID) IPURE;                                                                   \
    MAPIMETHOD(OpenProfileSection)                                                                   \
    (THIS_ LPMAPIUID lpUID, LPCIID lpInterface, ULONG ulFlags, LPPROFSECT FAR * lppProfSect) IPURE;


#undef INTERFACE
#define INTERFACE IProviderAdmin
    DECLARE_MAPI_INTERFACE_(IProviderAdmin,
                            IUnknown){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IPROVIDERADMIN_METHODS(PURE) };
