...
#define HHN_WINDOW_CREATE (HHN_FIRST - 2)
    ...
    typedef struct tagHH_ENUM_IT
    {
        ...
        LPCSTR
            pszITName; // volitile pointer to the name of the infotype. Allocated by call. Caller responsible for freeing
...
#define HH_FTS_DEFAULT_PROXIMITY (-1)
    ...
    typedef struct tagHH_WINTYPE
    {
        ...
        BYTE tabOrder[HH_MAX_TABS +
                      1]; // IN/OUT: tab order: Contents, Index, Search, History, Favorites, Reserved 1-5, Custom tabs
