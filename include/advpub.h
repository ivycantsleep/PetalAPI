...
#define achRUNSETUPCOMMANDFUNCTION "RunSetupCommand"
    ...
    HRESULT WINAPI RunSetupCommand(HWND hWnd, LPCSTR szCmdName, LPCSTR szInfSection, LPCSTR szDir, LPCSTR lpszTitle,
                                   HANDLE *phEXE, DWORD dwFlags, LPVOID pvReserved);

    typedef HRESULT(WINAPI *RUNSETUPCOMMAND)(HWND hWnd,           // Handle to parent window  NULL=Quiet mode
...
#define achNEEDREBOOTFUNCTION "NeedReboot"
    ...
    typedef BOOL(WINAPI *NEEDREBOOT)(DWORD dwRebootCheck // Value returned from NeedRebootInit
    );
...
#define c_szTRANSLATEINFSTRING "TranslateInfString"
    ...
    HRESULT WINAPI TranslateInfString(PCSTR pszInfFilename, PCSTR pszInstallSection, PCSTR pszTranslateSection,
...
#define achREGINSTALL "RegInstall"
    ...
    typedef HRESULT(WINAPI *REGINSTALL)(HMODULE hm,          // Module that contains REGINST resource
...
#define achLAUNCHINFSECTIONEX "LaunchINFSectionEx"
    ...
    typedef HRESULT(WINAPI *LAUNCHINFSECTIONEX)(HWND hwnd,       // pass in window handle
...
#define AIF_NOOVERWRITE                                                              \
    0x00000010                           // copy only if target doesn't exist        \
...
#define AIF_NOLANGUAGECHECK                                                 \
    0x10000000               // don't check the language of the file        \
...
#define achADVINSTALLFILE "AdvInstallFile"
    ...
    HRESULT WINAPI AdvInstallFile(HWND hwnd, LPCSTR lpszSourceDir, LPCSTR lpszSourceFile, LPCSTR lpszDestDir,
                                  LPCSTR lpszDestFile, DWORD dwFlags, DWORD dwReserved);

    typedef HRESULT(WINAPI *ADVINSTALLFILE)(HWND hwnd,             // Parent Window for messages
...
#define IE4_NO_CRC_MAPPING                                                                         \
    0x00000040                        // Normally you should not turn on this bit, advpack creates \
...
#define IE4_REMOVREGBKDATA 0x00001000 // This bit should be used with restore bit
    ...
    HRESULT WINAPI RegSaveRestore(HWND hWnd, PCSTR pszTitleString, HKEY hkBckupKey, PCSTR pcszRootKey, PCSTR pcszSubKey,
    ...
    HRESULT WINAPI RegSaveRestoreOnINF(HWND hWnd, PCSTR pszTitle, PCSTR pszINF, PCSTR pszSection, HKEY hHKLMBackKey,
...
#define ARSR_REMOVREGBKDATA \
    IE4_REMOVREGBKDATA // if both this bit and restore bit on, remove the backup reg data without restore it
...
#define REG_RESTORE_LOG_KEY "RegRestoreLogFile"
    ...
    HRESULT WINAPI FileSaveRestoreOnINF(HWND hWnd, PCSTR pszTitle, PCSTR pszINF, PCSTR pszSection, PCSTR pszBackupDir,
...
#define AADBE_DEL_ENTRY 0x02 // delete entries from the INI file
    ...
    typedef HRESULT(WINAPI *GETVERSIONFROMFILE)(LPSTR lpszFilename, // filename to get info from
...
#define achDELNODE "DelNode"
    ...
    typedef HRESULT(WINAPI *DELNODE)(LPCSTR pszFileOrDirName, // Name of file or directory to delete
...
#define achDELNODERUNDLL32 "DelNodeRunDLL32"
    ...
    typedef HRESULT(WINAPI *DELNODERUNDLL32)(HWND hwnd,       // pass in window handle
                                             HINSTANCE hInst, // instance handle
    ...
    HRESULT WINAPI TranslateInfStringEx(HINF hInf, PCSTR pszInfFilename, PCSTR pszTranslateSection,
                                        PCSTR pszTranslateKey, PSTR pszBuffer, DWORD dwBufferSize,
                                        PDWORD pdwRequiredSize, PVOID pvReserved);

    HRESULT WINAPI CloseINFEngine(HINF hInf);


    HRESULT WINAPI ExtractFiles(LPCSTR pszCabName, LPCSTR pszExpandDir, DWORD dwFlags, LPCSTR pszFileList,
                                LPVOID lpReserved, DWORD dwReserved);
...
#define achUserInstStubWrapper "UserInstStubWrapper"
    ...
    typedef HRESULT(WINAPI *USERINSTSTUBWRAPPER)(HWND hwnd,       // pass in window handle
                                                 HINSTANCE hInst, // instance handle
...
#define achUserUnInstStubWrapper "UserUnInstStubWrapper"
    ...
    typedef HRESULT(WINAPI *USERUNINSTSTUBWRAPPER)(HWND hwnd,       // pass in window handle
                                                   HINSTANCE hInst, // instance handle
                                                   PSTR pszParams,  // String contains params: {GUID}
                                                   INT nShow);
