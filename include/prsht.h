...
#define IsolationAwarePropertySheet IsolationAwarePropertySheetA
    ...
    ISOLATION_AWARE_INLINE HPROPSHEETPAGE WINAPI
    IsolationAwareCreatePropertySheetPageA(LPCPROPSHEETPAGEA constPropSheetPagePointer)
    {
    ...
    ISOLATION_AWARE_INLINE HPROPSHEETPAGE WINAPI
    IsolationAwareCreatePropertySheetPageW(LPCPROPSHEETPAGEW constPropSheetPagePointer)
    {
        HPROPSHEETPAGE result = NULL;
