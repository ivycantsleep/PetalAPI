...
#define MAPI_MULTITHREAD_NOTIFICATIONS 0x00000001
    ...
    typedef HRESULT(STDMETHODCALLTYPE MAPILOGONEX)(
        ULONG_PTR ulUIParam, LPTSTR lpszProfileName, LPTSTR lpszPassword,
...
#define MAPI_IMAPISESSION_METHODS(IPURE)                                                                        \
    ...
    (THIS_ ULONG_PTR ulUIParam, ULONG cbEntryID, LPENTRYID lpEntryID, LPCIID lpInterface, ULONG ulFlags,        \
     LPMDB FAR * lppMDB) IPURE;                                                                                 \
    MAPIMETHOD(OpenAddressBook)                                                                                 \
    (THIS_ ULONG_PTR ulUIParam, LPCIID lpInterface, ULONG ulFlags, LPADRBOOK FAR * lppAdrBook) IPURE;           \
    ...
    (THIS_ ULONG_PTR ulUIParam, ULONG ulFlags, LPTSTR lpszAdrType, LPMESSAGE lpMessage) IPURE;                  \
    MAPIMETHOD(QueryDefaultMessageOpt)                                                                          \
    (THIS_ LPTSTR lpszAdrType, ULONG ulFlags, ULONG FAR * lpcValues, LPSPropValue FAR * lppOptions) IPURE;      \
    MAPIMETHOD(EnumAdrTypes)                                                                                    \
    (THIS_ ULONG ulFlags, ULONG FAR * lpcAdrTypes, LPTSTR FAR * FAR * lpppszAdrTypes) IPURE;                    \
    MAPIMETHOD(QueryIdentity)                                                                                   \
    (THIS_ ULONG FAR * lpcbEntryID, LPENTRYID FAR * lppEntryID) IPURE;                                          \
    MAPIMETHOD(Logoff)                                                                                          \
    (THIS_ ULONG_PTR ulUIParam, ULONG ulFlags, ULONG ulReserved) IPURE;                                         \
    MAPIMETHOD(SetDefaultStore)                                                                                 \
    (THIS_ ULONG ulFlags, ULONG cbEntryID, LPENTRYID lpEntryID) IPURE;                                          \
    MAPIMETHOD(AdminServices)                                                                                   \
    (THIS_ ULONG ulFlags, LPSERVICEADMIN FAR * lppServiceAdmin) IPURE;                                          \
    MAPIMETHOD(ShowForm)                                                                                        \
    (THIS_ ULONG_PTR ulUIParam, LPMDB lpMsgStore, LPMAPIFOLDER lpParentFolder, LPCIID lpInterface,              \
     ULONG ulMessageToken, LPMESSAGE lpMessageSent, ULONG ulFlags, ULONG ulMessageStatus, ULONG ulMessageFlags, \
     ULONG ulAccess, LPSTR lpszMessageClass) IPURE;                                                             \
    MAPIMETHOD(PrepareForm)                                                                                     \
    (THIS_ LPCIID lpInterface, LPMESSAGE lpMessage, ULONG FAR * lpulMessageToken) IPURE;


#undef INTERFACE
#define INTERFACE IMAPISession
    DECLARE_MAPI_INTERFACE_(IMAPISession,
                            IUnknown){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IMAPISESSION_METHODS(PURE) };
...
#define MAPI_IADDRBOOK_METHODS(IPURE)                                                                                  \
    ...
    (THIS_ LPTSTR lpszName, LPTSTR lpszAdrType, LPTSTR lpszAddress, ULONG ulFlags, ULONG FAR * lpcbEntryID,            \
     LPENTRYID FAR * lppEntryID) IPURE;                                                                                \
    MAPIMETHOD(NewEntry)                                                                                               \
    (THIS_ ULONG_PTR ulUIParam, ULONG ulFlags, ULONG cbEIDContainer, LPENTRYID lpEIDContainer, ULONG cbEIDNewEntryTpl, \
     LPENTRYID lpEIDNewEntryTpl, ULONG FAR * lpcbEIDNewEntry, LPENTRYID FAR * lppEIDNewEntry) IPURE;                   \
    MAPIMETHOD(ResolveName)                                                                                            \
    (THIS_ ULONG_PTR ulUIParam, ULONG ulFlags, LPTSTR lpszNewEntryTitle, LPADRLIST lpAdrList) IPURE;                   \
    MAPIMETHOD(Address)                                                                                                \
    (THIS_ ULONG_PTR FAR * lpulUIParam, LPADRPARM lpAdrParms, LPADRLIST FAR * lppAdrList) IPURE;                       \
    MAPIMETHOD(Details)                                                                                                \
    (THIS_ ULONG FAR * lpulUIParam, LPFNDISMISS lpfnDismiss, LPVOID lpvDismissContext, ULONG cbEntryID,                \
     LPENTRYID lpEntryID, LPFNBUTTON lpfButtonCallback, LPVOID lpvButtonContext, LPTSTR lpszButtonText, ULONG ulFlags) \
        IPURE;                                                                                                         \
    MAPIMETHOD(RecipOptions)                                                                                           \
    (THIS_ ULONG_PTR ulUIParam, ULONG ulFlags, LPADRENTRY lpRecip) IPURE;                                              \
    MAPIMETHOD(QueryDefaultRecipOpt)                                                                                   \
    (THIS_ LPTSTR lpszAdrType, ULONG ulFlags, ULONG FAR * lpcValues, LPSPropValue FAR * lppOptions) IPURE;             \
    MAPIMETHOD(GetPAB)                                                                                                 \
    (THIS_ ULONG FAR * lpcbEntryID, LPENTRYID FAR * lppEntryID) IPURE;                                                 \
    MAPIMETHOD(SetPAB)                                                                                                 \
    (THIS_ ULONG cbEntryID, LPENTRYID lpEntryID) IPURE;                                                                \
    MAPIMETHOD(GetDefaultDir)                                                                                          \
    (THIS_ ULONG FAR * lpcbEntryID, LPENTRYID FAR * lppEntryID) IPURE;                                                 \
    MAPIMETHOD(SetDefaultDir)                                                                                          \
    (THIS_ ULONG cbEntryID, LPENTRYID lpEntryID) IPURE;                                                                \
    MAPIMETHOD(GetSearchPath)                                                                                          \
    (THIS_ ULONG ulFlags, LPSRowSet FAR * lppSearchPath) IPURE;                                                        \
    MAPIMETHOD(SetSearchPath)                                                                                          \
    (THIS_ ULONG ulFlags, LPSRowSet lpSearchPath) IPURE;                                                               \
...
#define INTERFACE IAddrBook
    DECLARE_MAPI_INTERFACE_(IAddrBook, IMAPIProp){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE)
                                                       MAPI_IMAPIPROP_METHODS(PURE) MAPI_IADDRBOOK_METHODS(PURE) };
...
#define MAPI_IPROFADMIN_METHODS(IPURE)                                                                        \
    ...
    (THIS_ LPTSTR lpszProfileName, LPTSTR lpszPassword, ULONG_PTR ulUIParam, ULONG ulFlags) IPURE;            \
    MAPIMETHOD(DeleteProfile)                                                                                 \
    (THIS_ LPTSTR lpszProfileName, ULONG ulFlags) IPURE;                                                      \
    MAPIMETHOD(ChangeProfilePassword)                                                                         \
    (THIS_ LPTSTR lpszProfileName, LPTSTR lpszOldPassword, LPTSTR lpszNewPassword, ULONG ulFlags) IPURE;      \
    MAPIMETHOD(CopyProfile)                                                                                   \
    (THIS_ LPTSTR lpszOldProfileName, LPTSTR lpszOldPassword, LPTSTR lpszNewProfileName, ULONG_PTR ulUIParam, \
     ULONG ulFlags) IPURE;                                                                                    \
    ...
    (THIS_ LPTSTR lpszProfileName, ULONG ulFlags) IPURE;                                                      \
    MAPIMETHOD(AdminServices)                                                                                 \
    (THIS_ LPTSTR lpszProfileName, LPTSTR lpszPassword, ULONG_PTR ulUIParam, ULONG ulFlags,                   \
     LPSERVICEADMIN FAR * lppServiceAdmin) IPURE;


#undef INTERFACE
#define INTERFACE IProfAdmin
    DECLARE_MAPI_INTERFACE_(IProfAdmin,
                            IUnknown){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IPROFADMIN_METHODS(PURE) };
...
#define MAPI_IMSGSERVICEADMIN_METHODS(IPURE)                                                                \
    ...
    (THIS_ LPTSTR lpszService, LPTSTR lpszDisplayName, ULONG_PTR ulUIParam, ULONG ulFlags) IPURE;           \
    MAPIMETHOD(DeleteMsgService)                                                                            \
    (THIS_ LPMAPIUID lpUID) IPURE;                                                                          \
    MAPIMETHOD(CopyMsgService)                                                                              \
    (THIS_ LPMAPIUID lpUID, LPTSTR lpszDisplayName, LPCIID lpInterfaceToCopy, LPCIID lpInterfaceDst,        \
     LPVOID lpObjectDst, ULONG_PTR ulUIParam, ULONG ulFlags) IPURE;                                         \
    MAPIMETHOD(RenameMsgService)                                                                            \
    (THIS_ LPMAPIUID lpUID, ULONG ulFlags, LPTSTR lpszDisplayName) IPURE;                                   \
    MAPIMETHOD(ConfigureMsgService)                                                                         \
    (THIS_ LPMAPIUID lpUID, ULONG_PTR ulUIParam, ULONG ulFlags, ULONG cValues, LPSPropValue lpProps) IPURE; \
    MAPIMETHOD(OpenProfileSection)                                                                          \
    (THIS_ LPMAPIUID lpUID, LPCIID lpInterface, ULONG ulFlags, LPPROFSECT FAR * lppProfSect) IPURE;         \
    MAPIMETHOD(MsgServiceTransportOrder)                                                                    \
    (THIS_ ULONG cUID, LPMAPIUID lpUIDList, ULONG ulFlags) IPURE;                                           \
    MAPIMETHOD(AdminProviders)                                                                              \
    (THIS_ LPMAPIUID lpUID, ULONG ulFlags, LPPROVIDERADMIN FAR * lppProviderAdmin) IPURE;                   \
    MAPIMETHOD(SetPrimaryIdentity)                                                                          \
    (THIS_ LPMAPIUID lpUID, ULONG ulFlags) IPURE;                                                           \
...
#define INTERFACE IMsgServiceAdmin
    DECLARE_MAPI_INTERFACE_(IMsgServiceAdmin, IUnknown){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE)
