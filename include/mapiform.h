...
#define MAPI_GETLASTERROR_METHOD(IPURE)                                          \
    MAPIMETHOD(GetLastError)(THIS_ /*in*/ HRESULT hResult, /*in*/ ULONG ulFlags, \
...
#define MAPI_IPERSISTMESSAGE_METHODS(IPURE)                                                            \
    ...
    MAPIMETHOD(InitNew)(THIS_ /*in*/ LPMAPIMESSAGESITE pMessageSite, /*in*/ LPMESSAGE pMessage) IPURE; \
    MAPIMETHOD(Load)(THIS_ /*in*/ LPMAPIMESSAGESITE pMessageSite, /*in*/ LPMESSAGE pMessage,           \
                     /*in*/ ULONG ulMessageStatus, /*in*/ ULONG ulMessageFlags) IPURE;                 \
    MAPIMETHOD(Save)(THIS_ /*in*/ LPMESSAGE pMessage, /*in*/ ULONG fSameAsLoad) IPURE;                 \
    MAPIMETHOD(SaveCompleted)(THIS_ /*in*/ LPMESSAGE pMessage) IPURE;                                  \
    MAPIMETHOD(HandsOffMessage)(THIS) IPURE;

#undef INTERFACE
#define INTERFACE IPersistMessage
DECLARE_MAPI_INTERFACE_(IPersistMessage, IUnknown){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE)
...
#define MAPI_IMAPIMESSAGESITE_METHODS(IPURE)                                                                     \
    MAPIMETHOD(GetSession)(THIS_ /*out*/ LPMAPISESSION FAR * ppSession) IPURE;                                   \
    MAPIMETHOD(GetStore)(THIS_ /*out*/ LPMDB FAR * ppStore) IPURE;                                               \
    MAPIMETHOD(GetFolder)(THIS_ /*out*/ LPMAPIFOLDER FAR * ppFolder) IPURE;                                      \
    MAPIMETHOD(GetMessage)(THIS_ /*out*/ LPMESSAGE FAR * ppmsg) IPURE;                                           \
    MAPIMETHOD(GetFormManager)(THIS_ /*out*/ LPMAPIFORMMGR FAR * ppFormMgr) IPURE;                               \
    MAPIMETHOD(NewMessage)(THIS_ /*in*/ ULONG fComposeInFolder, /*in*/ LPMAPIFOLDER pFolderFocus,                \
                           /*in*/ LPPERSISTMESSAGE pPersistMessage, /*out*/ LPMESSAGE FAR * ppMessage,           \
                           /*out*/ LPMAPIMESSAGESITE FAR * ppMessageSite,                                        \
                           /*out*/ LPMAPIVIEWCONTEXT FAR * ppViewContext) IPURE;                                 \
    MAPIMETHOD(CopyMessage)(THIS_ /*in*/ LPMAPIFOLDER pFolderDestination) IPURE;                                 \
    MAPIMETHOD(MoveMessage)(THIS_ /*in*/ LPMAPIFOLDER pFolderDestination, /*in*/ LPMAPIVIEWCONTEXT pViewContext, \
                            /*in*/ LPCRECT prcPosRect) IPURE;                                                    \
    MAPIMETHOD(DeleteMessage)(THIS_ /*in*/ LPMAPIVIEWCONTEXT pViewContext, /*in*/ LPCRECT prcPosRect) IPURE;     \
    MAPIMETHOD(SaveMessage)(THIS) IPURE;                                                                         \
    MAPIMETHOD(SubmitMessage)(THIS_ /*in*/ ULONG ulFlags) IPURE;                                                 \
    MAPIMETHOD(GetSiteStatus)(THIS_ /*out*/ LPULONG lpulStatus) IPURE;

#undef INTERFACE
#define INTERFACE IMAPIMessageSite
DECLARE_MAPI_INTERFACE_(IMAPIMessageSite, IUnknown){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE)
                                                         MAPI_GETLASTERROR_METHOD(PURE)
...
#define MAPI_IMAPIFORM_METHODS(IPURE)                                                                     \
    MAPIMETHOD(SetViewContext)(THIS_ /*in*/ LPMAPIVIEWCONTEXT pViewContext) IPURE;                        \
    MAPIMETHOD(GetViewContext)(THIS_ /*out*/ LPMAPIVIEWCONTEXT FAR * ppViewContext) IPURE;                \
    MAPIMETHOD(ShutdownForm)(THIS_ /*in*/ ULONG ulSaveOptions) IPURE;                                     \
    MAPIMETHOD(DoVerb)(THIS_ /*in*/ LONG iVerb,                                                           \
                       /*in*/ LPMAPIVIEWCONTEXT lpViewContext, /* can be null */ /*in*/ ULONG hwndParent, \
                       /*in*/ LPCRECT lprcPosRect) IPURE;                                                 \
    MAPIMETHOD(Advise)(THIS_ /*in*/ LPMAPIVIEWADVISESINK pAdvise, /*out*/ ULONG FAR * pdwStatus) IPURE;   \
    MAPIMETHOD(Unadvise)(THIS_ /*in*/ ULONG ulConnection) IPURE;

#undef INTERFACE
#define INTERFACE IMAPIForm
DECLARE_MAPI_INTERFACE_(IMAPIForm, IUnknown){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_GETLASTERROR_METHOD(PURE)
...
#define MAPI_IMAPIVIEWCONTEXT_METHODS(IPURE)                                                                       \
    MAPIMETHOD(SetAdviseSink)(THIS_ /*in*/ LPMAPIFORMADVISESINK pmvns) IPURE;                                      \
    MAPIMETHOD(ActivateNext)(THIS_ /*in*/ ULONG ulDir, /*in*/ LPCRECT prcPosRect) IPURE;                           \
    MAPIMETHOD(GetPrintSetup)(THIS_ /*in*/ ULONG ulFlags, /*out*/ LPFORMPRINTSETUP FAR * lppFormPrintSetup) IPURE; \
    MAPIMETHOD(GetSaveStream)(THIS_ /*out*/ ULONG FAR * pulFlags, /*out*/ ULONG FAR * pulFormat,                   \
                              /*out*/ LPSTREAM FAR * ppstm) IPURE;                                                 \
    MAPIMETHOD(GetViewStatus)(THIS_ /*out*/ LPULONG lpulStatus) IPURE;

#undef INTERFACE
#define INTERFACE IMAPIViewContext
DECLARE_MAPI_INTERFACE_(IMAPIViewContext, IUnknown){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE)
                                                         MAPI_GETLASTERROR_METHOD(PURE)
...
#define MAPI_IMAPIFORMADVISESINK_METHODS(IPURE)                                                   \
    ...
    STDMETHOD(OnActivateNext)(THIS_ /*in*/ LPCSTR lpszMessageClass, /*in*/ ULONG ulMessageStatus, \
                              /*in*/ ULONG ulMessageFlags, /*out*/ LPPERSISTMESSAGE FAR * ppPersistMessage) IPURE;

#undef INTERFACE
#define INTERFACE IMAPIFormAdviseSink
DECLARE_MAPI_INTERFACE_(IMAPIFormAdviseSink,
                        IUnknown){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IMAPIFORMADVISESINK_METHODS(PURE) };
...
#define MAPI_IMAPIVIEWADVISESINK_METHODS(IPURE)                                          \
    ...
    MAPIMETHOD(OnPrint)(THIS_ /*in*/ ULONG dwPageNumber, /*in*/ HRESULT hrStatus) IPURE; \
    MAPIMETHOD(OnSubmitted)(THIS) IPURE;                                                 \
    MAPIMETHOD(OnSaved)(THIS) IPURE;

#undef INTERFACE
#define INTERFACE IMAPIViewAdviseSink
DECLARE_MAPI_INTERFACE_(IMAPIViewAdviseSink,
                        IUnknown){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IMAPIVIEWADVISESINK_METHODS(PURE) };
...
#define MAPI_IMAPIFORMINFO_METHODS(IPURE)                                                                             \
    MAPIMETHOD(CalcFormPropSet)(THIS_ /*in*/ ULONG ulFlags, /*out*/ LPMAPIFORMPROPARRAY FAR * ppFormPropArray) IPURE; \
    MAPIMETHOD(CalcVerbSet)(THIS_ /*in*/ ULONG ulFlags, /*out*/ LPMAPIVERBARRAY FAR * ppMAPIVerbArray) IPURE;         \
    MAPIMETHOD(MakeIconFromBinary)(THIS_ /*in*/ ULONG nPropID, /*out*/ HICON FAR * phicon) IPURE;                     \
    MAPIMETHOD(SaveForm)(THIS_ /*in*/ LPCTSTR szFileName) IPURE;                                                      \
    MAPIMETHOD(OpenFormContainer)(THIS_ /*out*/ LPMAPIFORMCONTAINER FAR * ppformcontainer) IPURE;

#undef INTERFACE
#define INTERFACE IMAPIFormInfo
DECLARE_MAPI_INTERFACE_(IMAPIFormInfo, IMAPIProp){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE)
...
#define MAPI_IMAPIFORMMGR_METHODS(IPURE)                                                                               \
    MAPIMETHOD(LoadForm)(THIS_ /*in*/ ULONG ulUIParam, /*in*/ ULONG ulFlags, /*in*/ LPCSTR lpszMessageClass,           \
                         /*in*/ ULONG ulMessageStatus, /*in*/ ULONG ulMessageFlags, /*in*/ LPMAPIFOLDER pFolderFocus,  \
                         /*in*/ LPMAPIMESSAGESITE pMessageSite, /*in*/ LPMESSAGE pmsg,                                 \
                         /*in*/ LPMAPIVIEWCONTEXT pViewContext, /*in*/ REFIID riid, /*out*/ LPVOID FAR * ppvObj)       \
        IPURE;                                                                                                         \
    MAPIMETHOD(ResolveMessageClass)(THIS_ /*in*/ LPCSTR szMsgClass, /*in*/ ULONG ulFlags,                              \
                                    /*in*/ LPMAPIFOLDER pFolderFocus, /* can be null */ /*out*/ LPMAPIFORMINFO FAR *   \
                                                                                            ppResult) IPURE;           \
    MAPIMETHOD(ResolveMultipleMessageClasses)(                                                                         \
        THIS_ /*in*/ LPSMESSAGECLASSARRAY pMsgClasses, /*in*/ ULONG ulFlags,                                           \
        /*in*/ LPMAPIFOLDER pFolderFocus, /* can be null */ /*out*/ LPSMAPIFORMINFOARRAY FAR * pfrminfoarray) IPURE;   \
    MAPIMETHOD(CalcFormPropSet)(THIS_ /*in*/ LPSMAPIFORMINFOARRAY pfrminfoarray, /*in*/ ULONG ulFlags,                 \
                                /*out*/ LPMAPIFORMPROPARRAY FAR * ppResults) IPURE;                                    \
    MAPIMETHOD(CreateForm)(THIS_ /*in*/ ULONG ulUIParam, /*in*/ ULONG ulFlags,                                         \
                           /*in*/ LPMAPIFORMINFO pfrminfoToActivate, /*in*/ REFIID refiidToAsk,                        \
                           /*out*/ LPVOID FAR * ppvObj) IPURE;                                                         \
    MAPIMETHOD(SelectForm)(THIS_ /*in*/ ULONG ulUIParam, /*in*/ ULONG ulFlags, /*in*/ LPCTSTR pszTitle,                \
                           /*in*/ LPMAPIFOLDER pfld, /*out*/ LPMAPIFORMINFO FAR * ppfrminfoReturned) IPURE;            \
    MAPIMETHOD(SelectMultipleForms)(THIS_ /*in*/ ULONG ulUIParam, /*in*/ ULONG ulFlags, /*in*/ LPCTSTR pszTitle,       \
                                    /*in*/ LPMAPIFOLDER pfld, /*in*/ LPSMAPIFORMINFOARRAY pfrminfoarray,               \
                                    /*out*/ LPSMAPIFORMINFOARRAY FAR * ppfrminfoarray) IPURE;                          \
    MAPIMETHOD(SelectFormContainer)(THIS_ /*in*/ ULONG ulUIParam, /*in*/ ULONG ulFlags,                                \
                                    /*out*/ LPMAPIFORMCONTAINER FAR * lppfcnt) IPURE;                                  \
    MAPIMETHOD(OpenFormContainer)(THIS_ /*in*/ HFRMREG hfrmreg, /*in*/ LPUNKNOWN lpunk,                                \
                                  /*out*/ LPMAPIFORMCONTAINER FAR * lppfcnt) IPURE;                                    \
    MAPIMETHOD(PrepareForm)(THIS_ /*in*/ ULONG ulUIParam, /*in*/ ULONG ulFlags, /*in*/ LPMAPIFORMINFO pfrminfo) IPURE; \
    MAPIMETHOD(IsInConflict)(THIS_ /*in*/ ULONG ulMessageFlags, /*in*/ ULONG ulMessageStatus,                          \
                             /*in*/ LPCSTR szMessageClass, /*in*/ LPMAPIFOLDER pFolderFocus) IPURE;

#undef INTERFACE
#define INTERFACE IMAPIFormMgr
DECLARE_MAPI_INTERFACE_(IMAPIFormMgr, IUnknown){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE)
                                                     MAPI_GETLASTERROR_METHOD(PURE) MAPI_IMAPIFORMMGR_METHODS(PURE) };
...
#define MAPI_IMAPIFORMCONTAINER_METHODS(IPURE)                                                                        \
    MAPIMETHOD(InstallForm)(THIS_ /*in*/ ULONG ulUIParam, /*in*/ ULONG ulFlags, /*in*/ LPCTSTR szCfgPathName) IPURE;  \
    MAPIMETHOD(RemoveForm)(THIS_ /*in*/ LPCSTR szMessageClass) IPURE;                                                 \
    MAPIMETHOD(ResolveMessageClass)(THIS_ /*in*/ LPCSTR szMessageClass, /*in*/ ULONG ulFlags,                         \
                                    /*out*/ LPMAPIFORMINFO FAR * pforminfo) IPURE;                                    \
    MAPIMETHOD(ResolveMultipleMessageClasses)(THIS_ /*in*/ LPSMESSAGECLASSARRAY pMsgClassArray, /*in*/ ULONG ulFlags, \
                                              /*out*/ LPSMAPIFORMINFOARRAY FAR * ppfrminfoarray) IPURE;               \
    MAPIMETHOD(CalcFormPropSet)(THIS_ /*in*/ ULONG ulFlags, /*out*/ LPMAPIFORMPROPARRAY FAR * ppResults) IPURE;       \
    MAPIMETHOD(GetDisplay)(THIS_ /*in*/ ULONG ulFlags, /*out*/ LPTSTR FAR * pszDisplayName) IPURE;

#undef INTERFACE
#define INTERFACE IMAPIFormContainer
DECLARE_MAPI_INTERFACE_(IMAPIFormContainer, IUnknown){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE)
                                                           MAPI_GETLASTERROR_METHOD(PURE)
...
#define MAPI_IMAPIFORMFACTORY_METHODS(IPURE)                                              \
    MAPIMETHOD(CreateClassFactory)(THIS_ /*in*/ REFCLSID clsidForm, /*in*/ ULONG ulFlags, \
                                   /*out*/ LPCLASSFACTORY FAR * lppClassFactory) IPURE;   \
    MAPIMETHOD(LockServer)(THIS_ /*in*/ ULONG ulFlags, /*in*/ ULONG fLockServer) IPURE;

#undef INTERFACE
#define INTERFACE IMAPIFormFactory
DECLARE_MAPI_INTERFACE_(IMAPIFormFactory, IUnknown){ BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE)
                                                         MAPI_GETLASTERROR_METHOD(PURE)
