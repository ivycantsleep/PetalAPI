...
#define DS_GENERIC_ALL                                                                                         \
    ((STANDARD_RIGHTS_REQUIRED) | (ACTRL_DS_CREATE_CHILD) | (ACTRL_DS_DELETE_CHILD) | (ACTRL_DS_DELETE_TREE) | \
     (ACTRL_DS_READ_PROP) | (ACTRL_DS_WRITE_PROP) | (ACTRL_DS_LIST) | (ACTRL_DS_LIST_OBJECT) |                 \
     (ACTRL_DS_CONTROL_ACCESS) | (ACTRL_DS_SELF))
#endif
...
#define FRSCONN_GET_PRIORITY(_options_)                                                                   \
    (((((_options_) & FRSCONN_PRIORITY_MASK) >> 28) != 0) ? (((_options_) & FRSCONN_PRIORITY_MASK) >> 28) \
...
#define GUID_FOREIGNSECURITYPRINCIPALS_CONTAINER_BYTE "\x22\xb7\x0c\x67\xd5\x6e\x4e\xfb\x91\xe9\x30\x0f\xca\x3d\xc1\xaa"
    ...
    DWORD
    WINAPI
    DsBindW(LPCWSTR DomainControllerName, // in, optional
    ...
    DWORD
    WINAPI
    DsBindA(LPCSTR DomainControllerName, // in, optional
...
#define DsBind DsBindA
    ...
    DWORD
    WINAPI
    DsBindWithCredW(LPCWSTR DomainControllerName,          // in, optional
                    LPCWSTR DnsDomainName,                 // in, optional
    ...
    DWORD
    WINAPI
    DsBindWithCredA(LPCSTR DomainControllerName,           // in, optional
                    LPCSTR DnsDomainName,                  // in, optional
                    RPC_AUTH_IDENTITY_HANDLE AuthIdentity, // in, optional
                    HANDLE *phDS);
...
#define DsBindWithCred DsBindWithCredA
    ...
    DWORD
    WINAPI
    DsBindWithSpnW(LPCWSTR DomainControllerName,          // in, optional
                   LPCWSTR DnsDomainName,                 // in, optional
                   RPC_AUTH_IDENTITY_HANDLE AuthIdentity, // in, optional
    ...
    DWORD
    WINAPI
    DsBindWithSpnA(LPCSTR DomainControllerName,           // in, optional
                   LPCSTR DnsDomainName,                  // in, optional
                   RPC_AUTH_IDENTITY_HANDLE AuthIdentity, // in, optional
...
#define DsBindWithSpn DsBindWithSpnA
    ...
    DWORD
    WINAPI
    DsUnBindW(HANDLE *phDS); // in

    NTDSAPI
    DWORD
    WINAPI
    DsUnBindA(HANDLE *phDS); // in
...
#define DsUnBind DsUnBindA
    ...
    DWORD
    WINAPI
    DsMakePasswordCredentialsW(LPCWSTR User, LPCWSTR Domain, LPCWSTR Password, RPC_AUTH_IDENTITY_HANDLE *pAuthIdentity);

    NTDSAPI
    DWORD
    WINAPI
    DsMakePasswordCredentialsA(LPCSTR User, LPCSTR Domain, LPCSTR Password, RPC_AUTH_IDENTITY_HANDLE *pAuthIdentity);
...
#define DsMakePasswordCredentials DsMakePasswordCredentialsA
    ...
    NTDSAPI
    VOID WINAPI DsFreePasswordCredentials(RPC_AUTH_IDENTITY_HANDLE AuthIdentity);
...
#define DsCrackNames DsCrackNamesA
    ...
    NTDSAPI
    void WINAPI DsFreeNameResultW(DS_NAME_RESULTW *pResult); // in

    NTDSAPI
    void WINAPI DsFreeNameResultA(DS_NAME_RESULTA *pResult); // in
...
#define DsFreeNameResult DsFreeNameResultA
    ...
    DWORD
    WINAPI
    DsMakeSpnW(IN LPCWSTR ServiceClass, IN LPCWSTR ServiceName, IN LPCWSTR InstanceName, IN USHORT InstancePort,
               IN LPCWSTR Referrer, IN OUT DWORD *pcSpnLength, OUT LPWSTR pszSpn);

    NTDSAPI
    DWORD
    WINAPI
    DsMakeSpnA(IN LPCSTR ServiceClass, IN LPCSTR ServiceName, IN LPCSTR InstanceName, IN USHORT InstancePort,
               IN LPCSTR Referrer, IN OUT DWORD *pcSpnLength, OUT LPSTR pszSpn);
...
#define DsMakeSpn DsMakeSpnA
    ...
    DWORD
    WINAPI
    DsGetSpnA(IN DS_SPN_NAME_TYPE ServiceType, IN LPCSTR ServiceClass, IN LPCSTR ServiceName, IN USHORT InstancePort,
              IN USHORT cInstanceNames, IN LPCSTR *pInstanceNames, IN const USHORT *pInstancePorts, OUT DWORD *pcSpn,
              OUT LPSTR **prpszSpn);

    NTDSAPI
    DWORD
    WINAPI
    DsGetSpnW(IN DS_SPN_NAME_TYPE ServiceType, IN LPCWSTR ServiceClass, IN LPCWSTR ServiceName, IN USHORT InstancePort,
              IN USHORT cInstanceNames, IN LPCWSTR *pInstanceNames, IN const USHORT *pInstancePorts, OUT DWORD *pcSpn,
              OUT LPWSTR **prpszSpn);
...
#define DsGetSpn DsGetSpnA
    ...
    NTDSAPI
    void WINAPI DsFreeSpnArrayA(IN DWORD cSpn, IN OUT LPSTR *rpszSpn);

    NTDSAPI
    void WINAPI DsFreeSpnArrayW(IN DWORD cSpn, IN OUT LPWSTR *rpszSpn);
...
#define DsFreeSpnArray DsFreeSpnArrayA
    ...
    DWORD
    WINAPI
    DsCrackSpnA(IN LPCSTR pszSpn, IN OUT LPDWORD pcServiceClass, OUT LPSTR ServiceClass, IN OUT LPDWORD pcServiceName,
                OUT LPSTR ServiceName, IN OUT LPDWORD pcInstanceName, OUT LPSTR InstanceName,
                OUT USHORT *pInstancePort);

    NTDSAPI
    DWORD
    WINAPI
    DsCrackSpnW(IN LPCWSTR pszSpn, IN OUT DWORD *pcServiceClass, OUT LPWSTR ServiceClass, IN OUT DWORD *pcServiceName,
                OUT LPWSTR ServiceName, IN OUT DWORD *pcInstanceName, OUT LPWSTR InstanceName,
                OUT USHORT *pInstancePort);
...
#define DsCrackSpn DsCrackSpnA
    ...
    DWORD
    WINAPI
    DsWriteAccountSpnA(IN HANDLE hDS, IN DS_SPN_WRITE_OP Operation, IN LPCSTR pszAccount, IN DWORD cSpn,
                       IN LPCSTR *rpszSpn);

    NTDSAPI
    DWORD
    WINAPI
    DsWriteAccountSpnW(IN HANDLE hDS, IN DS_SPN_WRITE_OP Operation, IN LPCWSTR pszAccount, IN DWORD cSpn,
                       IN LPCWSTR *rpszSpn);
...
--*/
    ...
    DWORD
    WINAPI
    DsClientMakeSpnForTargetServerW(IN LPCWSTR ServiceClass, IN LPCWSTR ServiceName, IN OUT DWORD *pcSpnLength,
                                    OUT LPWSTR pszSpn);

    NTDSAPI
    DWORD
    WINAPI
    DsClientMakeSpnForTargetServerA(IN LPCSTR ServiceClass, IN LPCSTR ServiceName, IN OUT DWORD *pcSpnLength,
                                    OUT LPSTR pszSpn);
...
--*/
    ...
    DWORD
    WINAPI
    DsServerRegisterSpnA(IN DS_SPN_WRITE_OP Operation, IN LPCSTR ServiceClass, IN LPCSTR UserObjectDN);

    NTDSAPI
    DWORD
    WINAPI
    DsServerRegisterSpnW(IN DS_SPN_WRITE_OP Operation, IN LPCWSTR ServiceClass, IN LPCWSTR UserObjectDN);
...
#define DsServerRegisterSpn DsServerRegisterSpnA
    ...
    DWORD
    WINAPI
    DsReplicaSyncA(IN HANDLE hDS, IN LPCSTR NameContext, IN const UUID *pUuidDsaSrc, IN ULONG Options);

    NTDSAPI
    DWORD
    WINAPI
    DsReplicaSyncW(IN HANDLE hDS, IN LPCWSTR NameContext, IN const UUID *pUuidDsaSrc, IN ULONG Options);
...
*/
    ...
    DWORD
    WINAPI
    DsReplicaAddA(IN HANDLE hDS, IN LPCSTR NameContext, IN LPCSTR SourceDsaDn, IN LPCSTR TransportDn,
                  IN LPCSTR SourceDsaAddress, IN const PSCHEDULE pSchedule, IN DWORD Options);

    NTDSAPI
    DWORD
    WINAPI
    DsReplicaAddW(IN HANDLE hDS, IN LPCWSTR NameContext, IN LPCWSTR SourceDsaDn, IN LPCWSTR TransportDn,
                  IN LPCWSTR SourceDsaAddress, IN const PSCHEDULE pSchedule, IN DWORD Options);
...
#define DsReplicaAdd DsReplicaAddA
    ...
    DWORD
    WINAPI
    DsReplicaDelA(IN HANDLE hDS, IN LPCSTR NameContext, IN LPCSTR DsaSrc, IN ULONG Options);

    NTDSAPI
    DWORD
    WINAPI
    DsReplicaDelW(IN HANDLE hDS, IN LPCWSTR NameContext, IN LPCWSTR DsaSrc, IN ULONG Options);
...
#define DsReplicaDel DsReplicaDelA
    ...
    DWORD
    WINAPI
    DsReplicaModifyA(IN HANDLE hDS, IN LPCSTR NameContext, IN const UUID *pUuidSourceDsa, IN LPCSTR TransportDn,
                     IN LPCSTR SourceDsaAddress, IN const PSCHEDULE pSchedule, IN DWORD ReplicaFlags,
                     IN DWORD ModifyFields, IN DWORD Options);

    NTDSAPI
    DWORD
    WINAPI
    DsReplicaModifyW(IN HANDLE hDS, IN LPCWSTR NameContext, IN const UUID *pUuidSourceDsa, IN LPCWSTR TransportDn,
                     IN LPCWSTR SourceDsaAddress, IN const PSCHEDULE pSchedule, IN DWORD ReplicaFlags,
                     IN DWORD ModifyFields, IN DWORD Options);
...
#define DsReplicaModify DsReplicaModifyA
    ...
    DWORD
    WINAPI
    DsReplicaUpdateRefsA(IN HANDLE hDS, IN LPCSTR NameContext, IN LPCSTR DsaDest, IN const UUID *pUuidDsaDest,
                         IN ULONG Options);

    NTDSAPI
    DWORD
    WINAPI
    DsReplicaUpdateRefsW(IN HANDLE hDS, IN LPCWSTR NameContext, IN LPCWSTR DsaDest, IN const UUID *pUuidDsaDest,
                         IN ULONG Options);
...
#define DS_REPSYNCALL_CROSS_SITE_BOUNDARIES 0x00000040
    ...
    DWORD
    WINAPI
    DsReplicaSyncAllA(HANDLE hDS, LPCSTR pszNameContext, ULONG ulFlags,
                      BOOL(__stdcall *pFnCallBack)(LPVOID, PDS_REPSYNCALL_UPDATEA), LPVOID pCallbackData,
                      PDS_REPSYNCALL_ERRINFOA **pErrors);

    NTDSAPI
    DWORD
    WINAPI
    DsReplicaSyncAllW(HANDLE hDS, LPCWSTR pszNameContext, ULONG ulFlags,
                      BOOL(__stdcall *pFnCallBack)(LPVOID, PDS_REPSYNCALL_UPDATEW), LPVOID pCallbackData,
...
#define DsReplicaSyncAll DsReplicaSyncAllA
    ...
    DWORD
    WINAPI
    DsRemoveDsServerW(HANDLE hDs,            // in
                      LPWSTR ServerDN,       // in
    ...
    DWORD
    WINAPI
    DsRemoveDsServerA(HANDLE hDs,            // in
                      LPSTR ServerDN,        // in
...
#define DsRemoveDsServer DsRemoveDsServerA
    ...
    DWORD
    WINAPI
    DsRemoveDsDomainW(HANDLE hDs,     // in
                      LPWSTR DomainDN // in
    );
    ...
    DWORD
    WINAPI
    DsRemoveDsDomainA(HANDLE hDs,    // in
                      LPSTR DomainDN // in
    );
...
#define DsRemoveDsDomain DsRemoveDsDomainA
    ...
    DWORD
    WINAPI
    DsListSitesA(HANDLE hDs,                 // in
                 PDS_NAME_RESULTA *ppSites); // out

    NTDSAPI
    DWORD
    WINAPI
    DsListSitesW(HANDLE hDs,                 // in
...
#define DsListSites DsListSitesA
    ...
    DWORD
    WINAPI
    DsListServersInSiteA(HANDLE hDs,                   // in
                         LPCSTR site,                  // in
    ...
    DWORD
    WINAPI
    DsListServersInSiteW(HANDLE hDs,                   // in
                         LPCWSTR site,                 // in
...
#define DsListServersInSite DsListServersInSiteA
    ...
    DWORD
    WINAPI
    DsListDomainsInSiteA(HANDLE hDs,                   // in
                         LPCSTR site,                  // in
    ...
    DWORD
    WINAPI
    DsListDomainsInSiteW(HANDLE hDs,                   // in
                         LPCWSTR site,                 // in
...
#define DsListDomainsInSite DsListDomainsInSiteA
    ...
    DWORD
    WINAPI
    DsListServersForDomainInSiteA(HANDLE hDs,                   // in
                                  LPCSTR domain,                // in
                                  LPCSTR site,                  // in
                                  PDS_NAME_RESULTA *ppServers); // out
    ...
    DWORD
    WINAPI
    DsListServersForDomainInSiteW(HANDLE hDs,                   // in
                                  LPCWSTR domain,               // in
                                  LPCWSTR site,                 // in
                                  PDS_NAME_RESULTW *ppServers); // out
...
#define DS_LIST_ACCOUNT_OBJECT_FOR_SERVER 2
    ...
    DWORD
    WINAPI
    DsListInfoForServerA(HANDLE hDs,                // in
                         LPCSTR server,             // in
    ...
    DWORD
    WINAPI
    DsListInfoForServerW(HANDLE hDs,                // in
                         LPCWSTR server,            // in
...
#define DS_ROLE_INFRASTRUCTURE_OWNER 4
    ...
    DWORD
    WINAPI
    DsListRolesA(HANDLE hDs,                 // in
                 PDS_NAME_RESULTA *ppRoles); // out

    NTDSAPI
    DWORD
    WINAPI
    DsListRolesW(HANDLE hDs,                 // in
...
#define DS_SCHEMA_GUID_CONTROL_RIGHT 4
    ...
    DWORD
    WINAPI
    DsMapSchemaGuidsA(HANDLE hDs,                       // in
                      DWORD cGuids,                     // in
                      GUID *rGuids,                     // in
                      DS_SCHEMA_GUID_MAPA **ppGuidMap); // out

    NTDSAPI
    VOID WINAPI DsFreeSchemaGuidMapA(PDS_SCHEMA_GUID_MAPA pGuidMap); // in

    NTDSAPI
    DWORD
    WINAPI
    DsMapSchemaGuidsW(HANDLE hDs,                       // in
                      DWORD cGuids,                     // in
                      GUID *rGuids,                     // in
                      DS_SCHEMA_GUID_MAPW **ppGuidMap); // out

    NTDSAPI
    VOID WINAPI DsFreeSchemaGuidMapW(PDS_SCHEMA_GUID_MAPW pGuidMap); // in
...
#define DsFreeSchemaGuidMap DsFreeSchemaGuidMapA
    ...
    DWORD
    WINAPI
    DsGetDomainControllerInfoA(HANDLE hDs,        // in
    ...
    DWORD
    WINAPI
    DsGetDomainControllerInfoW(HANDLE hDs,         // in
    ...
    NTDSAPI
    VOID WINAPI DsFreeDomainControllerInfoA(DWORD InfoLevel, // in
                                            DWORD cInfo,     // in
                                            VOID *pInfo);    // in

    NTDSAPI
    VOID WINAPI DsFreeDomainControllerInfoW(DWORD InfoLevel, // in
                                            DWORD cInfo,     // in
                                            VOID *pInfo);    // in
...
#define DS_KCC_FLAG_ASYNC_OP (1)
    ...
    DWORD
    WINAPI
    DsReplicaConsistencyCheck(HANDLE hDS,           // in
    ...
    DWORD
    WINAPI
    DsReplicaVerifyObjectsW(HANDLE hDS,              // in
    ...
    DWORD
    WINAPI
    DsReplicaVerifyObjectsA(HANDLE hDS,              // in
...
#define DS_REPL_NBR_MODIFIABLE_MASK                                                                                \
    (DS_REPL_NBR_SYNC_ON_STARTUP | DS_REPL_NBR_DO_SCHEDULED_SYNCS | DS_REPL_NBR_TWO_WAY_SYNC |                     \
     DS_REPL_NBR_IGNORE_CHANGE_NOTIFICATIONS | DS_REPL_NBR_DISABLE_SCHEDULED_SYNC | DS_REPL_NBR_COMPRESS_CHANGES | \
    ...
    DWORD
    WINAPI
    DsReplicaGetInfoW(HANDLE hDS,                     // in
    ...
    DWORD
    WINAPI
    DsReplicaGetInfo2W(HANDLE hDS,                     // in
                       DS_REPL_INFO_TYPE InfoType,     // in
                       LPCWSTR pszObject,              // in
                       UUID *puuidForSourceDsaObjGuid, // in
    ...
    NTDSAPI
    void WINAPI DsReplicaFreeInfo(DS_REPL_INFO_TYPE InfoType, // in
                                  VOID *pInfo);               // in
...
// No ANSI equivalents currently supported.
    ...
    DWORD
    WINAPI
    DsAddSidHistoryW(HANDLE hDS,                              // in
    ...
    DWORD
    WINAPI
    DsAddSidHistoryA(HANDLE hDS,                              // in
                     DWORD Flags,                             // in - sbz for now
...
#define DsAddSidHistory DsAddSidHistoryA
    ...
    DWORD
    WINAPI
    DsInheritSecurityIdentityW(HANDLE hDS,            // in
                               DWORD Flags,           // in - sbz for now
    ...
    DWORD
    WINAPI
    DsInheritSecurityIdentityA(HANDLE hDS,           // in
                               DWORD Flags,          // in - sbz for now
...
--*/
    ...
    DWORD
    WINAPI
    DsQuoteRdnValueW(IN DWORD cUnquotedRdnValueLength, IN LPCWCH psUnquotedRdnValue,
                     IN OUT DWORD *pcQuotedRdnValueLength, OUT LPWCH psQuotedRdnValue);

    NTDSAPI
    DWORD
    WINAPI
    DsQuoteRdnValueA(IN DWORD cUnquotedRdnValueLength, IN LPCCH psUnquotedRdnValue,
                     IN OUT DWORD *pcQuotedRdnValueLength, OUT LPCH psQuotedRdnValue);
...
--*/
    ...
    DWORD
    WINAPI
    DsUnquoteRdnValueW(IN DWORD cQuotedRdnValueLength, IN LPCWCH psQuotedRdnValue,
                       IN OUT DWORD *pcUnquotedRdnValueLength, OUT LPWCH psUnquotedRdnValue);

    NTDSAPI
    DWORD
    WINAPI
    DsUnquoteRdnValueA(IN DWORD cQuotedRdnValueLength, IN LPCCH psQuotedRdnValue,
                       IN OUT DWORD *pcUnquotedRdnValueLength, OUT LPCH psUnquotedRdnValue);
...
--*/
    ...
    DWORD
    WINAPI
    DsGetRdnW(IN OUT LPCWCH *ppDN, IN OUT DWORD *pcDN, OUT LPCWCH *ppKey, OUT DWORD *pcKey, OUT LPCWCH *ppVal,
              OUT DWORD *pcVal);
...
--*/
    ...
    NTDSAPI
    BOOL WINAPI DsCrackUnquotedMangledRdnW(IN LPCWSTR pszRDN, IN DWORD cchRDN, OUT OPTIONAL GUID *pGuid,
                                           OUT OPTIONAL DS_MANGLE_FOR *peDsMangleFor);

    NTDSAPI
    BOOL WINAPI DsCrackUnquotedMangledRdnA(IN LPCSTR pszRDN, IN DWORD cchRDN, OUT OPTIONAL GUID *pGuid,
                                           OUT OPTIONAL DS_MANGLE_FOR *peDsMangleFor);
...
--*/
    ...
    NTDSAPI
    BOOL WINAPI DsIsMangledRdnValueW(LPCWSTR pszRdn, DWORD cRdn, DS_MANGLE_FOR eDsMangleForDesired);

    NTDSAPI
    BOOL WINAPI DsIsMangledRdnValueA(LPCSTR pszRdn, DWORD cRdn, DS_MANGLE_FOR eDsMangleForDesired);
...
--*/
    ...
    NTDSAPI
    BOOL WINAPI DsIsMangledDnA(LPCSTR pszDn, DS_MANGLE_FOR eDsMangleFor);

    NTDSAPI
    BOOL WINAPI DsIsMangledDnW(LPCWSTR pszDn, DS_MANGLE_FOR eDsMangleFor);
