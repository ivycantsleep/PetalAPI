...
#define GetMappedFileName GetMappedFileNameA
    ...
    DWORD
    WINAPI
    GetDeviceDriverBaseNameA(LPVOID ImageBase, LPSTR lpBaseName, DWORD nSize);
...
#define GetDeviceDriverFileName GetDeviceDriverFileNameA
    ...
    typedef BOOL (*PENUM_PAGE_FILE_CALLBACKW)(LPVOID pContext, PENUM_PAGE_FILE_INFORMATION pPageFileInfo,
                                              LPCWSTR lpFilename);

    typedef BOOL (*PENUM_PAGE_FILE_CALLBACKA)(LPVOID pContext, PENUM_PAGE_FILE_INFORMATION pPageFileInfo,
                                              LPCSTR lpFilename);
