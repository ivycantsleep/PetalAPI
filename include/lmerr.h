...
#define NERR_PasswordTooShort \
    (NERR_BASE +              \
     145) /* The password does not meet the password policy requirements. Check the minimum password length, password complexity and password history requirements. */
...
#define NERR_AcctLimitExceeded \
    (NERR_BASE + 334) /* A user's session with this server has been deleted
 ...
 *
 */
#define NERR_BrowserConfiguredToNotRun \
...
#define NERR_RplAdapterNameUnavailable \
...
#define NERR_RplBootNameUnavailable \
...
#define NERR_DfsVolumeHasMultipleServers \
...
#define NERR_DfsCantRemoveLastServerShare \
...
#define NERR_NameUsesIncompatibleCodePage \
    (NERR_BASE +                          \
     596) /*The specified computer name is incompatible with the default language used on the domain controller.*/
