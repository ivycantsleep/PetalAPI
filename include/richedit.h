...
#define EMO_EXPAND                              \
    3   // HIWORD(lparam) = EMO_EXPANDSELECTION \
        ...
        //  indicated level
#define EMO_MOVESELECTION                                        \
    4                     // LOWORD(lparam) != 0 -> move current \
...
#define CFE_AUTOCOLOR                       \
    0x40000000 // NOTE: this corresponds to \
...
#define CFM_EFFECTS2                                                                                                 \
    (CFM_EFFECTS | CFM_DISABLED | CFM_SMALLCAPS | CFM_ALLCAPS | CFM_HIDDEN | CFM_OUTLINE | CFM_SHADOW | CFM_EMBOSS | \
     CFM_IMPRINT | CFM_DISABLED | CFM_REVISED | CFM_SUBSCRIPT | CFM_SUPERSCRIPT | CFM_BACKCOLOR)

#define CFM_ALL2                                                                                          \
    (CFM_ALL | CFM_EFFECTS2 | CFM_BACKCOLOR | CFM_LCID | CFM_UNDERLINETYPE | CFM_WEIGHT | CFM_REVAUTHOR | \
...
#define SCF_USEUIRULES                               \
    0x0008 // Modifier for SCF_SELECTION; says that  \
           //  format came from a toolbar, etc., and \
           //  hence UI formatting rules should be   \
           //  used instead of literal formatting
#define SCF_ASSOCIATEFONT                            \
    0x0010 // Associate fontname with bCharSet (one  \
           //  possible for each of Western, ME, FE, \
           //  Thai)
#define SCF_NOKBUPDATE                                                       \
    0x0020                        // Do not update KB layput for this change \
...
#define PFM_ALL                                                                                      \
    (PFM_STARTINDENT | PFM_RIGHTINDENT | PFM_OFFSET | PFM_ALIGNMENT | PFM_TABSTOPS | PFM_NUMBERING | \
...
#define PFM_EFFECTS                                                                                                    \
    (PFM_RTLPARA | PFM_KEEP | PFM_KEEPNEXT | PFM_TABLE | PFM_PAGEBREAKBEFORE | PFM_NOLINENUMBER | PFM_NOWIDOWCONTROL | \
     PFM_DONOTHYPHEN | PFM_SIDEBYSIDE | PFM_TABLE | PFM_TABLEROWDELIMITER)

#define PFM_ALL2                                                                                            \
    (PFM_ALL | PFM_EFFECTS | PFM_SPACEBEFORE | PFM_SPACEAFTER | PFM_LINESPACING | PFM_STYLE | PFM_SHADING | \
     PFM_BORDER | PFM_NUMBERINGTAB | PFM_NUMBERINGSTART | PFM_NUMBERINGSTYLE)
...
#define PFNS_NEWNUMBER                              \
    0x8000 // Start new number with wNumberingStart \
