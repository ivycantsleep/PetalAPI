...
#define IS_SHARED_WOW_BINARY(VdmBinaryType) (BINARY_TYPE_WIN16 & (VdmBinaryType))

#define IS_WOW_BINARY(VdmBinaryType) ((BINARY_TYPE_WIN16 | BINARY_TYPE_SEPWOW) & (VdmBinaryType))
