...
#define WINHTTP_AUTO_DETECT_TYPE_DNS_A 0x00000002
    ...
    BOOLAPI
    WinHttpTimeFromSystemTime(IN CONST SYSTEMTIME *pst, // input GMT time
...
#define WINHTTP_TIME_FORMAT_BUFSIZE 62
    ...
    BOOLAPI
    WinHttpTimeToSystemTime(IN LPCWSTR pwszTime, // NULL terminated string
...
#define ICU_ENCODE_PERCENT 0x00001000     // Encode any percent (ASCII25)
    ...
    BOOLAPI
    WinHttpCrackUrl(IN LPCWSTR pwszUrl, IN DWORD dwUrlLength, IN DWORD dwFlags,
                    IN OUT LPURL_COMPONENTS lpUrlComponents);

    BOOLAPI
    WinHttpCreateUrl(IN LPURL_COMPONENTS lpUrlComponents, IN DWORD dwFlags, OUT LPWSTR pwszUrl,
...
#define ICU_ESCAPE 0x80000000 // (un)escape URL characters
    ...
    HINTERNET
    WINAPI
    WinHttpOpen(IN LPCWSTR pwszUserAgent, IN DWORD dwAccessType, IN LPCWSTR pwszProxyName OPTIONAL,
                IN LPCWSTR pwszProxyBypass OPTIONAL, IN DWORD dwFlags);
...
#define WINHTTP_NO_PROXY_BYPASS NULL
    ...
    BOOLAPI
    WinHttpReadData(IN HINTERNET hRequest, IN LPVOID lpBuffer, IN DWORD dwNumberOfBytesToRead,
                    OUT LPDWORD lpdwNumberOfBytesRead);

    BOOLAPI
    WinHttpWriteData(IN HINTERNET hRequest, IN LPCVOID lpBuffer, IN DWORD dwNumberOfBytesToWrite,
                     OUT LPDWORD lpdwNumberOfBytesWritten);


    BOOLAPI
    WinHttpQueryDataAvailable(IN HINTERNET hRequest, OUT LPDWORD lpdwNumberOfBytesAvailable OPTIONAL);


    BOOLAPI
    WinHttpQueryOption(IN HINTERNET hInternet, IN DWORD dwOption, OUT LPVOID lpBuffer OPTIONAL,
                       IN OUT LPDWORD lpdwBufferLength);

    BOOLAPI
    WinHttpSetOption(IN HINTERNET hInternet, IN DWORD dwOption, IN LPVOID lpBuffer, IN DWORD dwBufferLength);

    BOOLAPI
    WinHttpSetTimeouts(IN HINTERNET hInternet, // Session/Request handle.
                       IN int nResolveTimeout, IN int nConnectTimeout, IN int nSendTimeout, IN int nReceiveTimeout);
...
#define WINHTTP_FLAG_SECURE_PROTOCOL_ALL \
    (WINHTTP_FLAG_SECURE_PROTOCOL_SSL2 | WINHTTP_FLAG_SECURE_PROTOCOL_SSL3 | WINHTTP_FLAG_SECURE_PROTOCOL_TLS1)
    ...
    typedef VOID(CALLBACK *WINHTTP_STATUS_CALLBACK)(IN HINTERNET hInternet, IN DWORD_PTR dwContext,
    ...
    WINAPI
    WinHttpSetStatusCallback(IN HINTERNET hInternet, IN WINHTTP_STATUS_CALLBACK lpfnInternetCallback,
                             IN DWORD dwNotificationFlags, IN DWORD_PTR dwReserved);
...
#define HTTP_STATUS_LAST HTTP_STATUS_VERSION_NOT_SUP
    ...
    HINTERNET
    WINAPI
    WinHttpOpenRequest(IN HINTERNET hConnect, IN LPCWSTR pwszVerb, IN LPCWSTR pwszObjectName, IN LPCWSTR pwszVersion,
                       IN LPCWSTR pwszReferrer OPTIONAL, IN LPCWSTR FAR *ppwszAcceptTypes OPTIONAL, IN DWORD dwFlags);
...
#define WINHTTP_DEFAULT_ACCEPT_TYPES NULL
    ...
    BOOLAPI
    WinHttpAddRequestHeaders(IN HINTERNET hRequest, IN LPCWSTR pwszHeaders, IN DWORD dwHeadersLength,
...
#define WINHTTP_ADDREQ_FLAG_REPLACE 0x80000000
    ...
    BOOLAPI
    WinHttpSendRequest(IN HINTERNET hRequest, IN LPCWSTR pwszHeaders OPTIONAL, IN DWORD dwHeadersLength,
                       IN LPVOID lpOptional OPTIONAL, IN DWORD dwOptionalLength, IN DWORD dwTotalLength,
...
#define WINHTTP_NO_REQUEST_DATA NULL
    ...
    BOOLAPI WinHttpQueryAuthSchemes(IN HINTERNET hRequest,            // HINTERNET handle returned by WinHttpOpenRequest
    ...
    BOOLAPI WinHttpQueryAuthParams(IN HINTERNET hRequest, // HINTERNET handle returned by WinHttpOpenRequest
                                   IN DWORD AuthScheme,
    ...
    BOOLAPI
    WinHttpQueryHeaders(IN HINTERNET hRequest, IN DWORD dwInfoLevel, IN LPCWSTR pwszName OPTIONAL,
...
#define WINHTTP_NO_HEADER_INDEX NULL
    ...
    BOOLAPI
    WinHttpDetectAutoProxyConfigUrl(IN DWORD dwAutoDetectFlags, OUT LPWSTR *ppwszAutoConfigUrl);

    BOOLAPI
    WinHttpGetProxyForUrl(IN HINTERNET hSession, IN LPCWSTR lpcwszUrl, IN WINHTTP_AUTOPROXY_OPTIONS *pAutoProxyOptions,
