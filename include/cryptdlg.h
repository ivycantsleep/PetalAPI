...
#define ACTION_REVOCATION_DEFAULT_CACHE 0x00020000
    ...
    typedef BOOL(WINAPI *PFNCMFILTERPROC)(IN PCCERT_CONTEXT pCertContext,
...
#define CERT_DISPWELL_DISTRUST_ADD_LEAF_CERT 9
    ...
    //
    typedef UINT(WINAPI *PFNCMHOOKPROC)(IN HWND hwndDialog, IN UINT message, IN WPARAM wParam, IN LPARAM lParam);
...
typedef PCERT_SELECT_STRUCT_A PCERT_SELECT_STRUCT;
    ...
    CRYPTDLGAPI
    BOOL WINAPI CertSelectCertificateA(IN OUT PCERT_SELECT_STRUCT_A pCertSelectInfo);
#ifdef MAC
#define CertSelectCertificate CertSelectCertificateA
#else // !MAC
CRYPTDLGAPI
BOOL WINAPI CertSelectCertificateW(IN OUT PCERT_SELECT_STRUCT_W pCertSelectInfo);
#ifdef UNICODE
...
#define CERT_FILTER_KEY_EXISTS 0x0020
    ...
    DWORD
    WINAPI
    GetFriendlyNameOfCertA(PCCERT_CONTEXT pccert, LPSTR pchBuffer, DWORD cchBuffer);
    CRYPTDLGAPI
    DWORD
    WINAPI
    GetFriendlyNameOfCertW(PCCERT_CONTEXT pccert, LPWSTR pchBuffer, DWORD cchBuffer);
#ifdef UNICODE
...
#define szCERT_CERTIFICATE_ACTION_VERIFY "{7801ebd0-cf4b-11d0-851f-0060979387ea}"
    ...
    typedef HRESULT(WINAPI *PFNTRUSTHELPER)(IN PCCERT_CONTEXT pCertContext, IN DWORD lCustData,
                                            IN BOOL fLeafCertificate, IN LPBYTE pbTrustBlob);
    //
    //  Failure Reasons:
    //
...
#define CTL_MODIFY_REQUEST_ADD_TRUSTED 3
    ...
    HRESULT
    WINAPI
    CertModifyCertificatesToTrust(int cCerts,                   // Count of modifications to be done
    ...
    BOOL WINAPI FormatVerisignExtension(DWORD /*dwCertEncodingType*/, DWORD /*dwFormatType*/, DWORD /*dwFormatStrType*/,
