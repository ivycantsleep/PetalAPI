...
#define INTERFACE IDirect3DDevice3
    ...
    DECLARE_INTERFACE_(IDirect3DDevice3, IUnknown)
    {
        ...
        STDMETHOD(DrawPrimitiveStrided)(THIS_ D3DPRIMITIVETYPE, DWORD, LPD3DDRAWPRIMITIVESTRIDEDDATA, DWORD, DWORD)
            PURE;
        STDMETHOD(DrawIndexedPrimitiveStrided)(THIS_ D3DPRIMITIVETYPE, DWORD, LPD3DDRAWPRIMITIVESTRIDEDDATA, DWORD,
...
#define INTERFACE IDirect3DDevice7
    ...
    DECLARE_INTERFACE_(IDirect3DDevice7, IUnknown)
    {
        ...
        STDMETHOD(DrawIndexedPrimitiveVB)(THIS_ D3DPRIMITIVETYPE, LPDIRECT3DVERTEXBUFFER7, DWORD, DWORD, LPWORD, DWORD,
                                          DWORD) PURE;
        STDMETHOD(ComputeSphereVisibility)(THIS_ LPD3DVECTOR, LPD3DVALUE, DWORD, DWORD, LPDWORD) PURE;
...
#define INTERFACE IDirect3DVertexBuffer7
    ...
    DECLARE_INTERFACE_(IDirect3DVertexBuffer7, IUnknown)
    {
        ...
        STDMETHOD(ProcessVerticesStrided)(THIS_ DWORD, DWORD, DWORD, LPD3DDRAWPRIMITIVESTRIDEDDATA, DWORD,
