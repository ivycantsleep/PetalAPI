...
#define IS_COMPATIBLE_USBAUDIO_MID(guid)                                                                    \
    (((guid)->Data1 >= 0x4e1cecd2) && ((guid)->Data1 < 0x4e1cecd2 + 0xffff) && ((guid)->Data2 == 0x1679) && \
     ((guid)->Data3 == 0x463b) && ((guid)->Data4[0] == 0xa7) && ((guid)->Data4[1] == 0x2f) &&               \
     ((guid)->Data4[2] == 0xa5) && ((guid)->Data4[3] == 0xbf) && ((guid)->Data4[4] == 0x64) &&              \
     ((guid)->Data4[5] == 0xc8) && ((guid)->Data4[6] == 0x6e) && ((guid)->Data4[7] == 0xba))
...
#define IS_COMPATIBLE_USBAUDIO_PID(guid)                                                                    \
    (((guid)->Data1 >= 0xabcc5a5e) && ((guid)->Data1 < 0xabcc5a5e + 0xffff) && ((guid)->Data2 == 0xc263) && \
     ((guid)->Data3 == 0x463b) && ((guid)->Data4[0] == 0xa7) && ((guid)->Data4[1] == 0x2f) &&               \
     ((guid)->Data4[2] == 0xa5) && ((guid)->Data4[3] == 0xbf) && ((guid)->Data4[4] == 0x64) &&              \
     ((guid)->Data4[5] == 0xc8) && ((guid)->Data4[6] == 0x6e) && ((guid)->Data4[7] == 0xba))
...
#define DEFINE_USBAUDIO_PRODUCT_NAME(vid, pid, strIndex)                                                           \
    0xFC575048 + (USHORT)(vid), 0x2E08 + (USHORT)(pid), 0x463B + (USHORT)(strIndex), 0xA7, 0x2F, 0xA5, 0xBF, 0x64, \
        0xC8, 0x6E, 0xBA
...
#define STATIC_KSDATAFORMAT_SUBTYPE_DRM DEFINE_WAVEFORMATEX_GUID(WAVE_FORMAT_DRM)
...
#define STATIC_KSDATAFORMAT_SUBTYPE_ALAW DEFINE_WAVEFORMATEX_GUID(WAVE_FORMAT_ALAW)
...
#define STATIC_KSDATAFORMAT_SUBTYPE_MULAW DEFINE_WAVEFORMATEX_GUID(WAVE_FORMAT_MULAW)
...
#define STATIC_KSDATAFORMAT_SUBTYPE_ADPCM DEFINE_WAVEFORMATEX_GUID(WAVE_FORMAT_ADPCM)
...
#if defined(_NTDDK_)
typedef NTSTATUS(CALLBACK *PRTAUDIOGETPOSITION)(IN PFILE_OBJECT PinFileObject, OUT PUCHAR *ppPlayPosition,
                                                OUT PLONG plOffset);
...
#define STATIC_KSMETHODSETID_Wave_Queued 0x7432c160L, 0x8827, 0x11cf, 0xa1, 0x02, 0x00, 0x20, 0xaf, 0xd1, 0x56, 0xe4
...
// @@BEGIN_DDKSPLIT
//===========================================================================
#define STATIC_KSEVENTSETID_Sysaudio 0x04800320L, 0x4491, 0x11D1, 0xA0, 0x50, 0x40, 0x57, 0x05, 0xC1, 0x00, 0x00
...
#define KS_INTERLACE_Field1First \
    0x00000004 // else Field 2 is first;  top field in PAL is field 1, top field in NTSC is field 2?
...
#define DEFINE_KSPROPERTY_ITEM_OVERLAYUPDATE_INTERESTS(Handler)                                                    \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_OVERLAYUPDATE_INTERESTS, (Handler), sizeof(KSPROPERTY), sizeof(ULONG), NULL, \
                           NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_OVERLAYUPDATE_PALETTE(Handler)                                                       \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_OVERLAYUPDATE_PALETTE, NULL, sizeof(KSPROPERTY), 0, (Handler), NULL, 0, NULL, \
                           NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_OVERLAYUPDATE_COLORKEY(Handler)                                                       \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_OVERLAYUPDATE_COLORKEY, NULL, sizeof(KSPROPERTY), sizeof(COLORKEY), (Handler), \
                           NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_OVERLAYUPDATE_CLIPLIST(Handler)                          \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_OVERLAYUPDATE_CLIPLIST, NULL, sizeof(KSPROPERTY), \
                           2 * sizeof(RECT) + sizeof(RGNDATAHEADER), (Handler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_OVERLAYUPDATE_VIDEOPOSITION(Handler)                                            \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_OVERLAYUPDATE_VIDEOPOSITION, NULL, sizeof(KSPROPERTY), 2 * sizeof(RECT), \
                           (Handler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_OVERLAYUPDATE_DISPLAYCHANGE(Handler)                                                   \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_OVERLAYUPDATE_DISPLAYCHANGE, NULL, sizeof(KSPROPERTY), sizeof(KSDISPLAYCHANGE), \
                           (Handler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_OVERLAYUPDATE_COLORREF(Handler)                                                       \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_OVERLAYUPDATE_COLORREF, (Handler), sizeof(KSPROPERTY), sizeof(COLORREF), NULL, \
                           NULL, 0, NULL, NULL, 0)
