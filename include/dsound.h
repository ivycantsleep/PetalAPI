...
#define MAKE_DSHRESULT(code) MAKE_HRESULT(1, _FACDS, code)
    ...
    DEFINE_GUID(CLSID_DirectSoundFullDuplex, 0xfea4300c, 0x7959, 0x4147, 0xb2, 0x6a, 0x23, 0x77, 0xb9, 0xe7, 0xa9,
                0x1d);
    ...
    DEFINE_GUID(DSDEVID_DefaultVoicePlayback, 0xdef00002, 0x9c6d, 0x47ed, 0xaa, 0xf1, 0x4d, 0xda, 0x8f, 0x2b, 0x5c,
                0x03);

    // DirectSound default device for voice capture {DEF00003-9C6D-47ED-AAF1-4DDA8F2B5C03}
    DEFINE_GUID(DSDEVID_DefaultVoiceCapture, 0xdef00003, 0x9c6d, 0x47ed, 0xaa, 0xf1, 0x4d, 0xda, 0x8f, 0x2b, 0x5c,
                0x03);
...
#define INTERFACE IReferenceClock
    ...
    DECLARE_INTERFACE_(IReferenceClock, IUnknown)
    {
        ...
        STDMETHOD(AdviseTime)(THIS_ REFERENCE_TIME rtBaseTime, REFERENCE_TIME rtStreamTime, HANDLE hEvent,
                              LPDWORD pdwAdviseCookie) PURE;
        STDMETHOD(AdvisePeriodic)(THIS_ REFERENCE_TIME rtStartTime, REFERENCE_TIME rtPeriodTime, HANDLE hSemaphore,
                                  LPDWORD pdwAdviseCookie) PURE;
...
#define INTERFACE IDirectSound
    ...
    DECLARE_INTERFACE_(IDirectSound, IUnknown)
    {
        ...
        STDMETHOD(CreateSoundBuffer)(THIS_ LPCDSBUFFERDESC pcDSBufferDesc, LPDIRECTSOUNDBUFFER * ppDSBuffer,
...
#define INTERFACE IDirectSound3DListener
    ...
    DECLARE_INTERFACE_(IDirectSound3DListener, IUnknown)
    {
        ...
        STDMETHOD(SetOrientation)(THIS_ D3DVALUE xFront, D3DVALUE yFront, D3DVALUE zFront, D3DVALUE xTop, D3DVALUE yTop,
                                  D3DVALUE zTop, DWORD dwApply) PURE;
...
#define INTERFACE IDirectSoundCapture
    ...
    DECLARE_INTERFACE_(IDirectSoundCapture, IUnknown)
    {
        ...
        STDMETHOD(CreateCaptureBuffer)(THIS_ LPCDSCBUFFERDESC pcDSCBufferDesc, LPDIRECTSOUNDCAPTUREBUFFER * ppDSCBuffer,
                                       LPUNKNOWN pUnkOuter) PURE;
...
#define IDirectSoundCapture_Initialize(p, a) (p)->Initialize(a)
    ...
    DEFINE_GUID(IID_IDirectSoundCaptureBuffer, 0xb0210782, 0x89cd, 0x11d0, 0xaf, 0x8, 0x0, 0xa0, 0xc9, 0x25, 0xcd,
                0x16);
...
#define IDirectSoundCaptureBuffer_Unlock(p, a, b, c, d) (p)->Unlock(a, b, c, d)
    ...
    DEFINE_GUID(IID_IDirectSoundCaptureBuffer8, 0x990df4, 0xdbb, 0x4872, 0x83, 0x3e, 0x6d, 0x30, 0x3e, 0x80, 0xae,
                0xb6);
...
#define INTERFACE IDirectSoundNotify
    ...
    DECLARE_INTERFACE_(IDirectSoundNotify, IUnknown)
    {
        ...
        STDMETHOD(SetNotificationPositions)(THIS_ DWORD dwPositionNotifies, LPCDSBPOSITIONNOTIFY pcPositionNotifies)
            PURE;
    };
...
#define IDirectSoundFXEcho_GetAllParameters(p, a) (p)->GetAllParameters(a)
    ...
    DEFINE_GUID(IID_IDirectSoundFXDistortion, 0x8ecf4326, 0x455f, 0x4d8b, 0xbd, 0xa9, 0x8d, 0x5d, 0x3e, 0x9e, 0x3e,
                0x0b);
...
#define IDirectSoundFXDistortion_GetAllParameters(p, a) (p)->GetAllParameters(a)
    ...
    DEFINE_GUID(IID_IDirectSoundFXCompressor, 0x4bbd1154, 0x62f6, 0x4e2c, 0xa1, 0x5c, 0xd3, 0xb6, 0xc4, 0x17, 0xf7,
                0xa0);
...
#define IDirectSoundFXParamEq_GetAllParameters(p, a) (p)->GetAllParameters(a)
    ...
    DEFINE_GUID(IID_IDirectSoundFXI3DL2Reverb, 0x4b166a6a, 0x0d66, 0x43f3, 0x80, 0xe3, 0xee, 0x62, 0x80, 0xde, 0xe1,
                0xa4);
...
#define IDirectSoundFXI3DL2Reverb_GetPreset(p, a) (p)->GetPreset(a)
    ...
    DEFINE_GUID(IID_IDirectSoundFXWavesReverb, 0x46858c3a, 0x0dc6, 0x45e3, 0xb7, 0x60, 0xd4, 0xee, 0xf1, 0x6c, 0xb3,
                0x25);
...
#define IDirectSoundFXWavesReverb_GetAllParameters(p, a) (p)->GetAllParameters(a)
    ...
    DEFINE_GUID(IID_IDirectSoundCaptureFXAec, 0xad74143d, 0x903d, 0x4ab7, 0x80, 0x66, 0x28, 0xd3, 0x63, 0x03, 0x6d,
                0x65);
...
#define IDirectSoundCaptureFXAec_GetAllParameters(p, a) (p)->GetAllParameters(a)
    ...
    DEFINE_GUID(IID_IDirectSoundCaptureFXNoiseSuppress, 0xed311e41, 0xfbae, 0x4175, 0x96, 0x25, 0xcd, 0x8, 0x54, 0xf6,
                0x93, 0xca);
...
#define INTERFACE IDirectSoundFullDuplex
    ...
    DECLARE_INTERFACE_(IDirectSoundFullDuplex, IUnknown)
    {
        ...
        STDMETHOD(Initialize)(THIS_ LPCGUID pCaptureGuid, LPCGUID pRenderGuid, LPCDSCBUFFERDESC lpDscBufferDesc,
...
#define DS3DALG_DEFAULT GUID_NULL
    ...
    DEFINE_GUID(GUID_DSFX_STANDARD_DISTORTION, 0xef114c90, 0xcd1d, 0x484e, 0x96, 0xe5, 0x09, 0xcf, 0xaf, 0x91, 0x2a,
                0x21);

    // Compressor/Limiter {EF011F79-4000-406D-87AF-BFFB3FC39D57}
    DEFINE_GUID(GUID_DSFX_STANDARD_COMPRESSOR, 0xef011f79, 0x4000, 0x406d, 0x87, 0xaf, 0xbf, 0xfb, 0x3f, 0xc3, 0x9d,
                0x57);
    ...
    DEFINE_GUID(GUID_DSFX_STANDARD_I3DL2REVERB, 0xef985e71, 0xd5c7, 0x42d4, 0xba, 0x4d, 0x2d, 0x07, 0x3e, 0x2e, 0x96,
                0xf4);
