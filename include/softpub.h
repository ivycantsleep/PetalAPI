...
#define WINTRUST_ACTION_GENERIC_CERT_VERIFY \
    { 0x189a3842, 0x3041, 0x11d1, { 0x85, 0xe1, 0x0, 0xc0, 0x4f, 0xc2, 0x95, 0xee } }
...
#define GENERIC_CHAIN_CERTTRUST_FUNCTION L"GenericChainCertificateTrust"
    ...
    typedef HRESULT(WINAPI *PFN_WTD_GENERIC_CHAIN_POLICY_CALLBACK)(IN PCRYPT_PROVIDER_DATA pProvData,
                                                                   IN DWORD dwStepError, IN DWORD dwRegPolicySettings,
                                                                   IN DWORD cSigner,
