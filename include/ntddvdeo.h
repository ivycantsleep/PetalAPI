...
#define WVIDEO_DEVICE_NAME L"DISPLAY%d"
    ...
    DEFINE_GUID(GUID_DEVINTERFACE_DISPLAY_ADAPTER, 0x5b45201d, 0xf2f2, 0x4f3b, 0x85, 0xbb, 0x30, 0xff, 0x1f, 0x95, 0x35,
                0x99);
...
#define IOCTL_FSVIDEO_COPY_FRAME_BUFFER CTL_CODE(FILE_DEVICE_FULLSCREEN_VIDEO, 0x200, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
#define IOCTL_FSVIDEO_SET_CURRENT_MODE CTL_CODE(FILE_DEVICE_FULLSCREEN_VIDEO, 0x203, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
#define IOCTL_FSVIDEO_SET_CURSOR_POSITION \
    ...
    typedef VOID (*PVIDEO_WIN32K_CALLOUT)(IN PVOID Params);
...
#define VIDEO_MODE_NO_ZERO_MEMORY              \
    0x80000000 // High order bit of the mode   \
...
#define VIDEO_MODE_MAP_MEM_LINEAR               \
    0x40000000 // Miniports which support this  \
...
#define VIDEO_MODE_PALETTE_DRIVEN   \
    0x0004 // 0 = Colors are direct \
           // 1 = Colors are index to a palette
#define VIDEO_MODE_MANAGED_PALETTE          \
    0x0008 // 0 = Palette is fixed (must be \
           //     queried from miniport     \
           // 1 = Palette is settable.
#define VIDEO_MODE_INTERLACED        \
    0x0010 // 1 = Mode is interlaced \
           // 0 = non-interlaced
#define VIDEO_MODE_NO_OFF_SCREEN              \
    0x0020 // 1 = Offscreen memory CAN NOT be \
           //     used to store information.  \
           // 0 = Offscreen memory is available
#define VIDEO_MODE_NO_64_BIT_ACCESS                \
    0x0040 // 1 = 64 bit memory writes to frame    \
...
#define VIDEO_DEVICE_COLOR                  \
    0x1 // Is this device support color (1) \
        // or monochrome only
#define VIDEO_OPTIONAL_GAMMET_TABLE          \
    0x2 // Indicates that a gammet table can \
