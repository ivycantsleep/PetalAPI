...
#define UTC_OPCODE (UTC_OPCODE_TYPE1 | UTC_OPCODE_TYPE2 | UTC_SHORT_NAME | UTC_CONST_NAME | UTC_DATA_OBJECT)
...
#define TF_PACKAGE_LIST (UTC_DATA_OBJECT | UTC_SHORT_NAME | UTC_CONST_NAME)
#define TF_ALL_LISTS                                                                                                \
    (TF_DATA_OBJECT | TF_NAMED_OBJECT | TF_NAMESPACE_MODIFIER | TF_OPCODE_TYPE1 | TF_OPCODE_TYPE2 | TF_SHORT_NAME | \
     TF_CONST_NAME | TF_COMPILER_DIRECTIVE | TF_DATA_LIST | TF_PACKAGE_LIST | TF_FIELD_LIST | TF_PNP_MACRO |        \
     TF_BYTE_LIST | TF_DWORD_LIST)
