...
--*/
{
    ...
    case IOCTL_GET_PROCESSOR_OBJ_INFO:
        ...
        if (irpSp->Parameters.DeviceIoControl.OutputBufferLength < sizeof(IOCTL_GET_PROCESSOR_OBJ_INFO))
        {
        ...
        else
        {
            ...
            status = AMLIEvalNameSpaceObject(deviceExtension->AcpiObject, &data, 0, NULL);
            ...
            if (NT_SUCCESS(status))
            {
                ...
                (*(PPROCESSOR_OBJECT_INFO)resultBuffer).PhysicalID = ((PROCESSOROBJ *)data.pbDataBuff)->bApicID;

                (*(PPROCESSOR_OBJECT_INFO)resultBuffer).PBlkAddress = ((PROCESSOROBJ *)data.pbDataBuff)->dwPBlk;
    ...
    case IOCTL_ACPI_ASYNC_EVAL_METHOD:
        ...
        //
        status = ACPIIoctlAsyncEvalControlMethod(DeviceObject, Irp, irpSp);
        break;
    ...
    case IOCTL_ACPI_EVAL_METHOD:
        ...
        // Handle this elsewhere
        //
        status = ACPIIoctlEvalControlMethod(DeviceObject, Irp, irpSp);
        break;
