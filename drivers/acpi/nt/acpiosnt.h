...
typedef VOID (*PDEVICE_WORKER)(IN struct _DEVICE_EXTENSION *DevExt, IN ULONG Events);
...
#define DEV_MASK_INTERNAL_DEVICE (DEV_CAP_NO_FILTER | DEV_CAP_NO_STOP | DEV_PROP_EXCLUSIVE)
