...
typedef BOOL(WINAPI api_CompareObjectHandles)(HANDLE hFirstObjectHandle, HANDLE hSecondObjectHandle);
typedef LSTATUS(WINAPI api_NtCompareObjects)(HANDLE hFirstObjectHandle, HANDLE hSecondObjectHandle);
...
extern "C"
{
    ...
    EXPORT BOOL WINAPI _CompareObjectHandles(HANDLE hFirstObjectHandle, HANDLE hSecondObjectHandle)
    {
