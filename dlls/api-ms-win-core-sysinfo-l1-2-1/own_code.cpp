...
__inline errno_t __CRTDECL memcpy_s1(void *const _Destination, rsize_t const _DestinationSize,
...
__inline void *memcpy1(void *dest, const void *src, size_t len)
{
    char *d = (char *)dest;
...
__inline void *zeroset1(void *dest, size_t len)
{
