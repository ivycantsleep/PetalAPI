...
extern "C"
{
    ...
    __declspec(dllexport) HRESULT _PowerRegisterForEffectivePowerModeNotifications(
        ULONG Version, EFFECTIVE_POWER_MODE_CALLBACK *Callback, PVOID Context, PVOID *RegistrationHandle)
    {
    ...
    __declspec(dllexport) HRESULT _PowerUnregisterFromEffectivePowerModeNotifications(PVOID RegistrationHandle)
    {
        return S_OK;
    }
}
