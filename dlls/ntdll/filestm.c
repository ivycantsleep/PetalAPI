...
HRESULT
STDMETHODCALLTYPE
RtlInitFileStream(PRTL_FILE_STREAM FileStream)
{
...
HRESULT
STDMETHODCALLTYPE
RtlCloseFileStream(PRTL_FILE_STREAM FileStream)
{
...
ULONG
STDMETHODCALLTYPE
RtlAddRefFileStream(PRTL_FILE_STREAM FileStream)
{
...
ULONG
STDMETHODCALLTYPE
RtlReleaseFileStream(PRTL_FILE_STREAM FileStream)
{
...
HRESULT
STDMETHODCALLTYPE
RtlQueryInterfaceFileStream(IStream *Functions, PRTL_FILE_STREAM Data, const IID *Interface, PVOID *Object)
{
...
HRESULT
STDMETHODCALLTYPE
RtlReadFileStream(PRTL_FILE_STREAM FileStream, PVOID Buffer, ULONG BytesToRead, ULONG *BytesRead)
{
    //
    ...
    Status = NtReadFile(FileHandle,
                        ...
                        &IoStatusBlock, Buffer, BytesToRead,
...
HRESULT
STDMETHODCALLTYPE
RtlWriteFileStream(PRTL_FILE_STREAM FileStream, const VOID *Buffer, ULONG BytesToWrite, ULONG *BytesWritten)
{
...
HRESULT
STDMETHODCALLTYPE
RtlSeekFileStream(PRTL_FILE_STREAM FileStream, LARGE_INTEGER Distance, DWORD Origin, ULARGE_INTEGER *NewPosition)
{
    //
    ...
    case STREAM_SEEK_CUR:
        Status = NtQueryInformationFile(FileHandle, &IoStatusBlock, &CurrentPosition, sizeof(CurrentPosition),
    ...
    case STREAM_SEEK_END:
    {
        ...
        Status = NtQueryInformationFile(FileHandle, &IoStatusBlock, &StandardInfo, sizeof(StandardInfo),
        ...
        CurrentPosition.CurrentByteOffset.QuadPart = StandardInfo.EndOfFile.QuadPart - Distance.QuadPart;
    }
    break;
    ...
    Status = NtSetInformationFile(FileHandle, &IoStatusBlock, &CurrentPosition, sizeof(CurrentPosition),
                                  FilePositionInformation);
...
HRESULT
STDMETHODCALLTYPE
RtlSetFileStreamSize(PRTL_FILE_STREAM FileStream, ULARGE_INTEGER NewSize)
{
    //
    ...
    Status = NtSetInformationFile(FileHandle, &IoStatusBlock, &EndOfFile, sizeof(EndOfFile), FileEndOfFileInformation);
    if (!NT_SUCCESS(Status))
    {
        goto Exit;
    }
    ...
    Status =
        NtSetInformationFile(FileHandle, &IoStatusBlock, &Allocation, sizeof(Allocation), FileAllocationInformation);
    if (!NT_SUCCESS(Status))
    {
        goto Exit;
    }
...
HRESULT
STDMETHODCALLTYPE
RtlCopyFileStreamTo(PRTL_FILE_STREAM FileStream, IStream *AnotherStream, ULARGE_INTEGER NumberOfBytesToCopyLargeInteger,
                    ULARGE_INTEGER *NumberOfBytesRead, ULARGE_INTEGER *NumberOfBytesWrittenLargeInteger)
{
    //
...
HRESULT
STDMETHODCALLTYPE
RtlCommitFileStream(PRTL_FILE_STREAM FileStream, ULONG Flags)
{
...
HRESULT
STDMETHODCALLTYPE
RtlRevertFileStream(PRTL_FILE_STREAM FileStream)
{
...
HRESULT
STDMETHODCALLTYPE
RtlLockFileStreamRegion(PRTL_FILE_STREAM FileStream, ULARGE_INTEGER Offset, ULARGE_INTEGER NumberOfBytes,
                        ULONG LockType)
{
...
HRESULT
STDMETHODCALLTYPE
RtlUnlockFileStreamRegion(PRTL_FILE_STREAM FileStream, ULARGE_INTEGER Offset, ULARGE_INTEGER NumberOfBytes,
                          ULONG LockType)
{
...
HRESULT
STDMETHODCALLTYPE
RtlStatFileStream(PRTL_FILE_STREAM FileStream, STATSTG *StatusInformation, ULONG Flags)
{
...
HRESULT
STDMETHODCALLTYPE
RtlCloneFileStream(PRTL_FILE_STREAM FileStream, IStream **NewStream)
{
