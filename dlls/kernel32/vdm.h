...
BOOL BaseGetVdmConfigInfo(IN LPCWSTR CommandLine, IN ULONG DosSeqId, IN ULONG BinaryType,
                          IN PUNICODE_STRING CmdLineString, OUT PULONG VdmSize);
...
BOOL BaseCreateVDMEnvironment(LPWSTR lpEnvironment, ANSI_STRING *pAStringEnv, UNICODE_STRING *pUStringEnv);
...
#define WOW_ROOT L"\\Registry\\Machine\\System\\CurrentControlSet\\Control\\WOW"
