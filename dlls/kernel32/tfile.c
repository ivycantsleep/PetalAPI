...
main(int argc, char *argv[], char *envp[])
{
    ...
    fFile = FindFirstFile("e:\\nt\\dll\\nul", FindFileData);
    xassert(fFile != INVALID_HANDLE_VALUE);
    FindClose(fFile);

    FindFileData = (PWIN32_FIND_DATA)buff;
    fFile = FindFirstFile("e:\\", FindFileData);
    xassert(fFile == INVALID_HANDLE_VALUE);
    ...
    SearchPath(".;e:\\nt;e:\\nt\\dll", "base", ".dll", 512, cbuff, NULL);

    SearchPath(NULL, "win386.exe", ".EXe", 512, cbuff, NULL);
    ...
    *buff = '\0';
    ...
    iFile = CreateFile(buff, GENERIC_WRITE, FILE_SHARE_READ, NULL, OPEN_EXISTING, 0, NULL);
    xassert(iFile != INVALID_HANDLE_VALUE);
    w2 = GetTempFileName("e:\\tmp", "foobar", w1, buff);
    xassert(w1 == w2);
    oFile = CreateFile(buff, GENERIC_WRITE, 0, NULL, OPEN_EXISTING, 0, NULL);
    ...
    oFile = CreateFile("rrxyzzy", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
    xassert(oFile != INVALID_HANDLE_VALUE);

    iFile = CreateFile("e:\\nt\\dll\\usersrv.dll", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
    xassert(iFile != INVALID_HANDLE_VALUE);
    ...
    FindFileData = (PWIN32_FIND_DATA)buff;
    fFile = FindFirstFile("e:\\nt\\dll\\usersrv.dll", FindFileData);
    xassert(fFile != INVALID_HANDLE_VALUE);
    ...
    *buff = '\0';
    ...
    FindFileData = (PWIN32_FIND_DATA)buff;
    fFile = FindFirstFile("xyzzy\\*.*", FindFileData);
    xassert(fFile != INVALID_HANDLE_VALUE);
    b = TRUE;
    while (b)
    {
    ...
    iFile = CreateFile("", GENERIC_READ, FILE_SHARE_READ, NULL, OPEN_EXISTING, 0, NULL);
    xassert(iFile == INVALID_HANDLE_VALUE);

    iFile = CreateFile("nt.cfg", GENERIC_READ, FILE_SHARE_READ, NULL, OPEN_EXISTING, 0, NULL);
    xassert(iFile != INVALID_HANDLE_VALUE);
    ...
    xassert(LockFile(iFile, 0, 0, 10, 0));
    xassert(LockFile(iFile, 10, 0, 10, 0));
    fFile = CreateFile("nt.cfg", GENERIC_READ, FILE_SHARE_READ, NULL, OPEN_EXISTING, 0, NULL);
    xassert(fFile != INVALID_HANDLE_VALUE);
    ...
    oFile = CreateFile("ntos3.cfg", GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ, NULL, CREATE_ALWAYS,
    ...
    oFile = CreateFile("ntos3.cfg", GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ, NULL, CREATE_NEW,
    ...
    oFile = CreateFile("ntos3.cfg", GENERIC_WRITE | GENERIC_READ, FILE_SHARE_READ, NULL, OPEN_EXISTING, 0, NULL);
    xassert(oFile != INVALID_HANDLE_VALUE);
    ...
    FindFileData = (PWIN32_FIND_DATA)buff;
    fFile = FindFirstFile("dll\\*.*", FindFileData);
    xassert(fFile != INVALID_HANDLE_VALUE);
    b = TRUE;
    while (b)
    {
    ...
    strcat(cbuff, "\\*.*");
    fFile = FindFirstFile(cbuff, FindFileData);
    xassert(fFile != INVALID_HANDLE_VALUE);
    b = TRUE;
    while (b)
    {
