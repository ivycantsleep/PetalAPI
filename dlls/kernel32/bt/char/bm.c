...
VOID _fastcall MemToReg(IN ULONG Count, IN PULONG Address);

VOID _fastcall RegToMem(IN ULONG Count, IN PULONG Address);
...
VOID FiberRoutine1(LPVOID lpParameter)
{
    for (;;)
    {
...
VOID FiberRoutine0(LPVOID lpParameter)
{
    PERFINFO PerfInfo;
    int i;
...

{
    ...
    StartBenchMark("Memory To Register Aligned Test", MEMORY_TEST, &PerfInfo);
    ...
    StartBenchMark("Memory To Register Unaligned Within Cache Line Test", MEMORY_TEST, &PerfInfo);
    ...
    Address = (PULONG)((((ULONG)(&Buffer[256]) + 127) & ~127) - 1);
    StartBenchMark("Memory To Register Unaligned Across Cache Line Test", MEMORY_TEST / 2, &PerfInfo);
    ...
    StartBenchMark("Register To Memory Aligned Test", MEMORY_TEST, &PerfInfo);
    ...
    Address = (PULONG)((((ULONG)(&Buffer[256]) + 127) & ~127) + 1);
    StartBenchMark("Register To Memory Unaligned Within Cache Line Test", MEMORY_TEST, &PerfInfo);
    ...
    Address = (PULONG)((((ULONG)(&Buffer[256]) + 127) & ~127) - 1);
    StartBenchMark("Register To Memory Unaligned Across Cache Line Test", MEMORY_TEST / 2, &PerfInfo);
