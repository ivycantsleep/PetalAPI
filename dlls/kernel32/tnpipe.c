...
VOID ClientThread(LPVOID ThreadParameter)
{
    DWORD n;
    HANDLE C1;
    LPSTR l;
    ...
    C1 = CreateFile("\\\\.\\Pipe\\cw\\testpipe", GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ | FILE_SHARE_WRITE,
...
int main(int argc, char *argv[], char *envp[])
{
    ...
    S1 = CreateNamedPipe("\\\\.\\Pipe\\cw\\testpipe", PIPE_ACCESS_DUPLEX | FILE_FLAG_OVERLAPPED,
                         PIPE_WAIT | PIPE_READMODE_MESSAGE | PIPE_TYPE_MESSAGE, 2, 1024, 1024, 0, NULL);

    assert(S1 != INVALID_HANDLE_VALUE);

    S2 = CreateNamedPipe("\\\\.\\Pipe\\cw\\testpipe", PIPE_ACCESS_DUPLEX | FILE_FLAG_OVERLAPPED,
    ...
    S3 = CreateNamedPipe("\\\\.\\Pipe\\cw\\testpipe", PIPE_ACCESS_DUPLEX | FILE_FLAG_OVERLAPPED,
                         PIPE_WAIT | PIPE_READMODE_MESSAGE | PIPE_TYPE_MESSAGE, 992, 0, 0, 0, NULL);
