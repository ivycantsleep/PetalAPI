...
NTSTATUS
BaseDllReadWriteIniFile(IN BOOLEAN Unicode, IN BOOLEAN WriteOperation, IN BOOLEAN SectionOperation,
                        IN PVOID FileName OPTIONAL, IN PVOID ApplicationName OPTIONAL, IN PVOID VariableName OPTIONAL,
                        IN OUT PVOID VariableValue OPTIONAL, IN OUT PULONG VariableValueLength OPTIONAL);

DWORD
WINAPI
GetPrivateProfileSectionNamesA(LPSTR lpszReturnBuffer, DWORD nSize, LPCSTR lpFileName)
{
    return GetPrivateProfileStringA(NULL, NULL, NULL, lpszReturnBuffer, nSize, lpFileName);
}
...
{
    return GetPrivateProfileStringW(NULL, NULL, NULL, lpszReturnBuffer, nSize, lpFileName);
}
...
BOOL WINAPI GetPrivateProfileStructA(LPCSTR lpszSection, LPCSTR lpszKey, LPVOID lpStruct, UINT uSizeStruct,
                                     LPCSTR szFile)
{
    UCHAR szBuf[256];
    ...
    {
        lpFreeBuffer = (LPSTR)RtlAllocateHeap(RtlProcessHeap(), 0, nLen);
        if (!lpFreeBuffer)
        {
            return FALSE;
        }
    ...
    Result = FALSE;
    nLen = GetPrivateProfileStringA(lpszSection, lpszKey, NULL, lpBuf, nLen, szFile);
...
BOOL WINAPI GetPrivateProfileStructW(LPCWSTR lpszSection, LPCWSTR lpszKey, LPVOID lpStruct, UINT uSizeStruct,
                                     LPCWSTR szFile)
{
    WCHAR szBuf[256];
    ...
    {
        lpFreeBuffer = (PWSTR)RtlAllocateHeap(RtlProcessHeap(), 0, nLen * sizeof(WCHAR));
        if (!lpFreeBuffer)
        {
            return FALSE;
        }
    ...
    Result = FALSE;
    nLen = GetPrivateProfileStringW(lpszSection, lpszKey, NULL, lpBuf, nLen, szFile);
...
BOOL WINAPI WritePrivateProfileStructA(LPCSTR lpszSection, LPCSTR lpszKey, LPVOID lpStruct, UINT uSizeStruct,
                                       LPCSTR szFile)
{
    UCHAR szBuf[256];
    LPSTR lpBuf, lpBufTemp, lpFreeBuffer;
    ...
    if (lpStruct == NULL)
    {
        return WritePrivateProfileStringA(lpszSection, lpszKey, NULL, szFile);
    }
...
BOOL WINAPI WritePrivateProfileStructW(LPCWSTR lpszSection, LPCWSTR lpszKey, LPVOID lpStruct, UINT uSizeStruct,
                                       LPCWSTR szFile)
{
    WCHAR szBuf[256];
    PWSTR lpBuf, lpBufTemp, lpFreeBuffer;
    ...
    if (lpStruct == NULL)
    {
        return WritePrivateProfileStringW(lpszSection, lpszKey, NULL, szFile);
    }
...
{
    return (GetPrivateProfileIntA(lpAppName, lpKeyName, nDefault, NULL));
}

DWORD
GetProfileStringA(LPCSTR lpAppName, LPCSTR lpKeyName, LPCSTR lpDefault, LPSTR lpReturnedString, DWORD nSize)
{
    return (GetPrivateProfileStringA(lpAppName, lpKeyName, lpDefault, lpReturnedString, nSize, NULL));
}
...
{
    return (GetPrivateProfileSectionA(lpAppName, lpReturnedString, nSize, NULL));
}

BOOL WriteProfileSectionA(LPCSTR lpAppName, LPCSTR lpString)
{
    return (WritePrivateProfileSectionA(lpAppName, lpString, NULL));
}

UINT APIENTRY GetProfileIntW(LPCWSTR lpAppName, LPCWSTR lpKeyName, INT nDefault)
{
    return (GetPrivateProfileIntW(lpAppName, lpKeyName, nDefault, NULL));
}
...
{
    return (GetPrivateProfileStringW(lpAppName, lpKeyName, lpDefault, lpReturnedString, nSize, NULL));
}

BOOL APIENTRY WriteProfileStringW(LPCWSTR lpAppName, LPCWSTR lpKeyName, LPCWSTR lpString)
{
...
{
    return (GetPrivateProfileSectionW(lpAppName, lpReturnedString, nSize, NULL));
}

BOOL APIENTRY WriteProfileSectionW(LPCWSTR lpAppName, LPCWSTR lpString)
{
    return (WritePrivateProfileSectionW(lpAppName, lpString, NULL));
}
...
UINT GetPrivateProfileIntA(LPCSTR lpAppName, LPCSTR lpKeyName, INT nDefault, LPCSTR lpFileName)
{
    ...
    ReturnValue = 0;
    cb = GetPrivateProfileStringA(lpAppName, lpKeyName, NULL, ValueBuffer, sizeof(ValueBuffer), lpFileName);
    if (cb == 0)
    {
...
DWORD
GetPrivateProfileStringA(LPCSTR lpAppName, LPCSTR lpKeyName, LPCSTR lpDefault, LPSTR lpReturnedString, DWORD nSize,
                         LPCSTR lpFileName)
{
    NTSTATUS Status;
    ULONG n;
    ...
    Status = BaseDllReadWriteIniFile(FALSE, // Unicode,
                                     ...
                                     RTL_CONST_CAST(PVOID)(lpFileName), RTL_CONST_CAST(PVOID)(lpAppName),
                                     RTL_CONST_CAST(PVOID)(lpKeyName), lpReturnedString, &n);
...
BOOL WritePrivateProfileStringA(LPCSTR lpAppName, LPCSTR lpKeyName, LPCSTR lpString, LPCSTR lpFileName)
{
    ...
    Status = BaseDllReadWriteIniFile(FALSE, // Unicode,
                                     ...
                                     RTL_CONST_CAST(PVOID)(lpKeyName == NULL ? NULL : lpString), NULL);
    if (NT_SUCCESS(Status))
    {
        return (TRUE);
    }
...
GetPrivateProfileSectionA(LPCSTR lpAppName, LPSTR lpReturnedString, DWORD nSize, LPCSTR lpFileName)
{
    ...
    Status = BaseDllReadWriteIniFile(FALSE, // Unicode,
                                     ...
                                     RTL_CONST_CAST(PVOID)(lpFileName), RTL_CONST_CAST(PVOID)(lpAppName), NULL,
                                     lpReturnedString, &n);
    if (NT_SUCCESS(Status) || Status == STATUS_BUFFER_OVERFLOW)
    {
        if (NT_SUCCESS(Status))
...
BOOL WritePrivateProfileSectionA(LPCSTR lpAppName, LPCSTR lpString, LPCSTR lpFileName)
{
    ...
    Status = BaseDllReadWriteIniFile(FALSE, // Unicode,
                                     ...
                                     TRUE,  // SectionOperation
                                     RTL_CONST_CAST(PVOID)(lpFileName), RTL_CONST_CAST(PVOID)(lpAppName), NULL,
                                     RTL_CONST_CAST(PVOID)(lpString), NULL);
    if (NT_SUCCESS(Status))
    {
        return (TRUE);
    }
...
UINT APIENTRY GetPrivateProfileIntW(LPCWSTR lpAppName, LPCWSTR lpKeyName, INT nDefault, LPCWSTR lpFileName)
{
    NTSTATUS Status;
    ULONG ReturnValue;
    ...
    ReturnValue = 0;
    cb = GetPrivateProfileStringW(lpAppName, lpKeyName, NULL, ValueBuffer, sizeof(ValueBuffer) / sizeof(WCHAR),
                                  lpFileName);
    if (cb == 0)
    {
        ReturnValue = nDefault;
    ...
    else
    {
        ...
        Status = RtlUnicodeStringToAnsiString(&AnsiString, &Value, TRUE);
        if (NT_SUCCESS(Status))
        {
...
DWORD
APIENTRY
GetPrivateProfileStringW(LPCWSTR lpAppName, LPCWSTR lpKeyName, LPCWSTR lpDefault, LPWSTR lpReturnedString, DWORD nSize,
                         LPCWSTR lpFileName)
{
    NTSTATUS Status;
    ULONG n;
...
BOOL APIENTRY WritePrivateProfileStringW(LPCWSTR lpAppName, LPCWSTR lpKeyName, LPCWSTR lpString, LPCWSTR lpFileName)
{
    NTSTATUS Status;
...
BOOL APIENTRY WritePrivateProfileSectionW(LPCWSTR lpAppName, LPCWSTR lpString, LPCWSTR lpFileName)
{
    NTSTATUS Status;
...
VOID BaseDllFlushRegistryCache(VOID);

BOOL CloseProfileUserMapping(VOID)
{
...
BOOL OpenProfileUserMapping(VOID)
{
    NTSTATUS Status;
    ...
    if (BaseDllIniUserKeyPath.Length == 0)
    {
        ...
        if (NT_SUCCESS(Status))
        {
            InitializeObjectAttributes(&ObjectAttributes, &BaseDllIniUserKeyPath, OBJ_CASE_INSENSITIVE, NULL, NULL);
...
#if DBG
char *xOperationNames[] = { "FlushProfiles", "ReadKeyValue",         "WriteKeyValue", "DeleteKey",
                            "ReadKeyNames",  "ReadSectionNames",     "ReadSection",   "WriteSection",
                            "DeleteSection", "RefreshIniFileMapping" };
#endif

NTSTATUS
BaseDllCaptureIniFileParameters(BOOLEAN UnicodeParameters, INIFILE_OPERATION Operation, BOOLEAN WriteOperation,
                                BOOLEAN MultiValueStrings, PVOID FileName, PVOID ApplicationName, PVOID VariableName,
                                PVOID VariableValue, PULONG ResultMaxChars OPTIONAL,
                                PINIFILE_PARAMETERS *ReturnedParameterBlock);


NTSTATUS
BaseDllReadWriteIniFileViaMapping(IN PINIFILE_PARAMETERS a);

NTSTATUS
BaseDllReadWriteIniFileOnDisk(IN PINIFILE_PARAMETERS a);

NTSTATUS
BaseDllOpenIniFileOnDisk(IN PINIFILE_PARAMETERS a);

NTSTATUS
BaseDllCloseIniFileOnDisk(IN PINIFILE_PARAMETERS a);

NTSTATUS
BaseDllAppendNullToResultBuffer(IN PINIFILE_PARAMETERS a);

NTSTATUS
BaseDllAppendStringToResultBuffer(IN PINIFILE_PARAMETERS a, IN PANSI_STRING String OPTIONAL,
                                  IN PUNICODE_STRING StringU OPTIONAL, IN BOOLEAN IncludeNull);

NTSTATUS
BaseDllAppendBufferToResultBuffer(IN PINIFILE_PARAMETERS a, IN PBYTE Buffer OPTIONAL, IN PWSTR BufferU OPTIONAL,
                                  IN ULONG Chars, IN BOOLEAN IncludeNull);
                        ...
                        IN OUT PVOID VariableValue OPTIONAL, IN OUT PULONG VariableValueLength OPTIONAL)
{
    ...
    if (WriteOperation)
    {
        ...
        {
#if DBG
            if (ARGUMENT_PRESENT(VariableName) || ARGUMENT_PRESENT(VariableValue))
            {
    ...
    else
    {
        if (ARGUMENT_PRESENT(ApplicationName))
        {
            ...
            else if (ARGUMENT_PRESENT(VariableName))
            {
                Operation = ReadKeyValue;
            }
            else if (SectionOperation)
            {
        ...
        else if (SectionOperation || !ARGUMENT_PRESENT(VariableValue))
        {
            return STATUS_INVALID_PARAMETER;
        }
        else
    ...
    if (WriteOperation)
    {
        ASSERT(Operation == WriteKeyValue || Operation == WriteSection || Operation == DeleteKey ||
               Operation == DeleteSection || Operation == FlushProfiles || Operation == RefreshIniFileMapping);
    }
    else
    {
        ASSERT(Operation == ReadKeyValue || Operation == ReadKeyNames || Operation == ReadSectionNames ||
               Operation == ReadSection);
    }
#endif

    Status = BaseDllCaptureIniFileParameters(Unicode, Operation, WriteOperation, MultiValueStrings, FileName,
                                             ApplicationName, VariableName, VariableValue, VariableValueLength, &a);
    if (!NT_SUCCESS(Status))
    {
        return Status;
    }
    ...
    if (a->Operation == RefreshIniFileMapping)
    {
        ...
        {
            CaptureBuffer = CsrAllocateCaptureBuffer(1, a->BaseFileName.MaximumLength);
            ...
            {
                CsrCaptureMessageString(CaptureBuffer, (PCHAR)a->BaseFileName.Buffer, a->BaseFileName.Length,
                                        a->BaseFileName.MaximumLength, (PSTRING)&ap->IniFileName);
        ...
        if (NT_SUCCESS(Status))
        {
            CsrClientCallServer((PCSR_API_MSG)&m, CaptureBuffer,
                                CSR_MAKE_API_NUMBER(BASESRV_SERVERDLL_INDEX, BasepRefreshIniFileMapping), sizeof(*ap));
    ...
    else if (a->IniFileNameMapping != NULL)
    {
        Status = BaseDllReadWriteIniFileViaMapping(a);
#if DBG
        if (BaseDllDumpIniCalls)
        {
            if (NT_SUCCESS(Status) || Status == STATUS_BUFFER_OVERFLOW || Status == STATUS_MORE_PROCESSING_REQUIRED)
            {
                if (!a->WriteOperation)
                {
                    if (a->Unicode)
    ...
    if (NT_SUCCESS(Status))
    {
        if (a->Operation == ReadSectionNames || a->Operation == ReadKeyNames || a->Operation == ReadSection)
        {
    ...
    if (NT_SUCCESS(Status) || Status == STATUS_BUFFER_OVERFLOW)
    {
        ...
        else if (ARGUMENT_PRESENT(VariableValueLength))
        {
...
ULONG
BaseDllIniFileNameLength(IN BOOLEAN Unicode, IN PVOID *Name);

NTSTATUS
BaseDllFindIniFileNameMapping(IN PUNICODE_STRING FileName, IN PUNICODE_STRING BaseFileName,
                              OUT PINIFILE_MAPPING_FILENAME *ReturnedFileNameMapping);

BOOLEAN
BaseDllGetApplicationName(IN PINIFILE_PARAMETERS a, OUT PANSI_STRING *ApplicationName OPTIONAL,
                          OUT PUNICODE_STRING *ApplicationNameU OPTIONAL);

BOOLEAN
BaseDllGetVariableName(IN PINIFILE_PARAMETERS a, OUT PANSI_STRING *VariableName OPTIONAL,
                       OUT PUNICODE_STRING *VariableNameU OPTIONAL);

BOOLEAN
BaseDllGetVariableValue(IN PINIFILE_PARAMETERS a, OUT PBYTE *VariableValue OPTIONAL, OUT PWSTR *VariableValueU OPTIONAL,
                        OUT PULONG VariableValueLength);

NTSTATUS
BaseDllCaptureIniFileParameters(BOOLEAN Unicode, INIFILE_OPERATION Operation, BOOLEAN WriteOperation,
                                BOOLEAN MultiValueStrings, PVOID FileName OPTIONAL, PVOID ApplicationName OPTIONAL,
                                PVOID VariableName OPTIONAL, PVOID VariableValue OPTIONAL,
                                PULONG ResultMaxChars OPTIONAL, PINIFILE_PARAMETERS *ReturnedParameterBlock)
{
    NTSTATUS Status;
    PBYTE s;
    PWSTR p, p1;
    ULONG TotalSize, CharSize, NtFileNameLength, FileNameLength, ApplicationNameLength, VariableNameLength,
        VariableValueLength;
    ANSI_STRING AnsiString;
    PINIFILE_PARAMETERS a;
    ...
    TotalSize += (ApplicationNameLength + 1 + VariableNameLength + 1 + VariableValueLength + 1) * CharSize;
    ...
    if (ARGUMENT_PRESENT(FileName))
    {
        ...
        if (FileNameLength != 0)
        {
            ...
            {
                if (*p1 == OBJ_NAME_PATH_SEPARATOR || *p1 == L'/' || *p1 == L':')
                {
                    p1++;
                    break;
                }
        ...
        BaseDllFindIniFileNameMapping(&a->FileName, &a->BaseFileName, &a->IniFileNameMapping);
    }
    else
    {
                        ...
                        OUT PULONG VariableValueLength)
{
    ...
    if (ARGUMENT_PRESENT(VariableValue))
    {
        if (a->ValueLength == 0)
        {
            ...
            Status = RtlUnicodeToMultiByteN(a->ValueBuffer, a->ValueLength, &Index, a->ValueBufferU, a->ValueLengthU);

            if (!NT_SUCCESS(Status))
            {
                KdPrint(("BASEDLL: UnicodeToAnsi of %.*ws failed (%08x)\n", a->ValueLengthU / sizeof(WCHAR),
                         a->ValueBufferU, Status));
                return FALSE;
            }
    ...
    if (ARGUMENT_PRESENT(VariableValueU))
    {
        if (a->ValueLengthU == 0)
        {
            ...
            Status = RtlMultiByteToUnicodeN(a->ValueBufferU, a->ValueLengthU, &Index, a->ValueBuffer, a->ValueLength);
...
BaseDllAppendNullToResultBuffer(IN PINIFILE_PARAMETERS a)
{
    return BaseDllAppendBufferToResultBuffer(a, NULL, NULL, 0, TRUE);
}
                                  ...
                                  IN PUNICODE_STRING StringU OPTIONAL, IN BOOLEAN IncludeNull)
{
    if (ARGUMENT_PRESENT(String))
    {
        ...
        {
            return BaseDllAppendBufferToResultBuffer(a, String->Buffer, NULL, String->Length, IncludeNull);
        }
    }
    else if (ARGUMENT_PRESENT(StringU))
    {
        ...
        {
            return BaseDllAppendBufferToResultBuffer(a, NULL, StringU->Buffer, StringU->Length / sizeof(WCHAR),
                                                     IncludeNull);
        }
    }
    else
    ...
    if (ARGUMENT_PRESENT(Buffer))
    {
        ...
        else
        {
            ...
            if (Chars)
            {
                if (a->Unicode)
                {
                    Status = RtlMultiByteToUnicodeN(a->ResultBufferU + a->ResultChars, Chars * sizeof(WCHAR), &Index,
                                                    Buffer, CharsMbcs);
                    if (!NT_SUCCESS(Status))
                    {
                        KdPrint(("BASEDLL: AnsiToUnicode of %.*s failed (%08x)\n", Chars, Buffer, Status));
    ...
    else if (ARGUMENT_PRESENT(BufferU))
    {
        ...
        else
        {
            ...
            if (Chars)
            {
                ...
                {
                    Status = RtlUnicodeToMultiByteN(a->ResultBuffer + a->ResultChars, Chars, &Index, BufferU,
                              ...
                              OUT PINIFILE_MAPPING_FILENAME *ReturnedFileNameMapping)
{
    ...
    if ((FileName->Buffer == BaseFileName->Buffer) || RtlPrefixUnicodeString(&BaseWindowsDirectory, FileName, TRUE) ||
        ...
        (IsTerminalServer() && RtlPrefixUnicodeString(&TermsrvWindowsDir, FileName, TRUE)))
    {
        ...
        while (FileNameMapping != NULL)
        {
            ...
            if (RtlEqualUnicodeString(BaseFileName, BASE_READ_REMOTE_STR(FileNameMapping->Name, TempStr), TRUE))
            {
                Status = STATUS_SUCCESS;
                break;
            }
...
NTSTATUS
BaseDllOpenMappingTarget(IN PINIFILE_PARAMETERS a, IN PINIFILE_MAPPING_VARNAME VarNameMapping,
                         IN PUNICODE_STRING ApplicationName OPTIONAL, IN BOOLEAN WriteAccess, OUT PHANDLE Key);

PINIFILE_MAPPING_APPNAME
BaseDllFindAppNameMapping(IN PINIFILE_MAPPING_FILENAME FileNameMapping, IN PUNICODE_STRING ApplicationName);

PINIFILE_MAPPING_VARNAME
BaseDllFindVarNameMapping(IN PINIFILE_MAPPING_APPNAME AppNameMapping, IN PUNICODE_STRING VariableName);

NTSTATUS
BaseDllReadApplicationNames(IN PINIFILE_PARAMETERS a);

NTSTATUS
BaseDllCheckKeyNotEmpty(IN HANDLE Key, IN PUNICODE_STRING SubKeyName);

NTSTATUS
BaseDllReadVariableNames(IN PINIFILE_PARAMETERS a, IN PINIFILE_MAPPING_APPNAME AppNameMapping);

NTSTATUS
BaseDllReadVariableValue(IN PINIFILE_PARAMETERS a, IN PINIFILE_MAPPING_APPNAME AppNameMapping,
                         IN PINIFILE_MAPPING_VARNAME VarNameMapping OPTIONAL, IN PUNICODE_STRING VariableName OPTIONAL);

NTSTATUS
BaseDllReadApplicationVariables(IN PINIFILE_PARAMETERS a, IN PINIFILE_MAPPING_APPNAME AppNameMapping);

NTSTATUS
BaseDllDeleteApplicationVariables(IN PINIFILE_PARAMETERS a, IN PINIFILE_MAPPING_APPNAME AppNameMapping);

NTSTATUS
BaseDllWriteApplicationVariables(IN PINIFILE_PARAMETERS a, IN PINIFILE_MAPPING_APPNAME AppNameMapping);

NTSTATUS
BaseDllWriteVariableValue(IN PINIFILE_PARAMETERS a, IN PINIFILE_MAPPING_APPNAME AppNameMapping,
...
BaseDllReadWriteIniFileViaMapping(IN PINIFILE_PARAMETERS a)
{
    ...
    else if (a->Operation == ReadSectionNames)
    {
        return BaseDllReadApplicationNames(a);
    }
    else if (!BaseDllGetApplicationName(a, NULL, &ApplicationNameU))
    {
        return STATUS_INVALID_PARAMETER;
    }
    ...
    else if (a->Operation == WriteSection || a->Operation == DeleteSection)
    {
...
VOID BaseDllFlushRegistryCache(VOID)
{
    ...
    if (BaseDllRegistryCache.RegistryPath.Buffer != NULL)
    {
        ...
        RtlZeroMemory(&BaseDllRegistryCache.RegistryPath, sizeof(BaseDllRegistryCache.RegistryPath));
    }
                         ...
                         IN PUNICODE_STRING ApplicationName OPTIONAL, IN BOOLEAN WriteAccess, OUT PHANDLE Key)
{
    ...
    *Key = INVALID_HANDLE_VALUE;
    ...
    MappingFlags =
        VarNameMapping->MappingFlags & (INIFILE_MAPPING_APPEND_BASE_NAME | INIFILE_MAPPING_APPEND_APPLICATION_NAME |
                                        INIFILE_MAPPING_SOFTWARE_RELATIVE | INIFILE_MAPPING_USER_RELATIVE);
    if (MappingTarget == NULL || MappingTarget->RegistryPath.Length == 0)
    {
        return STATUS_SUCCESS;
    }

    if (ARGUMENT_PRESENT(ApplicationName) && (MappingFlags & INIFILE_MAPPING_APPEND_APPLICATION_NAME))
    {
    ...
    else if (MappingFlags & INIFILE_MAPPING_SOFTWARE_RELATIVE)
    {
    ...
    RtlEnterCriticalSection(&BaseDllRegistryCache.Lock);
    if (BaseDllRegistryCache.RegistryKey != INVALID_HANDLE_VALUE &&
        BaseDllRegistryCache.MappingTarget == MappingTarget && BaseDllRegistryCache.MappingFlags == MappingFlags &&
        BaseDllRegistryCache.WriteAccess == WriteAccess &&
        RtlEqualUnicodeString(&BaseDllRegistryCache.RegistryPath, &RegistryPath, TRUE))
    {
        Status = NtQueryKey(BaseDllRegistryCache.RegistryKey, KeyBasicInformation, &KeyBasicInfo, sizeof(KeyBasicInfo),
                            &ResultLength);
    ...
    repeatoperation:
        ...
        Status = NtCreateKey(
            Key, STANDARD_RIGHTS_WRITE | KEY_QUERY_VALUE | KEY_ENUMERATE_SUB_KEYS | KEY_SET_VALUE | KEY_CREATE_SUB_KEY,
            &ObjectAttributes, 0, NULL, 0, &CreateDisposition);
        //
        ...
        if (Status == STATUS_OBJECT_NAME_NOT_FOUND && OperationRetried == FALSE)
        {
            ...
            InitializeObjectAttributes(&RetryObjectAttributes, &RetryRegistryPath, OBJ_CASE_INSENSITIVE | OBJ_OPENIF,
                                       NULL, NULL);
            RetryStatus = NtCreateKey(&RetryKey,
                                      STANDARD_RIGHTS_WRITE | KEY_QUERY_VALUE | KEY_ENUMERATE_SUB_KEYS | KEY_SET_VALUE |
                                          KEY_CREATE_SUB_KEY,
                                      &RetryObjectAttributes, 0, NULL, 0, &RetryCreateDisposition);
...
BaseDllFindAppNameMapping(IN PINIFILE_MAPPING_FILENAME FileNameMapping, IN PUNICODE_STRING ApplicationName)
{
    ...
    while (AppNameMapping != NULL)
    {
        ...
        if (RtlEqualUnicodeString(BASE_READ_REMOTE_STR(AppNameMapping->Name, TempStr), ApplicationName, TRUE))
        {
...
BaseDllFindVarNameMapping(IN PINIFILE_MAPPING_APPNAME AppNameMapping, IN PUNICODE_STRING VariableName)
{
    ...
    while (VarNameMapping != NULL)
    {
        ...
        if (RtlEqualUnicodeString(BASE_READ_REMOTE_STR(VarNameMapping->Name, TempStr), VariableName, TRUE))
        {
...
BaseDllReadApplicationNames(IN PINIFILE_PARAMETERS a)
{
    ...
    Status =
        BaseDllOpenMappingTarget(a, (PINIFILE_MAPPING_VARNAME)AppNameMapping->DefaultVarNameMapping, NULL, FALSE, &Key);
    ...
    for (SubKeyIndex = 0; TRUE; SubKeyIndex++)
    {
        ...
        if (NT_SUCCESS(Status))
        {
            ...
            Status = BaseDllCheckKeyNotEmpty(Key, &SubKeyName);
...
BaseDllCheckKeyNotEmpty(IN HANDLE Key, IN PUNICODE_STRING SubKeyName)
{
    ...
    Status = NtEnumerateValueKey(SubKey, 0, KeyValueBasicInformation, &KeyValueInformation, sizeof(KeyValueInformation),
                                 &ResultLength);
...
BaseDllReadVariableNames(IN PINIFILE_PARAMETERS a, IN PINIFILE_MAPPING_APPNAME AppNameMapping)
{
    ...
    Status = BaseDllOpenMappingTarget(a, VarNameMapping, ApplicationNameU, FALSE, &Key);
    if (!NT_SUCCESS(Status) || Key == INVALID_HANDLE_VALUE)
    {
        return Status;
    }
    ...
    {
        Status = NtEnumerateValueKey(Key, ValueIndex, KeyValueBasicInformation, KeyValueInformation, sizeof(Buffer),
                                     &ResultLength);
        if (Status == STATUS_NO_MORE_ENTRIES)
        {
            break;
                         ...
                         IN PINIFILE_MAPPING_VARNAME VarNameMapping OPTIONAL, IN PUNICODE_STRING VariableName OPTIONAL)
{
    ...
    Status = NtQueryValueKey(Key, VariableName, KeyValuePartialInformation, &KeyValueInformation,
    ...
    if (!NT_SUCCESS(Status))
    {
        ...
        Status = NtQueryValueKey(Key, VariableName, KeyValuePartialInformation, p, ResultLength, &ResultLength);
    }
    else
    {
    ...
    if (NT_SUCCESS(Status))
    {
        if (p->Type == REG_SZ)
        {
            ...
            if (NT_SUCCESS(Status))
            {
                ...
                if (a->Operation == ReadKeyValue && Value.Length >= (2 * sizeof(WCHAR)) &&
                    (s[0] == s[(Value.Length - sizeof(WCHAR)) / sizeof(WCHAR)]) && (s[0] == L'"' || s[0] == L'\''))
                {
                    Value.Buffer += 1;
...
BaseDllReadApplicationVariables(IN PINIFILE_PARAMETERS a, IN PINIFILE_MAPPING_APPNAME AppNameMapping)
{
    ...
    while (VarNameMapping != NULL)
    {
        if (VarNameMapping->Name.Length != 0)
        {
            ...
            Status = BaseDllReadVariableValue(a, AppNameMapping, VarNameMapping,
    ...
    for (ValueIndex = 0; TRUE; ValueIndex++)
    {
        ...
        if (!NT_SUCCESS(Status) && Status != STATUS_OBJECT_NAME_NOT_FOUND && Status != STATUS_OBJECT_TYPE_MISMATCH)
        {
            return Status;
        }
    }
...
BaseDllDeleteApplicationVariables(IN PINIFILE_PARAMETERS a, IN PINIFILE_MAPPING_APPNAME AppNameMapping)
{
    ...
    while (VarNameMapping != NULL)
    {
        if (VarNameMapping->Name.Length != 0)
        {
            ...
            Status = BaseDllWriteVariableValue(a, AppNameMapping, VarNameMapping,
                                               BASE_READ_REMOTE_STR(VarNameMapping->Name, TempStr));
    ...
    Status = BaseDllOpenMappingTarget(a, VarNameMapping, ApplicationNameU, TRUE, &Key);
    if (!NT_SUCCESS(Status) || Key == INVALID_HANDLE_VALUE)
    {
        return Status;
    }
    ...
    do
    {
        ...
        //
        Status =
            NtEnumerateValueKey(Key, 0, KeyValueBasicInformation, KeyValueInformation, sizeof(Buffer), &ResultLength);
        ...
        if (NT_SUCCESS(Status))
        {
            ...
            VariableName.Length = (USHORT)KeyValueInformation->NameLength;
            VariableName.MaximumLength = (USHORT)KeyValueInformation->NameLength;
            Status = NtDeleteValueKey(Key, &VariableName);
            //
...
BaseDllWriteApplicationVariables(IN PINIFILE_PARAMETERS a, IN PINIFILE_MAPPING_APPNAME AppNameMapping)
{
    ...
    else if (a->ValueBufferU != NULL && a->ValueLengthU != 0)
    {
    ...
    try
    {
        ...
        while (CurrentValueLength)
        {
            ...
            else
            {
                ...
                a->VariableNameU.Length = 0;
                FreeBuffer = RtlAllocateHeap(RtlProcessHeap(), MAKE_TAG(TMP_TAG),
                                             a->VariableNameU.MaximumLength + ((a->ValueLength + 1) * sizeof(WCHAR)));
                if (FreeBuffer == NULL)
                {
                    Status = STATUS_NO_MEMORY;
                    break;
            ...
            if (!NT_SUCCESS(Status))
            {
                ...
                {
                    RtlMoveMemory((PCHAR)NewValueBuffer + NewValueLength, CurrentVariableStart, CurrentVariableLength);
                          ...
                          IN PINIFILE_MAPPING_VARNAME VarNameMapping OPTIONAL, IN PUNICODE_STRING VariableName OPTIONAL)
{
    ...
    Status = NtQueryValueKey(Key, VariableName, KeyValueBasicInformation, &KeyValueInformation,
                             sizeof(KeyValueInformation), &ResultLength);
    if (NT_SUCCESS(Status) || Status == STATUS_BUFFER_OVERFLOW)
    {
    ...
    if (a->Operation == WriteKeyValue || a->Operation == WriteSection)
    {
        ...
        {
            Status = NtSetValueKey(Key, VariableName, 0, REG_SZ, VariableValueU, VariableValueLength);
        }
    }
    else
    {
...
NTSTATUS
BaseDllReadSectionNames(IN PINIFILE_PARAMETERS a);

NTSTATUS
BaseDllReadKeywordNames(IN PINIFILE_PARAMETERS a);

NTSTATUS
BaseDllReadKeywordValue(IN PINIFILE_PARAMETERS a);

NTSTATUS
BaseDllReadSection(IN PINIFILE_PARAMETERS a);

NTSTATUS
BaseDllWriteSection(IN PINIFILE_PARAMETERS a);

NTSTATUS
BaseDllWriteKeywordValue(IN PINIFILE_PARAMETERS a, IN PUNICODE_STRING VariableName OPTIONAL);
...
BaseDllReadWriteIniFileOnDisk(IN PINIFILE_PARAMETERS a)
{
    ...
    if (NT_SUCCESS(Status))
    {
        try
        {
            ...
            if (a->IniFile->UnicodeFile &&
                ((*(PWCHAR)a->TextCurrent == BYTE_ORDER_MARK) || (*(PWCHAR)a->TextCurrent == REVERSE_BYTE_ORDER_MARK)))
            {
                // Skip past the BOM.
    ...
    if (IsTerminalServer())
    {
        ...
        // up the ini file
        if (!NT_SUCCESS(Status) && ((a->Operation == ReadSectionNames) || (a->Operation == ReadKeyValue) ||
                                    (a->Operation == ReadKeyNames) || (a->Operation == ReadSection)))
        {
            ...
            if (TermsrvSyncUserIniFile(a))
            {
                BaseDllReadWriteIniFileOnDisk(a);
                 ...
                 ((a->Operation == WriteKeyValue) || (a->Operation == DeleteKey) || (a->Operation == WriteSection) ||
    ...
    if (Status == STATUS_OBJECT_NAME_NOT_FOUND && !a->WriteOperation && PartialResultChars != 0)
    {
        Status = STATUS_SUCCESS;
    }
...
BaseDllOpenIniFileOnDisk(IN PINIFILE_PARAMETERS a)
{
    ...
    if ((a->FileName.Length > sizeof(WCHAR) && a->FileName.Buffer[1] == L':') ||
        (a->FileName.Length != 0 && wcscspn(a->FileName.Buffer, L"\\/") != (a->FileName.Length / sizeof(WCHAR))))
    {
        n = GetFullPathNameW(a->FileName.Buffer, a->NtFileName.MaximumLength / sizeof(WCHAR), a->NtFileName.Buffer,
                             &FilePart);
    ...
    else
    {
            ...
            !(NT_SUCCESS(Status = gpTermsrvBuildIniFileName(&a->NtFileName, &a->BaseFileName))))
        {
            ...
            RtlCopyUnicodeString(&a->NtFileName, &BaseWindowsDirectory);
            Status = RtlAppendUnicodeToString(&a->NtFileName, L"\\");
            if (NT_SUCCESS(Status))
            {
                Status = RtlAppendUnicodeStringToString(&a->NtFileName, &a->BaseFileName);
            }
        }
    }
    ...
    if (NT_SUCCESS(Status))
    {
        if (RtlDosPathNameToNtPathName_U(a->NtFileName.Buffer, &FullFileName, &FilePart, NULL))
        {
            RtlCopyUnicodeString(&a->NtFileName, &FullFileName);
            RtlFreeUnicodeString(&FullFileName);

            IniFile = RtlAllocateHeap(RtlProcessHeap(), MAKE_TAG(INI_TAG) | HEAP_ZERO_MEMORY,
            ...
            InitializeObjectAttributes(&ObjectAttributes, &IniFile->NtFileName, OBJ_CASE_INSENSITIVE, NULL, NULL);
            if (IniFile->WriteAccess)
            {
                Status = NtCreateFile(&IniFile->FileHandle, SYNCHRONIZE | GENERIC_READ | GENERIC_WRITE,
            ...
            {
                Status = NtOpenFile(&IniFile->FileHandle, SYNCHRONIZE | GENERIC_READ, &ObjectAttributes, &IoStatusBlock,
    ...
    if (NT_SUCCESS(Status))
    {
        ...
        Length.QuadPart = -1;
        Status = NtLockFile(IniFile->FileHandle, NULL, NULL, NULL, &IoStatusBlock, &ByteOffset, &Length, LockFileKey,
                            FALSE, IniFile->WriteAccess);
        if (!NT_SUCCESS(Status))
        {
        ...
        if (NT_SUCCESS(Status))
        {
            Status = NtQueryInformationFile(IniFile->FileHandle, &IoStatusBlock, &IniFile->StandardInformation,
                                            sizeof(IniFile->StandardInformation), FileStandardInformation);
            if (Status == STATUS_BUFFER_OVERFLOW)
            {
                Status = STATUS_SUCCESS;
            }
    ...
    if (!NT_SUCCESS(Status))
    {
        ...
        if (IniFile != NULL)
        {
            if (IniFile->LockedFile)
            {
                ByteOffset.QuadPart = 0;
                Length.QuadPart = -1;
                NtUnlockFile(IniFile->FileHandle, &IoStatusBlock, &ByteOffset, &Length, LockFileKey);
            }
    ...
    Status = NtAllocateVirtualMemory(NtCurrentProcess(), &IniFile->BaseAddress, 0, &IniFile->RegionSize, MEM_RESERVE,
                                     PAGE_READWRITE);
    if (NT_SUCCESS(Status))
    {
        Status = NtAllocateVirtualMemory(NtCurrentProcess(), &IniFile->BaseAddress, 0, &IniFile->CommitSize, MEM_COMMIT,
                                         PAGE_READWRITE);
        if (NT_SUCCESS(Status))
        {
            Status = NtReadFile(IniFile->FileHandle, NULL, NULL, NULL, &IoStatusBlock, IniFile->BaseAddress,
                                IniFile->EndOfFile, NULL, &LockFileKey);
    ...
    if (IniFile != NULL)
    {
        ...
        if (IniFile->BaseAddress != NULL)
        {
            if (IniFile->UpdateOffset != 0xFFFFFFFF && IniFile->WriteAccess)
            {
                ...
                Status = NtWriteFile(IniFile->FileHandle, NULL, NULL, NULL, &IoStatusBlock,
                                     (PCHAR)(IniFile->BaseAddress) + IniFile->UpdateOffset, UpdateLength, &ByteOffset,
                                     &LockFileKey);
                if (NT_SUCCESS(Status))
                {
                    ...
                    else
                    {
                        ...
                        Status = NtSetInformationFile(IniFile->FileHandle, &IoStatusBlock, &Length, sizeof(Length),
            ...
            NtFreeVirtualMemory(NtCurrentProcess(), &IniFile->BaseAddress, &IniFile->RegionSize, MEM_RELEASE);
        ...
        if (IniFile->LockedFile)
        {
            ByteOffset.QuadPart = 0;
            Length.QuadPart = -1;
            NtUnlockFile(IniFile->FileHandle, &IoStatusBlock, &ByteOffset, &Length,
...
NTSTATUS
BaseDllFindSection(IN PINIFILE_PARAMETERS a);

NTSTATUS
BaseDllFindKeyword(IN PINIFILE_PARAMETERS a);

NTSTATUS
BaseDllAdvanceTextPointer(IN PINIFILE_PARAMETERS a, IN ULONG StopAt);
...
BaseDllReadSectionNames(IN PINIFILE_PARAMETERS a)
{
    ...
    while (NT_SUCCESS(Status))
    {
        ...
        {
            Status = BaseDllAppendStringToResultBuffer(a, a->AnsiSectionName, a->UnicodeSectionName, TRUE);
        }
        else
        {
            if (Status == STATUS_NO_MORE_ENTRIES)
...
BaseDllReadKeywordNames(IN PINIFILE_PARAMETERS a)
{
    ...
    while (NT_SUCCESS(Status))
    {
        ...
        if (Status == STATUS_MORE_ENTRIES)
        {
            Status = BaseDllAppendStringToResultBuffer(a, a->AnsiKeywordName, a->UnicodeKeywordName, TRUE);
        }
        else
        {
            if (Status == STATUS_NO_MORE_ENTRIES)
...
BaseDllReadSection(IN PINIFILE_PARAMETERS a)
{
    ...
    while (TRUE)
    {
        ...
        if (Status == STATUS_MORE_ENTRIES)
        {
            ...
            {
                Status = BaseDllAppendStringToResultBuffer(a, a->AnsiKeywordName, a->UnicodeKeywordName, FALSE);
                if (!NT_SUCCESS(Status))
                {
                    return Status;
                }
                ...
                Status =
                    BaseDllAppendBufferToResultBuffer(a, a->Unicode ? NULL : "=", a->Unicode ? L"=" : NULL, 1, FALSE);
                if (!NT_SUCCESS(Status))
                {
                    return Status;
                }
            ...
            Status = BaseDllAppendStringToResultBuffer(a, a->AnsiKeywordValue, a->UnicodeKeywordValue, TRUE);
            if (!NT_SUCCESS(Status))
            {
                return Status;
            }
...
NTSTATUS
BaseDllModifyMappedFile(IN PINIFILE_PARAMETERS a, IN PVOID AddressInFile, IN ULONG SizeToRemove, IN PVOID InsertBuffer,
...
BaseDllWriteSection(IN PINIFILE_PARAMETERS a)
{
    ...
    else
    {
        ...
        while (TRUE)
        {
            ...
            //
            Status =
                BaseDllAdvanceTextPointer(a, (a->Operation == DeleteSection) ? STOP_AT_NONSECTION : STOP_AT_KEYWORD);
    ...
    Status = BaseDllModifyMappedFile(a, AddressInFile, SizeToRemove, InsertBuffer, InsertAmount);
    RtlFreeHeap(RtlProcessHeap(), 0, InsertBuffer);
    return Status;
}

NTSTATUS
BaseDllCalculateDeleteLength(IN PINIFILE_PARAMETERS a)
{
    ULONG DeleteLength;

    if (a->IniFile->UnicodeFile)
    {
        DeleteLength = (ULONG)((PCHAR)a->TextCurrent - (PCHAR)a->UnicodeKeywordName->Buffer);
    }
    else
    {
        DeleteLength = (ULONG)((PCHAR)a->TextCurrent - a->AnsiKeywordName->Buffer);
    }
...
BaseDllWriteKeywordValue(IN PINIFILE_PARAMETERS a, IN PUNICODE_STRING VariableName OPTIONAL)
{
    ...
    else
    {
        if (a->IniFile->UnicodeFile)
        {
            if (a->Operation == DeleteKey)
            {
                ...
                return BaseDllModifyMappedFile(a, a->UnicodeKeywordName->Buffer, DeleteLength, NULL, 0);
            }
            else
            {
        ...
        else
        {
            ...
            {
                DeleteLength = BaseDllCalculateDeleteLength(a);
                return BaseDllModifyMappedFile(a, a->AnsiKeywordName->Buffer, DeleteLength, NULL, 0);
            }
            else
            {
    ...
    if (a->IniFile->UnicodeFile)
    {
        ...
        if (InsertAmount == 0)
        {
            return BaseDllModifyMappedFile(a, a->UnicodeKeywordValue->Buffer, a->UnicodeKeywordValue->Length,
                                           UnicodeKeywordValue, ValueLength);
        }
    ...
    else
    {
        ...
        if (InsertAmount == 0)
        {
            return BaseDllModifyMappedFile(a, a->AnsiKeywordValue->Buffer, a->AnsiKeywordValue->Length,
                                           AnsiKeywordValue, ValueLength);
        }
    ...
    Status = BaseDllModifyMappedFile(a, AddressInFile, 0, InsertBuffer, InsertAmount);
    RtlFreeHeap(RtlProcessHeap(), 0, InsertBuffer);
    return Status;
}
        ...
        if (Status == STATUS_MORE_ENTRIES)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    Status = RtlUnicodeStringToAnsiString(a->AnsiSectionName, a->UnicodeSectionName, TRUE);
                    if (!NT_SUCCESS(Status))
                    {
            ...
            {
                if (RtlEqualUnicodeString(UnicodeSectionName, a->UnicodeSectionName, TRUE))
                {
                    Status = STATUS_SUCCESS;
                }
                else
        ...
        if (Status == STATUS_MORE_ENTRIES)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    Status = RtlUnicodeStringToAnsiString(a->AnsiKeywordName, a->UnicodeKeywordName, TRUE);
                    if (!NT_SUCCESS(Status))
                    {
            ...
            {
                if (RtlEqualUnicodeString(UnicodeKeywordName, a->UnicodeKeywordName, TRUE))
                {
                    Status = STATUS_SUCCESS;
                }
                else
                        ...
                        IN ULONG InsertAmount)
{
    ...
    if (NewEndOfFile > a->IniFile->CommitSize)
    {
        ...
        Status = NtAllocateVirtualMemory(NtCurrentProcess(), &a->IniFile->BaseAddress, 0, &a->IniFile->CommitSize,
                                         MEM_COMMIT, PAGE_READWRITE);
        if (!NT_SUCCESS(Status))
        {
            KdPrint(
                ("BASEDLL: Unable to allocate memory to grow %wZ - Status == %x\n", &a->IniFile->NtFileName, Status));
    ...
    if (SizeToRemove > InsertAmount)
    {
        ...
        RtlMoveMemory((PCHAR)AddressInFile + InsertAmount, (PCHAR)AddressInFile + SizeToRemove,
    ...
    else if (InsertAmount > 0)
    {
        ...
        if (SizeToRemove < InsertAmount)
        {
            ...
            RtlMoveMemory((PCHAR)AddressInFile + InsertAmount - SizeToRemove, (PCHAR)AddressInFile,
...
VOID BaseDllCheckInitFromIniFile(IN DWORD Flags, IN ULONG MappingFlags, IN PUNICODE_STRING FileName,
                                 IN PUNICODE_STRING ApplicationName, IN PUNICODE_STRING KeyName, IN OUT PWSTR *Buffer,
                                 IN OUT PULONG Size);

BOOL QueryWin31IniFilesMappedToRegistry(IN DWORD Flags, OUT PWSTR Buffer, IN DWORD cchBuffer, OUT LPDWORD cchUsed)
{
    BOOL Result;
    PINIFILE_MAPPING_FILENAME FileNameMapping;
    PINIFILE_MAPPING_APPNAME AppNameMapping;
    ...
    *cchUsed = 0;
    ...
    if (FileNameMapping != NULL)
    {
        ...
        VarNameMapping = (PINIFILE_MAPPING_VARNAME)AppNameMapping->DefaultVarNameMapping;
        BaseDllCheckInitFromIniFile(Flags, VarNameMapping->MappingFlags, &NullString, &NullString, &NullString, &Buffer,
                                    &Size);
    }
    ...
    while (FileNameMapping)
    {
        ...
        if (AppNameMapping != NULL)
        {
            ...
            BaseDllCheckInitFromIniFile(Flags, VarNameMapping->MappingFlags,
                                        BASE_READ_REMOTE_STR(FileNameMapping->Name, TempStr), &NullString, &NullString,
                                        &Buffer, &Size);
        }
        ...
        while (AppNameMapping)
        {
            ...
            if (VarNameMapping != NULL)
            {
                ...
                BaseDllCheckInitFromIniFile(
                    Flags, VarNameMapping->MappingFlags, BASE_READ_REMOTE_STR(FileNameMapping->Name, TempStr1),
                    BASE_READ_REMOTE_STR(AppNameMapping->Name, TempStr2), &NullString, &Buffer, &Size);
            }
            ...
            while (VarNameMapping)
            {
                ...
                BaseDllCheckInitFromIniFile(Flags, VarNameMapping->MappingFlags,
                                            ...
                                            BASE_READ_REMOTE_STR(VarNameMapping->Name, TempStr3), &Buffer, &Size);
                                 ...
                                 IN OUT PULONG Size)
{
    ...
    {
        cb = FileName->Length + sizeof(UNICODE_NULL) + ApplicationName->Length + sizeof(UNICODE_NULL) +
        ...
        else if (!(Flags & WIN31_INIFILES_MAPPED_TO_SYSTEM))
        {
            return;
        }
...
VOID BaseDllDumpIniFileMappings(PINIFILE_MAPPING IniFileMapping);

VOID BaseDllPrintMappingTarget(IN PINIFILE_MAPPING_VARNAME VarNameMapping);
...
VOID BaseDllPrintMappingTarget(IN PINIFILE_MAPPING_VARNAME VarNameMapping)
{
    ...
    if (VarNameMapping->MappingTarget)
    {
        ...
        DbgPrint("%wZ", BASE_READ_REMOTE_STR((((PINIFILE_MAPPING_TARGET)(VarNameMapping->MappingTarget))->RegistryPath),
                                             TempStr));
    }
