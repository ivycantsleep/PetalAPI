...
BOOL CreateTestDirs(LPSTR BasePath, DWORD Depth);
BOOL DeleteTestDirs(LPSTR BasePath, DWORD Depth);
...
//
LPSTR g_subdir[MAX_SUBDIRS] = { "12345678.123",
                                "12345678.1",
                                "8.1",
                                "8.123",
                                "12345678.1",
...
BOOL CreateTestDirs(LPTSTR BasePath, DWORD Depth)
{
    int len;
