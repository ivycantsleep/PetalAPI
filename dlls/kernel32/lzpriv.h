...
#define LZ_TABLE_BIAS                                \
    1024 // offset of first LZFile entry in table of \
         // handles, should be > 255                 \
         //  (255 == largest possible DOS file handle)

#define STYLE_MASK                                   \
    0xff0f // wStyle mask used to determine whether  \
...
#define LZF_INITIALIZED                               \
    0x00000001 // 1 ==> buffers have been initialized \
