...
NTSTATUS
AMLITest_Post_GetNameSpaceObject(PAMLIHOOK_DATA *ppData, NTSTATUS _Status);
...
NTSTATUS
AMLITest_Post_EvalNameSpaceObject(PAMLIHOOK_DATA *ppData, NTSTATUS _Status);
...
AMLITest_Pre_AsyncEvalObject(IN PNSOBJ pns, OUT POBJDATA pdataResult, IN int icArgs, IN POBJDATA pdataArgs,
                             IN PFNACB *nAsyncCallBack, IN PVOID *Context, PAMLIHOOK_DATA *Data);

NTSTATUS
AMLITest_Post_AsyncEvalObject(PAMLIHOOK_DATA *Data, NTSTATUS Status);
...
AMLITest_Pre_NestAsyncEvalObject(PNSOBJ pns, POBJDATA pdataResult, int icArgs, POBJDATA pdataArgs,
                                 PFNACB *pfnAsyncCallBack, PVOID *pvContext, PAMLIHOOK_DATA *Data);


NTSTATUS
AMLITest_Post_NestAsyncEvalObject(PAMLIHOOK_DATA *Data, NTSTATUS Status);
...
NTSTATUS
AMLITest_Pre_EvalPackageElement(PNSOBJ pns, int iPkgIndex, POBJDATA pdataResult, PAMLIHOOK_DATA *Data);
...
NTSTATUS
AMLITest_Pre_EvalPkgDataElement(POBJDATA pdataPkg, int iPkgIndex, POBJDATA pdataResult, PAMLIHOOK_DATA *Data);

NTSTATUS
AMLITest_Post_EvalPkgDataElement(PAMLIHOOK_DATA *Data, NTSTATUS Status);
...
NTSTATUS
AMLITest_Pre_FreeDataBuffs(POBJDATA pdata, int icData, PAMLIHOOK_DATA *Data);

NTSTATUS
AMLITest_Post_FreeDataBuffs(PAMLIHOOK_DATA *Data, NTSTATUS Status);
...
NTSTATUS
AMLIHook_Post_RegEventHandler(PAMLIHOOK_DATA *Data, NTSTATUS Status);
...
NTSTATUS
AMLITest_Pre_PauseInterpreter(PFNAA *pfnCallBack, PVOID *Context, PAMLIHOOK_DATA *Data);

NTSTATUS
AMLITest_Post_PauseInterpreter(PAMLIHOOK_DATA *Data, NTSTATUS Status);
...
NTSTATUS
AMLITest_Pre_ResumeInterpreter(PAMLIHOOK_DATA *Data);

NTSTATUS
AMLITest_Post_ResumeInterpreter(PAMLIHOOK_DATA *Data, NTSTATUS Status);
