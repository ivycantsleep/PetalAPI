...
VOID ACPIIoDebugTrace(BOOLEAN Write, PUSHORT Port, UCHAR Length, ULONG Value)
{
    if (IOTrace != 0)
    {
...
VOID CLEAR_PM1_STATUS_BITS(USHORT BitMask)
{
...
VOID CLEAR_PM1_STATUS_REGISTER(VOID)
{
    USHORT Value = 0;
...
VOID WRITE_PM1_CONTROL(USHORT Value, BOOLEAN Destructive, ULONG Flags)
{
...
VOID WRITE_PM1_ENABLE(USHORT Value)
{
...
USHORT
DefReadAcpiRegister(ACPI_REG_TYPE AcpiReg, ULONG Register)
/*++
...
--*/
{
    ...
    case PM1a_ENABLE:
        return READ_PORT_USHORT((PUSHORT)(AcpiInformation->PM1a_BLK + PM1_EN_OFFSET));
        break;

    case PM1b_ENABLE:
        return READ_PORT_USHORT((PUSHORT)(AcpiInformation->PM1b_BLK + PM1_EN_OFFSET));
        break;

    case PM1a_STATUS:
        return READ_PORT_USHORT((PUSHORT)AcpiInformation->PM1a_BLK + PM1_STS_OFFSET);
        break;

    case PM1b_STATUS:
        return READ_PORT_USHORT((PUSHORT)AcpiInformation->PM1b_BLK + PM1_STS_OFFSET);
        break;
    ...
    case GP_STATUS:
        ...
        {
            return READ_PORT_UCHAR((PUCHAR)(AcpiInformation->GP0_BLK + Register));
        }
        else
        {
            return READ_PORT_UCHAR((PUCHAR)(AcpiInformation->GP1_BLK + Register - AcpiInformation->Gpe0Size));
        }
        break;
    ...
    case GP_ENABLE:
        if (Register < AcpiInformation->Gpe0Size)
        {
            return READ_PORT_UCHAR((PUCHAR)(AcpiInformation->GP0_ENABLE + Register));
        }
        else
        {
            return READ_PORT_UCHAR((PUCHAR)(AcpiInformation->GP1_ENABLE + Register - AcpiInformation->Gpe0Size));
        }
        break;
...
VOID DefWriteAcpiRegister(ACPI_REG_TYPE AcpiReg, ULONG Register, USHORT Value)
/*++
...
--*/
{
    ...
    case PM1a_ENABLE:
        WRITE_PORT_USHORT((PUSHORT)(AcpiInformation->PM1a_BLK + PM1_EN_OFFSET), Value);
        break;

    case PM1b_ENABLE:
        WRITE_PORT_USHORT((PUSHORT)(AcpiInformation->PM1b_BLK + PM1_EN_OFFSET), Value);
        break;

    case PM1a_STATUS:
        WRITE_PORT_USHORT((PUSHORT)AcpiInformation->PM1a_BLK + PM1_STS_OFFSET, Value);
        break;

    case PM1b_STATUS:
        WRITE_PORT_USHORT((PUSHORT)AcpiInformation->PM1b_BLK + PM1_STS_OFFSET, Value);
        break;
    ...
    case GP_STATUS:
        if (Register < AcpiInformation->Gpe0Size)
        {
            WRITE_PORT_UCHAR((PUCHAR)(AcpiInformation->GP0_BLK + Register), (UCHAR)Value);
        }
        else
        {
            WRITE_PORT_UCHAR((PUCHAR)(AcpiInformation->GP1_BLK + Register - AcpiInformation->Gpe0Size), (UCHAR)Value);
        }
        break;
    ...
    case GP_ENABLE:
        if (Register < AcpiInformation->Gpe0Size)
        {
            WRITE_PORT_UCHAR((PUCHAR)(AcpiInformation->GP0_ENABLE + Register), (UCHAR)Value);
        }
        else
        {
            WRITE_PORT_UCHAR((PUCHAR)(AcpiInformation->GP1_ENABLE + Register - AcpiInformation->Gpe0Size),
                             (UCHAR)Value);
        }
        break;
