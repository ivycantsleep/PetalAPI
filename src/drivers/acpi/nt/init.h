...
NTSTATUS
ACPIInitStartDevice(IN PDEVICE_OBJECT DeviceObject, IN PCM_RESOURCE_LIST ResourceList, IN PACPI_POWER_CALLBACK CallBack,
...
NTSTATUS
ACPIInitUnicodeString(PUNICODE_STRING MultiString, PCHAR Buffer);
