...
#define STA_STATUS_DEFAULT (STA_STATUS_PRESENT | STA_STATUS_ENABLED | STA_STATUS_USER_INTERFACE | STA_STATUS_WORKING_OK)
...
VOID EXPORT ACPISimpleEvalComplete(IN PNSOBJ AcpiObject, IN NTSTATUS Status, IN POBJDATA Result OPTIONAL,
                                   IN PKEVENT Event);
