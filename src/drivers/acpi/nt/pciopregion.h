...
NTSTATUS
EXPORT
PciConfigSpaceHandlerWorker(IN PNSOBJ AcpiObject, IN NTSTATUS Status, IN POBJDATA Result, IN PVOID Context);
...
BOOLEAN
IsPciBusExtension(IN PDEVICE_EXTENSION DeviceObject);
...
NTSTATUS
IsPciDevice(IN PNSOBJ AcpiObj, IN PFNACB CompletionHandler, IN PVOID CompletionContext, OUT BOOLEAN *Result);
