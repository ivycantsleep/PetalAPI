...
//
INTERNAL_DEVICE_TABLE AcpiInternalDeviceTable[] = { "ACPI0006",    &AcpiGenericBusIrpDispatch,
...
INTERNAL_DEVICE_FLAG_TABLE AcpiInternalDeviceFlagTable[] = {
    "CPQB01D", DEV_CAP_START_IN_D3, "IBM3760", DEV_CAP_START_IN_D3, "ACPI0006",
    DEV_MASK_INTERNAL_BUS | DEV_CAP_CONTAINER, "PNP0000", DEV_CAP_PIC_DEVICE | DEV_MASK_INTERNAL_DEVICE, "PNP0001",
    DEV_CAP_PIC_DEVICE | DEV_MASK_INTERNAL_DEVICE, "PNP0002", DEV_MASK_INTERNAL_DEVICE, "PNP0003",
    DEV_CAP_PIC_DEVICE | DEV_MASK_INTERNAL_DEVICE, "PNP0004", DEV_CAP_PIC_DEVICE | DEV_MASK_INTERNAL_DEVICE, "PNP0100",
    DEV_MASK_INTERNAL_DEVICE, "PNP0101", DEV_MASK_INTERNAL_DEVICE, "PNP0102", DEV_MASK_INTERNAL_DEVICE, "PNP0200",
    DEV_MASK_INTERNAL_DEVICE, "PNP0201", DEV_MASK_INTERNAL_DEVICE, "PNP0202", DEV_MASK_INTERNAL_DEVICE, "PNP0500",
    DEV_CAP_SERIAL, "PNP0501", DEV_CAP_SERIAL, "PNP0800", DEV_MASK_INTERNAL_DEVICE, "PNP0A00", DEV_CAP_ISA, "PNP0A03",
    DEV_CAP_PCI, "PNP0A05", DEV_MASK_INTERNAL_BUS | DEV_CAP_EIO, "PNP0A06", DEV_MASK_INTERNAL_BUS | DEV_CAP_EIO,
    "PNP0B00", DEV_MASK_INTERNAL_DEVICE | DEV_CAP_NO_DISABLE_WAKE | DEV_CAP_RAW, // Clock --- need start device
    "PNP0C00", DEV_MASK_INTERNAL_DEVICE | DEV_CAP_NEVER_SHOW_IN_UI, "PNP0C01",
    DEV_MASK_INTERNAL_DEVICE | DEV_CAP_NEVER_SHOW_IN_UI, "PNP0C02", DEV_MASK_INTERNAL_DEVICE | DEV_CAP_NEVER_SHOW_IN_UI,
    "PNP0C04", DEV_MASK_INTERNAL_DEVICE, "PNP0C05", DEV_MASK_INTERNAL_DEVICE, "PNP0C09", DEV_CAP_NO_STOP, "PNP0C0B",
    DEV_CAP_RAW | DEV_MASK_INTERNAL_DEVICE,                                                       // Fan
    "PNP0C0C", DEV_CAP_RAW | DEV_CAP_BUTTON | DEV_CAP_NO_DISABLE_WAKE | DEV_MASK_INTERNAL_DEVICE, // Power
    "PNP0C0D", DEV_CAP_RAW | DEV_CAP_BUTTON | DEV_CAP_NO_DISABLE_WAKE | DEV_MASK_INTERNAL_DEVICE, // Lid
    "PNP0C0E", DEV_CAP_RAW | DEV_CAP_BUTTON | DEV_CAP_NO_DISABLE_WAKE | DEV_MASK_INTERNAL_DEVICE, // Sleep
    "PNP0C0F", DEV_CAP_NO_FILTER | DEV_TYPE_NEVER_PRESENT | DEV_CAP_LINK_NODE, "PNP0C80", DEV_CAP_NO_REMOVE_OR_EJECT,
