...
#define IoCopyDeviceCapabilitiesMapping(Source, Dest) \
    RtlCopyMemory((PUCHAR)Dest, (PUCHAR)Source, (PowerSystemShutdown + 1) * sizeof(DEVICE_POWER_STATE))
...
NTSTATUS
ACPISystemPowerQueryDeviceCapabilities(IN PDEVICE_EXTENSION DeviceExtension,
